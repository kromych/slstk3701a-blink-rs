...
pub type APORTVMASTERDIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PWRSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O, PWRSEL_A>;
impl<'a, REG, const O: u8> PWRSEL_W<'a, REG, O>
where
...
pub type ACCURACY_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type INPUTRANGE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O, INPUTRANGE_A>;
impl<'a, REG, const O: u8> INPUTRANGE_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type BIASPROG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aportxmasterdis(&mut self) -> APORTXMASTERDIS_W<CTRL_SPEC, 8> {
        APORTXMASTERDIS_W::new(self)
    }
    #[doc = "Bit 9 - APORT Bus Y Master Disable"]
    #[inline(always)]
    #[must_use]
    pub fn aportymasterdis(&mut self) -> APORTYMASTERDIS_W<CTRL_SPEC, 9> {
        APORTYMASTERDIS_W::new(self)
    }
    #[doc = "Bit 10 - APORT Bus Master Disable for Bus Selected By VASEL"]
    #[inline(always)]
    #[must_use]
    pub fn aportvmasterdis(&mut self) -> APORTVMASTERDIS_W<CTRL_SPEC, 10> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn accuracy(&mut self) -> ACCURACY_W<CTRL_SPEC, 15> {
        ACCURACY_W::new(self)
    }
    #[doc = "Bits 18:19 - Input Range"]
    #[inline(always)]
    #[must_use]
    pub fn inputrange(&mut self) -> INPUTRANGE_W<CTRL_SPEC, 18> {
        INPUTRANGE_W::new(self)
    }
    #[doc = "Bit 20 - Rising Edge Interrupt Sense"]
    #[inline(always)]
    #[must_use]
    pub fn irise(&mut self) -> IRISE_W<CTRL_SPEC, 20> {
        IRISE_W::new(self)
    }
    #[doc = "Bit 21 - Falling Edge Interrupt Sense"]
    #[inline(always)]
    #[must_use]
    pub fn ifall(&mut self) -> IFALL_W<CTRL_SPEC, 21> {
        IFALL_W::new(self)
    }
    #[doc = "Bits 24:29 - Bias Configuration"]
    #[inline(always)]
