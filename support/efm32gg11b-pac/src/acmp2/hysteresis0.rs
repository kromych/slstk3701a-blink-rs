...
pub type R = crate::R<Hysteresis0Spec>;
#[doc = "Register `HYSTERESIS0` writer"]
pub type W = crate::W<Hysteresis0Spec>;
...
impl W {
    #[doc = "Bits 0:3 - Hysteresis Select When ACMPOUT=0"]
    #[inline(always)]
    pub fn hyst(&mut self) -> HystW<'_, Hysteresis0Spec> {
        HystW::new(self, 0)
    }
    #[doc = "Bits 16:21 - Divider for VA Voltage When ACMPOUT=0"]
    #[inline(always)]
    pub fn divva(&mut self) -> DivvaW<'_, Hysteresis0Spec> {
        DivvaW::new(self, 16)
    }
    #[doc = "Bits 24:29 - Divider for VB Voltage When ACMPOUT=0"]
    #[inline(always)]
    pub fn divvb(&mut self) -> DivvbW<'_, Hysteresis0Spec> {
        DivvbW::new(self, 24)
    }
}
...
pub struct Hysteresis0Spec;
impl crate::RegisterSpec for Hysteresis0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hysteresis0::R`](R) reader structure"]
impl crate::Readable for Hysteresis0Spec {}
#[doc = "`write(|w| ..)` method takes [`hysteresis0::W`](W) writer structure"]
impl crate::Writable for Hysteresis0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HYSTERESIS0 to value 0"]
impl crate::Resettable for Hysteresis0Spec {}
