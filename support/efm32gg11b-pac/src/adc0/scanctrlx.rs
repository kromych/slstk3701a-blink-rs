...
pub type R = crate::R<ScanctrlxSpec>;
#[doc = "Register `SCANCTRLX` writer"]
pub type W = crate::W<ScanctrlxSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Scan Channel Reference Selection"]
    #[inline(always)]
    pub fn vrefsel(&mut self) -> VrefselW<'_, ScanctrlxSpec> {
        VrefselW::new(self, 0)
    }
    #[doc = "Bit 3 - Enable Fixed Scaling on VREF"]
    #[inline(always)]
    pub fn vrefattfix(&mut self) -> VrefattfixW<'_, ScanctrlxSpec> {
        VrefattfixW::new(self, 3)
    }
    #[doc = "Bits 4:7 - Code for VREF Attenuation Factor When VREFSEL is 1, 2 or 5"]
    #[inline(always)]
    pub fn vrefatt(&mut self) -> VrefattW<'_, ScanctrlxSpec> {
        VrefattW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Code for VIN Attenuation Factor"]
    #[inline(always)]
    pub fn vinatt(&mut self) -> VinattW<'_, ScanctrlxSpec> {
        VinattW::new(self, 8)
    }
    #[doc = "Bits 12:13 - Scan DV Level Select"]
    #[inline(always)]
    pub fn dvl(&mut self) -> DvlW<'_, ScanctrlxSpec> {
        DvlW::new(self, 12)
    }
    #[doc = "Bit 14 - Scan FIFO Overflow Action"]
    #[inline(always)]
    pub fn fifoofact(&mut self) -> FifoofactW<'_, ScanctrlxSpec> {
        FifoofactW::new(self, 14)
    }
    #[doc = "Bit 16 - Scan PRS Trigger Mode"]
    #[inline(always)]
    pub fn prsmode(&mut self) -> PrsmodeW<'_, ScanctrlxSpec> {
        PrsmodeW::new(self, 16)
    }
    #[doc = "Bits 17:21 - Scan Sequence PRS Trigger Select"]
    #[inline(always)]
    pub fn prssel(&mut self) -> PrsselW<'_, ScanctrlxSpec> {
        PrsselW::new(self, 17)
    }
    #[doc = "Bits 22:26 - Delay Next Conversion Start If CONVSTARTDELAYEN is Set"]
    #[inline(always)]
    pub fn convstartdelay(&mut self) -> ConvstartdelayW<'_, ScanctrlxSpec> {
        ConvstartdelayW::new(self, 22)
    }
    #[doc = "Bit 27 - Enable Delaying Next Conversion Start"]
    #[inline(always)]
    pub fn convstartdelayen(&mut self) -> ConvstartdelayenW<'_, ScanctrlxSpec> {
        ConvstartdelayenW::new(self, 27)
    }
    #[doc = "Bits 29:31 - REPDELAY Select for SCAN REP Mode"]
    #[inline(always)]
    pub fn repdelay(&mut self) -> RepdelayW<'_, ScanctrlxSpec> {
...
pub struct ScanctrlxSpec;
impl crate::RegisterSpec for ScanctrlxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scanctrlx::R`](R) reader structure"]
impl crate::Readable for ScanctrlxSpec {}
#[doc = "`write(|w| ..)` method takes [`scanctrlx::W`](W) writer structure"]
impl crate::Writable for ScanctrlxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SCANCTRLX to value 0"]
impl crate::Resettable for ScanctrlxSpec {}
