...
pub type VREFSEL_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, VREFSEL_A>;
...
pub type CONVSTARTDELAY_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
pub type REPDELAY_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, REPDELAY_A>;
impl<'a, REG, const O: u8> REPDELAY_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vrefsel(&mut self) -> VREFSEL_W<SINGLECTRLX_SPEC, 0> {
        VREFSEL_W::new(self)
    }
    #[doc = "Bit 3 - Enable Fixed Scaling on VREF"]
    #[inline(always)]
    #[must_use]
    pub fn vrefattfix(&mut self) -> VREFATTFIX_W<SINGLECTRLX_SPEC, 3> {
        VREFATTFIX_W::new(self)
    }
    #[doc = "Bits 4:7 - Code for VREF Attenuation Factor When VREFSEL is 1, 2 or 5"]
    #[inline(always)]
    #[must_use]
    pub fn vrefatt(&mut self) -> VREFATT_W<SINGLECTRLX_SPEC, 4> {
        VREFATT_W::new(self)
    }
    #[doc = "Bits 8:11 - Code for VIN Attenuation Factor"]
    #[inline(always)]
    #[must_use]
    pub fn vinatt(&mut self) -> VINATT_W<SINGLECTRLX_SPEC, 8> {
        VINATT_W::new(self)
    }
    #[doc = "Bits 12:13 - Single Channel DV Level Select"]
    #[inline(always)]
    #[must_use]
    pub fn dvl(&mut self) -> DVL_W<SINGLECTRLX_SPEC, 12> {
        DVL_W::new(self)
    }
    #[doc = "Bit 14 - Single Channel FIFO Overflow Action"]
    #[inline(always)]
    #[must_use]
    pub fn fifoofact(&mut self) -> FIFOOFACT_W<SINGLECTRLX_SPEC, 14> {
        FIFOOFACT_W::new(self)
    }
    #[doc = "Bit 16 - Single Channel PRS Trigger Mode"]
    #[inline(always)]
    #[must_use]
    pub fn prsmode(&mut self) -> PRSMODE_W<SINGLECTRLX_SPEC, 16> {
        PRSMODE_W::new(self)
    }
    #[doc = "Bits 17:21 - Single Channel PRS Trigger Select"]
    #[inline(always)]
    #[must_use]
    pub fn prssel(&mut self) -> PRSSEL_W<SINGLECTRLX_SPEC, 17> {
        PRSSEL_W::new(self)
    }
    #[doc = "Bits 22:26 - Delay Value for Next Conversion Start If CONVSTARTDELAYEN is Set"]
    #[inline(always)]
    #[must_use]
    pub fn convstartdelay(&mut self) -> CONVSTARTDELAY_W<SINGLECTRLX_SPEC, 22> {
        CONVSTARTDELAY_W::new(self)
    }
    #[doc = "Bit 27 - Enable Delaying Next Conversion Start"]
    #[inline(always)]
    #[must_use]
    pub fn convstartdelayen(&mut self) -> CONVSTARTDELAYEN_W<SINGLECTRLX_SPEC, 27> {
        CONVSTARTDELAYEN_W::new(self)
    }
    #[doc = "Bits 29:31 - REPDELAY Select for SINGLE REP Mode"]
    #[inline(always)]
    #[must_use]
    pub fn repdelay(&mut self) -> REPDELAY_W<SINGLECTRLX_SPEC, 29> {
        REPDELAY_W::new(self)
    }
