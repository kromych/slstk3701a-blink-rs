...
pub type R = crate::R<Mir0DatalSpec>;
#[doc = "Register `MIR0_DATAL` writer"]
pub type W = crate::W<Mir0DatalSpec>;
...
impl W {
    #[doc = "Bits 0:7 - First Byte of CAN Data Frame"]
    #[inline(always)]
    pub fn data0(&mut self) -> Data0W<'_, Mir0DatalSpec> {
        Data0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Second Byte of CAN Data Frame"]
    #[inline(always)]
    pub fn data1(&mut self) -> Data1W<'_, Mir0DatalSpec> {
        Data1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Third Byte of CAN Data Frame"]
    #[inline(always)]
    pub fn data2(&mut self) -> Data2W<'_, Mir0DatalSpec> {
        Data2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Fourth Byte of CAN Data Frame"]
    #[inline(always)]
    pub fn data3(&mut self) -> Data3W<'_, Mir0DatalSpec> {
        Data3W::new(self, 24)
    }
}
#[doc = "Interface Data a Register\n\nYou can [`read`](crate::Reg::read) this register and get [`mir0_datal::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mir0_datal::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mir0DatalSpec;
impl crate::RegisterSpec for Mir0DatalSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mir0_datal::R`](R) reader structure"]
impl crate::Readable for Mir0DatalSpec {}
#[doc = "`write(|w| ..)` method takes [`mir0_datal::W`](W) writer structure"]
impl crate::Writable for Mir0DatalSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MIR0_DATAL to value 0"]
impl crate::Resettable for Mir0DatalSpec {}
