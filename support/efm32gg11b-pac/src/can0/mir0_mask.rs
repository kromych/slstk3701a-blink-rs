...
pub type R = crate::R<Mir0MaskSpec>;
#[doc = "Register `MIR0_MASK` writer"]
pub type W = crate::W<Mir0MaskSpec>;
...
impl W {
    #[doc = "Bits 0:28 - Identifier Mask"]
    #[inline(always)]
    pub fn mask(&mut self) -> MaskW<'_, Mir0MaskSpec> {
        MaskW::new(self, 0)
    }
    #[doc = "Bit 30 - Mask Message Direction"]
    #[inline(always)]
    pub fn mdir(&mut self) -> MdirW<'_, Mir0MaskSpec> {
        MdirW::new(self, 30)
    }
    #[doc = "Bit 31 - Mask Extended Identifier"]
    #[inline(always)]
    pub fn mxtd(&mut self) -> MxtdW<'_, Mir0MaskSpec> {
        MxtdW::new(self, 31)
    }
}
#[doc = "Interface Mask Register\n\nYou can [`read`](crate::Reg::read) this register and get [`mir0_mask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mir0_mask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mir0MaskSpec;
impl crate::RegisterSpec for Mir0MaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mir0_mask::R`](R) reader structure"]
impl crate::Readable for Mir0MaskSpec {}
#[doc = "`write(|w| ..)` method takes [`mir0_mask::W`](W) writer structure"]
impl crate::Writable for Mir0MaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MIR0_MASK to value 0xdfff_ffff"]
impl crate::Resettable for Mir0MaskSpec {
