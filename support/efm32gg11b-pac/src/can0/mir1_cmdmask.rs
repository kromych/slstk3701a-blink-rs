...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datab(&mut self) -> DATAB_W<MIR1_CMDMASK_SPEC, 0> {
        DATAB_W::new(self)
    }
    #[doc = "Bit 1 - Access Data Bytes 0-3"]
    #[inline(always)]
    #[must_use]
    pub fn dataa(&mut self) -> DATAA_W<MIR1_CMDMASK_SPEC, 1> {
        DATAA_W::new(self)
    }
    #[doc = "Bit 2 - Transmission Request Bit/ New Data Bit"]
    #[inline(always)]
    #[must_use]
    pub fn txrqstnewdat(&mut self) -> TXRQSTNEWDAT_W<MIR1_CMDMASK_SPEC, 2> {
        TXRQSTNEWDAT_W::new(self)
    }
    #[doc = "Bit 3 - Clear Interrupt Pending Bit"]
    #[inline(always)]
    #[must_use]
    pub fn clrintpnd(&mut self) -> CLRINTPND_W<MIR1_CMDMASK_SPEC, 3> {
        CLRINTPND_W::new(self)
    }
    #[doc = "Bit 4 - Access Control Bits"]
    #[inline(always)]
    #[must_use]
    pub fn control(&mut self) -> CONTROL_W<MIR1_CMDMASK_SPEC, 4> {
        CONTROL_W::new(self)
    }
    #[doc = "Bit 5 - Access Arbitration Bits"]
    #[inline(always)]
    #[must_use]
    pub fn arbacc(&mut self) -> ARBACC_W<MIR1_CMDMASK_SPEC, 5> {
        ARBACC_W::new(self)
    }
    #[doc = "Bit 6 - Access Mask Bits"]
    #[inline(always)]
    #[must_use]
    pub fn maskacc(&mut self) -> MASKACC_W<MIR1_CMDMASK_SPEC, 6> {
        MASKACC_W::new(self)
    }
    #[doc = "Bit 7 - Write/Read RAM"]
    #[inline(always)]
    #[must_use]
    pub fn wrrd(&mut self) -> WRRD_W<MIR1_CMDMASK_SPEC, 7> {
        WRRD_W::new(self)
    }
