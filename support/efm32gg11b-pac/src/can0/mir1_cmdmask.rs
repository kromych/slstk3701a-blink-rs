...
pub type R = crate::R<Mir1CmdmaskSpec>;
#[doc = "Register `MIR1_CMDMASK` writer"]
pub type W = crate::W<Mir1CmdmaskSpec>;
...
impl W {
    #[doc = "Bit 0 - CC Channel Mode"]
    #[inline(always)]
    pub fn datab(&mut self) -> DatabW<'_, Mir1CmdmaskSpec> {
        DatabW::new(self, 0)
    }
    #[doc = "Bit 1 - Access Data Bytes 0-3"]
    #[inline(always)]
    pub fn dataa(&mut self) -> DataaW<'_, Mir1CmdmaskSpec> {
        DataaW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmission Request Bit/ New Data Bit"]
    #[inline(always)]
    pub fn txrqstnewdat(&mut self) -> TxrqstnewdatW<'_, Mir1CmdmaskSpec> {
        TxrqstnewdatW::new(self, 2)
    }
    #[doc = "Bit 3 - Clear Interrupt Pending Bit"]
    #[inline(always)]
    pub fn clrintpnd(&mut self) -> ClrintpndW<'_, Mir1CmdmaskSpec> {
        ClrintpndW::new(self, 3)
    }
    #[doc = "Bit 4 - Access Control Bits"]
    #[inline(always)]
    pub fn control(&mut self) -> ControlW<'_, Mir1CmdmaskSpec> {
        ControlW::new(self, 4)
    }
    #[doc = "Bit 5 - Access Arbitration Bits"]
    #[inline(always)]
    pub fn arbacc(&mut self) -> ArbaccW<'_, Mir1CmdmaskSpec> {
        ArbaccW::new(self, 5)
    }
    #[doc = "Bit 6 - Access Mask Bits"]
    #[inline(always)]
    pub fn maskacc(&mut self) -> MaskaccW<'_, Mir1CmdmaskSpec> {
        MaskaccW::new(self, 6)
    }
    #[doc = "Bit 7 - Write/Read RAM"]
    #[inline(always)]
    pub fn wrrd(&mut self) -> WrrdW<'_, Mir1CmdmaskSpec> {
        WrrdW::new(self, 7)
    }
}
#[doc = "Interface Command Mask Register\n\nYou can [`read`](crate::Reg::read) this register and get [`mir1_cmdmask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mir1_cmdmask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mir1CmdmaskSpec;
impl crate::RegisterSpec for Mir1CmdmaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mir1_cmdmask::R`](R) reader structure"]
impl crate::Readable for Mir1CmdmaskSpec {}
#[doc = "`write(|w| ..)` method takes [`mir1_cmdmask::W`](W) writer structure"]
impl crate::Writable for Mir1CmdmaskSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MIR1_CMDMASK to value 0"]
impl crate::Resettable for Mir1CmdmaskSpec {}
