...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data4(&mut self) -> DATA4_W<MIR1_DATAH_SPEC> {
        DATA4_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Sixth Byte of CAN Data Frame"]
    #[inline(always)]
    #[must_use]
    pub fn data5(&mut self) -> DATA5_W<MIR1_DATAH_SPEC> {
        DATA5_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Seventh Byte of CAN Data Frame"]
    #[inline(always)]
    #[must_use]
    pub fn data6(&mut self) -> DATA6_W<MIR1_DATAH_SPEC> {
        DATA6_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Eight Byte of CAN Data Frame"]
    #[inline(always)]
    #[must_use]
    pub fn data7(&mut self) -> DATA7_W<MIR1_DATAH_SPEC> {
        DATA7_W::new(self, 24)
    }
