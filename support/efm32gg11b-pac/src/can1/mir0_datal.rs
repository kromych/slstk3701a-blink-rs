...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data0(&mut self) -> DATA0_W<MIR0_DATAL_SPEC> {
        DATA0_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Second Byte of CAN Data Frame"]
    #[inline(always)]
    #[must_use]
    pub fn data1(&mut self) -> DATA1_W<MIR0_DATAL_SPEC> {
        DATA1_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Third Byte of CAN Data Frame"]
    #[inline(always)]
    #[must_use]
    pub fn data2(&mut self) -> DATA2_W<MIR0_DATAL_SPEC> {
        DATA2_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Fourth Byte of CAN Data Frame"]
    #[inline(always)]
    #[must_use]
    pub fn data3(&mut self) -> DATA3_W<MIR0_DATAL_SPEC> {
        DATA3_W::new(self, 24)
    }
