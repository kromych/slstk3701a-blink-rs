...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn id(&mut self) -> ID_W<MIR1_ARB_SPEC, 0> {
        ID_W::new(self)
    }
    #[doc = "Bit 29 - Message Direction"]
    #[inline(always)]
    #[must_use]
    pub fn dir(&mut self) -> DIR_W<MIR1_ARB_SPEC, 29> {
        DIR_W::new(self)
    }
    #[doc = "Bit 30 - Extended Identifier"]
    #[inline(always)]
    #[must_use]
    pub fn xtd(&mut self) -> XTD_W<MIR1_ARB_SPEC, 30> {
        XTD_W::new(self)
    }
    #[doc = "Bit 31 - Message Valid"]
    #[inline(always)]
    #[must_use]
    pub fn msgval(&mut self) -> MSGVAL_W<MIR1_ARB_SPEC, 31> {
        MSGVAL_W::new(self)
    }
