...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dlc(&mut self) -> DLC_W<MIR1_CTRL_SPEC> {
        DLC_W::new(self, 0)
    }
    #[doc = "Bit 7 - End of Buffer"]
    #[inline(always)]
    #[must_use]
    pub fn eob(&mut self) -> EOB_W<MIR1_CTRL_SPEC> {
        EOB_W::new(self, 7)
    }
    #[doc = "Bit 8 - Transmit Request"]
    #[inline(always)]
    #[must_use]
    pub fn txrqst(&mut self) -> TXRQST_W<MIR1_CTRL_SPEC> {
        TXRQST_W::new(self, 8)
    }
    #[doc = "Bit 9 - Remote Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rmten(&mut self) -> RMTEN_W<MIR1_CTRL_SPEC> {
        RMTEN_W::new(self, 9)
    }
    #[doc = "Bit 10 - Receive Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxie(&mut self) -> RXIE_W<MIR1_CTRL_SPEC> {
        RXIE_W::new(self, 10)
    }
    #[doc = "Bit 11 - Transmit Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txie(&mut self) -> TXIE_W<MIR1_CTRL_SPEC> {
        TXIE_W::new(self, 11)
    }
    #[doc = "Bit 12 - Use Acceptance Mask"]
    #[inline(always)]
    #[must_use]
    pub fn umask(&mut self) -> UMASK_W<MIR1_CTRL_SPEC> {
        UMASK_W::new(self, 12)
    }
    #[doc = "Bit 13 - Interrupt Pending"]
    #[inline(always)]
    #[must_use]
    pub fn intpnd(&mut self) -> INTPND_W<MIR1_CTRL_SPEC> {
        INTPND_W::new(self, 13)
    }
    #[doc = "Bit 14 - Message Lost (only Valid for Message Objects With Direction = Receive)"]
    #[inline(always)]
    #[must_use]
    pub fn messageof(&mut self) -> MESSAGEOF_W<MIR1_CTRL_SPEC> {
        MESSAGEOF_W::new(self, 14)
    }
    #[doc = "Bit 15 - New Data"]
    #[inline(always)]
    #[must_use]
    pub fn datavalid(&mut self) -> DATAVALID_W<MIR1_CTRL_SPEC> {
