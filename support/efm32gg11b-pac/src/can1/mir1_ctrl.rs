...
pub type R = crate::R<MIR1_CTRL_SPEC>;
#[doc = "Register `MIR1_CTRL` writer"]
pub type W = crate::W<MIR1_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dlc(&mut self) -> DLC_W<MIR1_CTRL_SPEC, 0> {
        DLC_W::new(self)
    }
    #[doc = "Bit 7 - End of Buffer"]
    #[inline(always)]
    #[must_use]
    pub fn eob(&mut self) -> EOB_W<MIR1_CTRL_SPEC, 7> {
        EOB_W::new(self)
    }
    #[doc = "Bit 8 - Transmit Request"]
    #[inline(always)]
    #[must_use]
    pub fn txrqst(&mut self) -> TXRQST_W<MIR1_CTRL_SPEC, 8> {
        TXRQST_W::new(self)
    }
    #[doc = "Bit 9 - Remote Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rmten(&mut self) -> RMTEN_W<MIR1_CTRL_SPEC, 9> {
        RMTEN_W::new(self)
    }
    #[doc = "Bit 10 - Receive Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxie(&mut self) -> RXIE_W<MIR1_CTRL_SPEC, 10> {
        RXIE_W::new(self)
    }
    #[doc = "Bit 11 - Transmit Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txie(&mut self) -> TXIE_W<MIR1_CTRL_SPEC, 11> {
        TXIE_W::new(self)
    }
    #[doc = "Bit 12 - Use Acceptance Mask"]
    #[inline(always)]
    #[must_use]
    pub fn umask(&mut self) -> UMASK_W<MIR1_CTRL_SPEC, 12> {
        UMASK_W::new(self)
    }
    #[doc = "Bit 13 - Interrupt Pending"]
    #[inline(always)]
    #[must_use]
    pub fn intpnd(&mut self) -> INTPND_W<MIR1_CTRL_SPEC, 13> {
        INTPND_W::new(self)
    }
    #[doc = "Bit 14 - Message Lost (only Valid for Message Objects With Direction = Receive)"]
    #[inline(always)]
    #[must_use]
    pub fn messageof(&mut self) -> MESSAGEOF_W<MIR1_CTRL_SPEC, 14> {
        MESSAGEOF_W::new(self)
    }
    #[doc = "Bit 15 - New Data"]
    #[inline(always)]
    #[must_use]
    pub fn datavalid(&mut self) -> DATAVALID_W<MIR1_CTRL_SPEC, 15> {
...
#[doc = "Interface Message Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mir1_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mir1_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
