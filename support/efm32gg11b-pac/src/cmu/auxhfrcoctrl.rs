...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tuning(&mut self) -> TUNING_W<AUXHFRCOCTRL_SPEC> {
        TUNING_W::new(self, 0)
    }
    #[doc = "Bits 8:13 - AUXHFRCO Fine Tuning Value"]
    #[inline(always)]
    #[must_use]
    pub fn finetuning(&mut self) -> FINETUNING_W<AUXHFRCOCTRL_SPEC> {
        FINETUNING_W::new(self, 8)
    }
    #[doc = "Bits 16:20 - AUXHFRCO Frequency Range"]
    #[inline(always)]
    #[must_use]
    pub fn freqrange(&mut self) -> FREQRANGE_W<AUXHFRCOCTRL_SPEC> {
        FREQRANGE_W::new(self, 16)
    }
    #[doc = "Bits 21:23 - AUXHFRCO Comparator Bias Current"]
    #[inline(always)]
    #[must_use]
    pub fn cmpbias(&mut self) -> CMPBIAS_W<AUXHFRCOCTRL_SPEC> {
        CMPBIAS_W::new(self, 21)
    }
    #[doc = "Bit 24 - AUXHFRCO LDO High Power Mode"]
    #[inline(always)]
    #[must_use]
    pub fn ldohp(&mut self) -> LDOHP_W<AUXHFRCOCTRL_SPEC> {
        LDOHP_W::new(self, 24)
    }
    #[doc = "Bits 25:26 - Locally Divide AUXHFRCO Clock Output"]
    #[inline(always)]
    #[must_use]
    pub fn clkdiv(&mut self) -> CLKDIV_W<AUXHFRCOCTRL_SPEC> {
        CLKDIV_W::new(self, 25)
    }
    #[doc = "Bit 27 - Enable Reference for Fine Tuning"]
    #[inline(always)]
    #[must_use]
    pub fn finetuningen(&mut self) -> FINETUNINGEN_W<AUXHFRCOCTRL_SPEC> {
        FINETUNINGEN_W::new(self, 27)
    }
    #[doc = "Bits 28:31 - AUXHFRCO Temperature Coefficient Trim on Comparator Reference"]
    #[inline(always)]
    #[must_use]
    pub fn vreftc(&mut self) -> VREFTC_W<AUXHFRCOCTRL_SPEC> {
