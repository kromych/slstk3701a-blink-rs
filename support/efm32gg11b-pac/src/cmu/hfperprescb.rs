...
pub type R = crate::R<HfperprescbSpec>;
#[doc = "Register `HFPERPRESCB` writer"]
pub type W = crate::W<HfperprescbSpec>;
...
impl W {
    #[doc = "Bits 8:16 - HFPERCLK Prescaler"]
    #[inline(always)]
    pub fn presc(&mut self) -> PrescW<'_, HfperprescbSpec> {
        PrescW::new(self, 8)
    }
}
#[doc = "High Frequency Peripheral Clock Prescaler B Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hfperprescb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hfperprescb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HfperprescbSpec;
impl crate::RegisterSpec for HfperprescbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hfperprescb::R`](R) reader structure"]
impl crate::Readable for HfperprescbSpec {}
#[doc = "`write(|w| ..)` method takes [`hfperprescb::W`](W) writer structure"]
impl crate::Writable for HfperprescbSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HFPERPRESCB to value 0"]
impl crate::Resettable for HfperprescbSpec {}
