...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn letimer1(&mut self) -> LETIMER1_W<LFACLKEN0_SPEC, 1> {
        LETIMER1_W::new(self)
    }
    #[doc = "Bit 2 - Low Energy Sensor Interface Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lesense(&mut self) -> LESENSE_W<LFACLKEN0_SPEC, 2> {
        LESENSE_W::new(self)
    }
    #[doc = "Bit 3 - Liquid Crystal Display Controller Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lcd(&mut self) -> LCD_W<LFACLKEN0_SPEC, 3> {
        LCD_W::new(self)
    }
    #[doc = "Bit 4 - Real-Time Counter Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rtc(&mut self) -> RTC_W<LFACLKEN0_SPEC, 4> {
        RTC_W::new(self)
    }
