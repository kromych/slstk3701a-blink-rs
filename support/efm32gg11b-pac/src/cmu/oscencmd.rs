...
pub type DPLLEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DPLLDIS` writer - DPLL Disable"]
pub type DPLLDIS_W<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dpllen(&mut self) -> DPLLEN_W<OSCENCMD_SPEC> {
        DPLLEN_W::new(self, 12)
    }
    #[doc = "Bit 13 - DPLL Disable"]
    #[inline(always)]
    #[must_use]
    pub fn dplldis(&mut self) -> DPLLDIS_W<OSCENCMD_SPEC> {
        DPLLDIS_W::new(self, 13)
    }
