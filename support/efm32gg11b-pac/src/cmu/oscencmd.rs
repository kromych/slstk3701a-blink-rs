...
pub type DpllenW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DPLLDIS` writer - DPLL Disable"]
pub type DplldisW<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    ...
    #[inline(always)]
    pub fn dpllen(&mut self) -> DpllenW<'_, OscencmdSpec> {
        DpllenW::new(self, 12)
    }
    #[doc = "Bit 13 - DPLL Disable"]
    #[inline(always)]
    pub fn dplldis(&mut self) -> DplldisW<'_, OscencmdSpec> {
        DplldisW::new(self, 13)
    }
}
