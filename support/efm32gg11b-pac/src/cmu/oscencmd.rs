...
pub type DPLLEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `DPLLDIS` writer - DPLL Disable"]
pub type DPLLDIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dpllen(&mut self) -> DPLLEN_W<OSCENCMD_SPEC, 12> {
        DPLLEN_W::new(self)
    }
    #[doc = "Bit 13 - DPLL Disable"]
    #[inline(always)]
    #[must_use]
    pub fn dplldis(&mut self) -> DPLLDIS_W<OSCENCMD_SPEC, 13> {
        DPLLDIS_W::new(self)
    }
