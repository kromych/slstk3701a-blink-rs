...
pub type CLKOUT2LOC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O, CLKOUT2LOC_A>;
impl<'a, REG, const O: u8> CLKOUT2LOC_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clkout2loc(&mut self) -> CLKOUT2LOC_W<ROUTELOC0_SPEC, 16> {
