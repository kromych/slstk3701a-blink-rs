...
pub type R = crate::R<DDATA4_SPEC>;
#[doc = "Register `DDATA4` writer"]
pub type W = crate::W<DDATA4_SPEC>;
...
pub type DDATA4_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ddata4(&mut self) -> DDATA4_W<DDATA4_SPEC, 0> {
        DDATA4_W::new(self)
    }
...
#[doc = "DDATA4 Register Access\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddata4::R`](R). WARN: One or more dependent resources other than the current register are immediately affected by a read operation. You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddata4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
