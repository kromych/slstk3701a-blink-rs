...
pub type R = crate::R<ADDRTIMING_SPEC>;
#[doc = "Register `ADDRTIMING` writer"]
pub type W = crate::W<ADDRTIMING_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addrsetup(&mut self) -> ADDRSETUP_W<ADDRTIMING_SPEC, 0> {
        ADDRSETUP_W::new(self)
    }
    #[doc = "Bits 8:10 - Address Hold Time"]
    #[inline(always)]
    #[must_use]
    pub fn addrhold(&mut self) -> ADDRHOLD_W<ADDRTIMING_SPEC, 8> {
        ADDRHOLD_W::new(self)
    }
    #[doc = "Bit 28 - Half Cycle ALE Strobe Duration Enable"]
    #[inline(always)]
    #[must_use]
    pub fn halfale(&mut self) -> HALFALE_W<ADDRTIMING_SPEC, 28> {
        HALFALE_W::new(self)
    }
...
#[doc = "Address Timing Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`addrtiming::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`addrtiming::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
