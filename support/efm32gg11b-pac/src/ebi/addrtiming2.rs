...
pub type R = crate::R<Addrtiming2Spec>;
#[doc = "Register `ADDRTIMING2` writer"]
pub type W = crate::W<Addrtiming2Spec>;
...
impl W {
    #[doc = "Bits 0:2 - Address Setup Time"]
    #[inline(always)]
    pub fn addrsetup(&mut self) -> AddrsetupW<'_, Addrtiming2Spec> {
        AddrsetupW::new(self, 0)
    }
    #[doc = "Bits 8:10 - Address Hold Time"]
    #[inline(always)]
    pub fn addrhold(&mut self) -> AddrholdW<'_, Addrtiming2Spec> {
        AddrholdW::new(self, 8)
    }
    #[doc = "Bit 28 - Half Cycle ALE Strobe Duration Enable"]
    #[inline(always)]
    pub fn halfale(&mut self) -> HalfaleW<'_, Addrtiming2Spec> {
        HalfaleW::new(self, 28)
    }
}
#[doc = "Address Timing Register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`addrtiming2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`addrtiming2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Addrtiming2Spec;
impl crate::RegisterSpec for Addrtiming2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`addrtiming2::R`](R) reader structure"]
impl crate::Readable for Addrtiming2Spec {}
#[doc = "`write(|w| ..)` method takes [`addrtiming2::W`](W) writer structure"]
impl crate::Writable for Addrtiming2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADDRTIMING2 to value 0x0707"]
impl crate::Resettable for Addrtiming2Spec {
