...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addrsetup(&mut self) -> ADDRSETUP_W<ADDRTIMING3_SPEC> {
        ADDRSETUP_W::new(self, 0)
    }
    #[doc = "Bits 8:10 - Address Hold Time"]
    #[inline(always)]
    #[must_use]
    pub fn addrhold(&mut self) -> ADDRHOLD_W<ADDRTIMING3_SPEC> {
        ADDRHOLD_W::new(self, 8)
    }
    #[doc = "Bit 28 - Half Cycle ALE Strobe Duration Enable"]
    #[inline(always)]
    #[must_use]
    pub fn halfale(&mut self) -> HALFALE_W<ADDRTIMING3_SPEC> {
