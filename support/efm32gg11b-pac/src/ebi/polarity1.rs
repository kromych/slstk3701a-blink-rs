...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cspol(&mut self) -> CSPOL_W<POLARITY1_SPEC> {
        CSPOL_W::new(self, 0)
    }
    #[doc = "Bit 1 - Read Enable Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn repol(&mut self) -> REPOL_W<POLARITY1_SPEC> {
        REPOL_W::new(self, 1)
    }
    #[doc = "Bit 2 - Write Enable Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn wepol(&mut self) -> WEPOL_W<POLARITY1_SPEC> {
        WEPOL_W::new(self, 2)
    }
    #[doc = "Bit 3 - Address Latch Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn alepol(&mut self) -> ALEPOL_W<POLARITY1_SPEC> {
        ALEPOL_W::new(self, 3)
    }
    #[doc = "Bit 4 - ARDY Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ardypol(&mut self) -> ARDYPOL_W<POLARITY1_SPEC> {
        ARDYPOL_W::new(self, 4)
    }
    #[doc = "Bit 5 - BL Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn blpol(&mut self) -> BLPOL_W<POLARITY1_SPEC> {
        BLPOL_W::new(self, 5)
    }
