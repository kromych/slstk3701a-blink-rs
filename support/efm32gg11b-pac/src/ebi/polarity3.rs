...
pub type R = crate::R<POLARITY3_SPEC>;
#[doc = "Register `POLARITY3` writer"]
pub type W = crate::W<POLARITY3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cspol(&mut self) -> CSPOL_W<POLARITY3_SPEC, 0> {
        CSPOL_W::new(self)
    }
    #[doc = "Bit 1 - Read Enable Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn repol(&mut self) -> REPOL_W<POLARITY3_SPEC, 1> {
        REPOL_W::new(self)
    }
    #[doc = "Bit 2 - Write Enable Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn wepol(&mut self) -> WEPOL_W<POLARITY3_SPEC, 2> {
        WEPOL_W::new(self)
    }
    #[doc = "Bit 3 - Address Latch Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn alepol(&mut self) -> ALEPOL_W<POLARITY3_SPEC, 3> {
        ALEPOL_W::new(self)
    }
    #[doc = "Bit 4 - ARDY Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ardypol(&mut self) -> ARDYPOL_W<POLARITY3_SPEC, 4> {
        ARDYPOL_W::new(self)
    }
    #[doc = "Bit 5 - BL Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn blpol(&mut self) -> BLPOL_W<POLARITY3_SPEC, 5> {
        BLPOL_W::new(self)
    }
...
#[doc = "Polarity Register 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`polarity3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`polarity3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct POLARITY3_SPEC;
impl crate::RegisterSpec for POLARITY3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`polarity3::R`](R) reader structure"]
impl crate::Readable for POLARITY3_SPEC {}
