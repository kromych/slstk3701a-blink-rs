...
pub type R = crate::R<RdtimingSpec>;
#[doc = "Register `RDTIMING` writer"]
pub type W = crate::W<RdtimingSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Read Setup Time"]
    #[inline(always)]
    pub fn rdsetup(&mut self) -> RdsetupW<'_, RdtimingSpec> {
        RdsetupW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Read Strobe Time"]
    #[inline(always)]
    pub fn rdstrb(&mut self) -> RdstrbW<'_, RdtimingSpec> {
        RdstrbW::new(self, 8)
    }
    #[doc = "Bits 16:18 - Read Hold Time"]
    #[inline(always)]
    pub fn rdhold(&mut self) -> RdholdW<'_, RdtimingSpec> {
        RdholdW::new(self, 16)
    }
    #[doc = "Bit 28 - Half Cycle REn Strobe Duration Enable"]
    #[inline(always)]
    pub fn halfre(&mut self) -> HalfreW<'_, RdtimingSpec> {
        HalfreW::new(self, 28)
    }
    #[doc = "Bit 29 - Prefetch Enable"]
    #[inline(always)]
    pub fn prefetch(&mut self) -> PrefetchW<'_, RdtimingSpec> {
        PrefetchW::new(self, 29)
    }
    #[doc = "Bit 30 - Page Mode Access Enable"]
    #[inline(always)]
    pub fn pagemode(&mut self) -> PagemodeW<'_, RdtimingSpec> {
        PagemodeW::new(self, 30)
    }
}
#[doc = "Read Timing Register\n\nYou can [`read`](crate::Reg::read) this register and get [`rdtiming::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rdtiming::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RdtimingSpec;
impl crate::RegisterSpec for RdtimingSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rdtiming::R`](R) reader structure"]
impl crate::Readable for RdtimingSpec {}
#[doc = "`write(|w| ..)` method takes [`rdtiming::W`](W) writer structure"]
impl crate::Writable for RdtimingSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RDTIMING to value 0x0007_7f07"]
impl crate::Resettable for RdtimingSpec {
