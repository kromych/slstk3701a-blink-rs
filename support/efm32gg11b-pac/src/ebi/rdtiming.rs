...
pub type R = crate::R<RDTIMING_SPEC>;
#[doc = "Register `RDTIMING` writer"]
pub type W = crate::W<RDTIMING_SPEC>;
...
#[doc = "Read Timing Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rdtiming::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rdtiming::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
