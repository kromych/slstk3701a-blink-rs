...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdsetup(&mut self) -> RDSETUP_W<RDTIMING2_SPEC> {
        RDSETUP_W::new(self, 0)
    }
    #[doc = "Bits 8:14 - Read Strobe Time"]
    #[inline(always)]
    #[must_use]
    pub fn rdstrb(&mut self) -> RDSTRB_W<RDTIMING2_SPEC> {
        RDSTRB_W::new(self, 8)
    }
    #[doc = "Bits 16:18 - Read Hold Time"]
    #[inline(always)]
    #[must_use]
    pub fn rdhold(&mut self) -> RDHOLD_W<RDTIMING2_SPEC> {
        RDHOLD_W::new(self, 16)
    }
    #[doc = "Bit 28 - Half Cycle REn Strobe Duration Enable"]
    #[inline(always)]
    #[must_use]
    pub fn halfre(&mut self) -> HALFRE_W<RDTIMING2_SPEC> {
        HALFRE_W::new(self, 28)
    }
    #[doc = "Bit 29 - Prefetch Enable"]
    #[inline(always)]
    #[must_use]
    pub fn prefetch(&mut self) -> PREFETCH_W<RDTIMING2_SPEC> {
        PREFETCH_W::new(self, 29)
    }
    #[doc = "Bit 30 - Page Mode Access Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pagemode(&mut self) -> PAGEMODE_W<RDTIMING2_SPEC> {
