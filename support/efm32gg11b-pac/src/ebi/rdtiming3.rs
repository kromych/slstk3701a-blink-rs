...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdsetup(&mut self) -> RDSETUP_W<RDTIMING3_SPEC, 0> {
        RDSETUP_W::new(self)
    }
    #[doc = "Bits 8:14 - Read Strobe Time"]
    #[inline(always)]
    #[must_use]
    pub fn rdstrb(&mut self) -> RDSTRB_W<RDTIMING3_SPEC, 8> {
        RDSTRB_W::new(self)
    }
    #[doc = "Bits 16:18 - Read Hold Time"]
    #[inline(always)]
    #[must_use]
    pub fn rdhold(&mut self) -> RDHOLD_W<RDTIMING3_SPEC, 16> {
        RDHOLD_W::new(self)
    }
    #[doc = "Bit 28 - Half Cycle REn Strobe Duration Enable"]
    #[inline(always)]
    #[must_use]
    pub fn halfre(&mut self) -> HALFRE_W<RDTIMING3_SPEC, 28> {
        HALFRE_W::new(self)
    }
    #[doc = "Bit 29 - Prefetch Enable"]
    #[inline(always)]
    #[must_use]
    pub fn prefetch(&mut self) -> PREFETCH_W<RDTIMING3_SPEC, 29> {
        PREFETCH_W::new(self)
    }
    #[doc = "Bit 30 - Page Mode Access Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pagemode(&mut self) -> PAGEMODE_W<RDTIMING3_SPEC, 30> {
        PAGEMODE_W::new(self)
    }
