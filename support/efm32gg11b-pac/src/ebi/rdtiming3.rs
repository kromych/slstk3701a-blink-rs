...
pub type R = crate::R<Rdtiming3Spec>;
#[doc = "Register `RDTIMING3` writer"]
pub type W = crate::W<Rdtiming3Spec>;
...
impl W {
    #[doc = "Bits 0:2 - Read Setup Time"]
    #[inline(always)]
    pub fn rdsetup(&mut self) -> RdsetupW<'_, Rdtiming3Spec> {
        RdsetupW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Read Strobe Time"]
    #[inline(always)]
    pub fn rdstrb(&mut self) -> RdstrbW<'_, Rdtiming3Spec> {
        RdstrbW::new(self, 8)
    }
    #[doc = "Bits 16:18 - Read Hold Time"]
    #[inline(always)]
    pub fn rdhold(&mut self) -> RdholdW<'_, Rdtiming3Spec> {
        RdholdW::new(self, 16)
    }
    #[doc = "Bit 28 - Half Cycle REn Strobe Duration Enable"]
    #[inline(always)]
    pub fn halfre(&mut self) -> HalfreW<'_, Rdtiming3Spec> {
        HalfreW::new(self, 28)
    }
    #[doc = "Bit 29 - Prefetch Enable"]
    #[inline(always)]
    pub fn prefetch(&mut self) -> PrefetchW<'_, Rdtiming3Spec> {
        PrefetchW::new(self, 29)
    }
    #[doc = "Bit 30 - Page Mode Access Enable"]
    #[inline(always)]
    pub fn pagemode(&mut self) -> PagemodeW<'_, Rdtiming3Spec> {
        PagemodeW::new(self, 30)
    }
}
#[doc = "Read Timing Register 3\n\nYou can [`read`](crate::Reg::read) this register and get [`rdtiming3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rdtiming3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Rdtiming3Spec;
impl crate::RegisterSpec for Rdtiming3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rdtiming3::R`](R) reader structure"]
impl crate::Readable for Rdtiming3Spec {}
#[doc = "`write(|w| ..)` method takes [`rdtiming3::W`](W) writer structure"]
impl crate::Writable for Rdtiming3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RDTIMING3 to value 0x0007_7f07"]
impl crate::Resettable for Rdtiming3Spec {
