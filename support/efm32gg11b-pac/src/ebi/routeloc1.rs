...
impl ADLOC_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<ADLOC_A> {
        match self.bits {
            0 => Some(ADLOC_A::LOC0),
            1 => Some(ADLOC_A::LOC1),
            2 => Some(ADLOC_A::LOC2),
...
pub type ADLOC_W<'a, REG> = crate::FieldWriter<'a, REG, 6, ADLOC_A>;
impl<'a, REG> ADLOC_W<'a, REG>
where
...
impl ALOC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<ALOC_A> {
        match self.bits {
            0 => Some(ALOC_A::LOC0),
            1 => Some(ALOC_A::LOC1),
            2 => Some(ALOC_A::LOC2),
...
pub type ALOC_W<'a, REG> = crate::FieldWriter<'a, REG, 6, ALOC_A>;
impl<'a, REG> ALOC_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl RDYLOC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<RDYLOC_A> {
        match self.bits {
...
pub type RDYLOC_W<'a, REG> = crate::FieldWriter<'a, REG, 6, RDYLOC_A>;
impl<'a, REG> RDYLOC_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adloc(&mut self) -> ADLOC_W<ROUTELOC1_SPEC> {
        ADLOC_W::new(self, 0)
    }
    #[doc = "Bits 8:13 - I/O Location"]
    #[inline(always)]
    #[must_use]
    pub fn aloc(&mut self) -> ALOC_W<ROUTELOC1_SPEC> {
        ALOC_W::new(self, 8)
    }
    #[doc = "Bits 16:21 - I/O Location"]
    #[inline(always)]
    #[must_use]
    pub fn rdyloc(&mut self) -> RDYLOC_W<ROUTELOC1_SPEC> {
        RDYLOC_W::new(self, 16)
    }
