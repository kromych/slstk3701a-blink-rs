...
pub type EBIPEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type NANDPEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ALB_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, ALB_A>;
impl<'a, REG, const O: u8> ALB_W<'a, REG, O>
where
...
pub type APEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O, APEN_A>;
impl<'a, REG, const O: u8> APEN_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type TFTPEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DATAENPEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CSTFTPEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ebipen(&mut self) -> EBIPEN_W<ROUTEPEN_SPEC, 0> {
        EBIPEN_W::new(self)
    }
    #[doc = "Bit 1 - EBI_CS0 Pin Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn cs2pen(&mut self) -> CS2PEN_W<ROUTEPEN_SPEC, 3> {
        CS2PEN_W::new(self)
    }
    #[doc = "Bit 4 - EBI_CS3 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cs3pen(&mut self) -> CS3PEN_W<ROUTEPEN_SPEC, 4> {
        CS3PEN_W::new(self)
    }
    #[doc = "Bit 5 - EBI_ALE Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn alepen(&mut self) -> ALEPEN_W<ROUTEPEN_SPEC, 5> {
        ALEPEN_W::new(self)
    }
    #[doc = "Bit 6 - EBI_ARDY Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ardypen(&mut self) -> ARDYPEN_W<ROUTEPEN_SPEC, 6> {
        ARDYPEN_W::new(self)
    }
    #[doc = "Bit 7 - EBI_BL\\[1:0\\] Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn blpen(&mut self) -> BLPEN_W<ROUTEPEN_SPEC, 7> {
        BLPEN_W::new(self)
    }
    #[doc = "Bit 12 - NANDRE and NANDWE Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn nandpen(&mut self) -> NANDPEN_W<ROUTEPEN_SPEC, 12> {
        NANDPEN_W::new(self)
    }
    #[doc = "Bits 16:17 - Sets the Lower Bound for EBI_A Enabling"]
    #[inline(always)]
    #[must_use]
    pub fn alb(&mut self) -> ALB_W<ROUTEPEN_SPEC, 16> {
        ALB_W::new(self)
    }
    #[doc = "Bits 18:22 - EBI_A Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn apen(&mut self) -> APEN_W<ROUTEPEN_SPEC, 18> {
        APEN_W::new(self)
    }
    #[doc = "Bit 24 - EBI_TFT Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tftpen(&mut self) -> TFTPEN_W<ROUTEPEN_SPEC, 24> {
        TFTPEN_W::new(self)
    }
    #[doc = "Bit 25 - EBI_DATA Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dataenpen(&mut self) -> DATAENPEN_W<ROUTEPEN_SPEC, 25> {
        DATAENPEN_W::new(self)
    }
    #[doc = "Bit 26 - EBI_CSTFT Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cstftpen(&mut self) -> CSTFTPEN_W<ROUTEPEN_SPEC, 26> {
        CSTFTPEN_W::new(self)
    }
