...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wrsetup(&mut self) -> WRSETUP_W<WRTIMING2_SPEC, 0> {
        WRSETUP_W::new(self)
    }
    #[doc = "Bits 8:14 - Write Strobe Time"]
    #[inline(always)]
    #[must_use]
    pub fn wrstrb(&mut self) -> WRSTRB_W<WRTIMING2_SPEC, 8> {
        WRSTRB_W::new(self)
    }
    #[doc = "Bits 16:18 - Write Hold Time"]
    #[inline(always)]
    #[must_use]
    pub fn wrhold(&mut self) -> WRHOLD_W<WRTIMING2_SPEC, 16> {
        WRHOLD_W::new(self)
    }
    #[doc = "Bit 28 - Half Cycle WEn Strobe Duration Enable"]
    #[inline(always)]
    #[must_use]
    pub fn halfwe(&mut self) -> HALFWE_W<WRTIMING2_SPEC, 28> {
        HALFWE_W::new(self)
    }
    #[doc = "Bit 29 - Write Buffer Disable"]
    #[inline(always)]
    #[must_use]
    pub fn wbufdis(&mut self) -> WBUFDIS_W<WRTIMING2_SPEC, 29> {
        WBUFDIS_W::new(self)
    }
