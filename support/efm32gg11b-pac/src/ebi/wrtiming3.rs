...
pub type R = crate::R<Wrtiming3Spec>;
#[doc = "Register `WRTIMING3` writer"]
pub type W = crate::W<Wrtiming3Spec>;
...
impl W {
    #[doc = "Bits 0:2 - Write Setup Time"]
    #[inline(always)]
    pub fn wrsetup(&mut self) -> WrsetupW<'_, Wrtiming3Spec> {
        WrsetupW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Write Strobe Time"]
    #[inline(always)]
    pub fn wrstrb(&mut self) -> WrstrbW<'_, Wrtiming3Spec> {
        WrstrbW::new(self, 8)
    }
    #[doc = "Bits 16:18 - Write Hold Time"]
    #[inline(always)]
    pub fn wrhold(&mut self) -> WrholdW<'_, Wrtiming3Spec> {
        WrholdW::new(self, 16)
    }
    #[doc = "Bit 28 - Half Cycle WEn Strobe Duration Enable"]
    #[inline(always)]
    pub fn halfwe(&mut self) -> HalfweW<'_, Wrtiming3Spec> {
        HalfweW::new(self, 28)
    }
    #[doc = "Bit 29 - Write Buffer Disable"]
    #[inline(always)]
    pub fn wbufdis(&mut self) -> WbufdisW<'_, Wrtiming3Spec> {
        WbufdisW::new(self, 29)
    }
}
#[doc = "Write Timing Register 3\n\nYou can [`read`](crate::Reg::read) this register and get [`wrtiming3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wrtiming3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Wrtiming3Spec;
impl crate::RegisterSpec for Wrtiming3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wrtiming3::R`](R) reader structure"]
impl crate::Readable for Wrtiming3Spec {}
#[doc = "`write(|w| ..)` method takes [`wrtiming3::W`](W) writer structure"]
impl crate::Writable for Wrtiming3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WRTIMING3 to value 0x0007_7f07"]
impl crate::Resettable for Wrtiming3Spec {
