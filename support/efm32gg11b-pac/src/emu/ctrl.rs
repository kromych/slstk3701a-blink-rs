...
pub type EM2BODDIS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EM01LD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EM23VSCALEAUTOWSEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl EM23VSCALE_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<EM23VSCALE_A> {
        match self.bits {
...
pub type EM23VSCALE_W<'a, REG> = crate::FieldWriter<'a, REG, 2, EM23VSCALE_A>;
impl<'a, REG> EM23VSCALE_W<'a, REG>
where
...
impl EM4HVSCALE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<EM4HVSCALE_A> {
        match self.bits {
...
pub type EM4HVSCALE_W<'a, REG> = crate::FieldWriter<'a, REG, 2, EM4HVSCALE_A>;
impl<'a, REG> EM4HVSCALE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn em2boddis(&mut self) -> EM2BODDIS_W<CTRL_SPEC> {
        EM2BODDIS_W::new(self, 2)
    }
    #[doc = "Bit 3 - Reserved for internal use. Do not change."]
    #[inline(always)]
    #[must_use]
    pub fn em01ld(&mut self) -> EM01LD_W<CTRL_SPEC> {
        EM01LD_W::new(self, 3)
    }
    #[doc = "Bit 4 - Automatically Configures Flash and Frequency to Wakeup From EM2 or EM3 at Low Voltage"]
    #[inline(always)]
    #[must_use]
    pub fn em23vscaleautowsen(&mut self) -> EM23VSCALEAUTOWSEN_W<CTRL_SPEC> {
        EM23VSCALEAUTOWSEN_W::new(self, 4)
    }
    #[doc = "Bits 8:9 - EM23 Voltage Scale"]
    #[inline(always)]
    #[must_use]
    pub fn em23vscale(&mut self) -> EM23VSCALE_W<CTRL_SPEC> {
        EM23VSCALE_W::new(self, 8)
    }
    #[doc = "Bits 16:17 - EM4H Voltage Scale"]
    #[inline(always)]
    #[must_use]
    pub fn em4hvscale(&mut self) -> EM4HVSCALE_W<CTRL_SPEC> {
        EM4HVSCALE_W::new(self, 16)
    }
