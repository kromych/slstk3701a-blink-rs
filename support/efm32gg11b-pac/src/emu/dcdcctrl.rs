...
impl DCDCMODE_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> DCDCMODE_A {
        match self.bits {
            0 => DCDCMODE_A::BYPASS,
...
pub type DCDCMODE_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, DCDCMODE_A>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcdcmode(&mut self) -> DCDCMODE_W<DCDCCTRL_SPEC> {
        DCDCMODE_W::new(self, 0)
    }
    #[doc = "Bit 4 - DCDC Mode EM23"]
    #[inline(always)]
    #[must_use]
    pub fn dcdcmodeem23(&mut self) -> DCDCMODEEM23_W<DCDCCTRL_SPEC> {
        DCDCMODEEM23_W::new(self, 4)
    }
    #[doc = "Bit 5 - DCDC Mode EM4H"]
    #[inline(always)]
    #[must_use]
    pub fn dcdcmodeem4(&mut self) -> DCDCMODEEM4_W<DCDCCTRL_SPEC> {
