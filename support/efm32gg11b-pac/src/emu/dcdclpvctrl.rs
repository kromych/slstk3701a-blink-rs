...
pub type R = crate::R<DcdclpvctrlSpec>;
#[doc = "Register `DCDCLPVCTRL` writer"]
pub type W = crate::W<DcdclpvctrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Low Power Feedback Attenuation"]
    #[inline(always)]
    pub fn lpatt(&mut self) -> LpattW<'_, DcdclpvctrlSpec> {
        LpattW::new(self, 0)
    }
    #[doc = "Bits 1:8 - LP Mode Reference Selection for EM23 and EM4H"]
    #[inline(always)]
    pub fn lpvref(&mut self) -> LpvrefW<'_, DcdclpvctrlSpec> {
        LpvrefW::new(self, 1)
    }
}
...
pub struct DcdclpvctrlSpec;
impl crate::RegisterSpec for DcdclpvctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dcdclpvctrl::R`](R) reader structure"]
impl crate::Readable for DcdclpvctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`dcdclpvctrl::W`](W) writer structure"]
impl crate::Writable for DcdclpvctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DCDCLPVCTRL to value 0x0168"]
impl crate::Resettable for DcdclpvctrlSpec {
