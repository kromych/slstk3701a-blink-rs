...
pub type ACMP0DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ACMP1DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PCNT0DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PCNT1DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PCNT2DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C0DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C1DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type VDAC0DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IDAC0DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ADC0DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LETIMER0DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type WDOG0DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type WDOG1DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LESENSE0DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CSENDIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LEUART0DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LEUART1DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LCDDIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LETIMER1DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C2DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ADC1DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ACMP2DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ACMP3DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RTCDIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type USBDIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn acmp0dis(&mut self) -> ACMP0DIS_W<EM23PERNORETAINCTRL_SPEC, 0> {
        ACMP0DIS_W::new(self)
    }
    #[doc = "Bit 1 - Allow Power Down of ACMP1 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn acmp1dis(&mut self) -> ACMP1DIS_W<EM23PERNORETAINCTRL_SPEC, 1> {
        ACMP1DIS_W::new(self)
    }
    #[doc = "Bit 2 - Allow Power Down of PCNT0 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn pcnt0dis(&mut self) -> PCNT0DIS_W<EM23PERNORETAINCTRL_SPEC, 2> {
        PCNT0DIS_W::new(self)
    }
    #[doc = "Bit 3 - Allow Power Down of PCNT1 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn pcnt1dis(&mut self) -> PCNT1DIS_W<EM23PERNORETAINCTRL_SPEC, 3> {
        PCNT1DIS_W::new(self)
    }
    #[doc = "Bit 4 - Allow Power Down of PCNT2 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn pcnt2dis(&mut self) -> PCNT2DIS_W<EM23PERNORETAINCTRL_SPEC, 4> {
        PCNT2DIS_W::new(self)
    }
    #[doc = "Bit 5 - Allow Power Down of I2C0 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn i2c0dis(&mut self) -> I2C0DIS_W<EM23PERNORETAINCTRL_SPEC, 5> {
        I2C0DIS_W::new(self)
    }
    #[doc = "Bit 6 - Allow Power Down of I2C1 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn i2c1dis(&mut self) -> I2C1DIS_W<EM23PERNORETAINCTRL_SPEC, 6> {
        I2C1DIS_W::new(self)
    }
    #[doc = "Bit 7 - Allow Power Down of DAC0 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn vdac0dis(&mut self) -> VDAC0DIS_W<EM23PERNORETAINCTRL_SPEC, 7> {
        VDAC0DIS_W::new(self)
    }
    #[doc = "Bit 8 - Allow Power Down of IDAC0 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn idac0dis(&mut self) -> IDAC0DIS_W<EM23PERNORETAINCTRL_SPEC, 8> {
        IDAC0DIS_W::new(self)
    }
    #[doc = "Bit 9 - Allow Power Down of ADC0 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn adc0dis(&mut self) -> ADC0DIS_W<EM23PERNORETAINCTRL_SPEC, 9> {
        ADC0DIS_W::new(self)
    }
    #[doc = "Bit 10 - Allow Power Down of LETIMER0 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn letimer0dis(&mut self) -> LETIMER0DIS_W<EM23PERNORETAINCTRL_SPEC, 10> {
        LETIMER0DIS_W::new(self)
    }
    #[doc = "Bit 11 - Allow Power Down of WDOG0 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn wdog0dis(&mut self) -> WDOG0DIS_W<EM23PERNORETAINCTRL_SPEC, 11> {
        WDOG0DIS_W::new(self)
    }
    #[doc = "Bit 12 - Allow Power Down of WDOG1 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn wdog1dis(&mut self) -> WDOG1DIS_W<EM23PERNORETAINCTRL_SPEC, 12> {
        WDOG1DIS_W::new(self)
    }
    #[doc = "Bit 13 - Allow Power Down of LESENSE0 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn lesense0dis(&mut self) -> LESENSE0DIS_W<EM23PERNORETAINCTRL_SPEC, 13> {
        LESENSE0DIS_W::new(self)
    }
    #[doc = "Bit 14 - Allow Power Down of CSEN During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn csendis(&mut self) -> CSENDIS_W<EM23PERNORETAINCTRL_SPEC, 14> {
        CSENDIS_W::new(self)
    }
    #[doc = "Bit 15 - Allow Power Down of LEUART0 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn leuart0dis(&mut self) -> LEUART0DIS_W<EM23PERNORETAINCTRL_SPEC, 15> {
        LEUART0DIS_W::new(self)
    }
    #[doc = "Bit 16 - Allow Power Down of LEUART1 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn leuart1dis(&mut self) -> LEUART1DIS_W<EM23PERNORETAINCTRL_SPEC, 16> {
        LEUART1DIS_W::new(self)
    }
    #[doc = "Bit 17 - Allow Power Down of LCD During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn lcddis(&mut self) -> LCDDIS_W<EM23PERNORETAINCTRL_SPEC, 17> {
        LCDDIS_W::new(self)
    }
    #[doc = "Bit 18 - Allow Power Down of LETIMER1 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn letimer1dis(&mut self) -> LETIMER1DIS_W<EM23PERNORETAINCTRL_SPEC, 18> {
        LETIMER1DIS_W::new(self)
    }
    #[doc = "Bit 19 - Allow Power Down of I2C2 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn i2c2dis(&mut self) -> I2C2DIS_W<EM23PERNORETAINCTRL_SPEC, 19> {
        I2C2DIS_W::new(self)
    }
    #[doc = "Bit 20 - Allow Power Down of ADC1 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn adc1dis(&mut self) -> ADC1DIS_W<EM23PERNORETAINCTRL_SPEC, 20> {
        ADC1DIS_W::new(self)
    }
    #[doc = "Bit 21 - Allow Power Down of ACMP2 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn acmp2dis(&mut self) -> ACMP2DIS_W<EM23PERNORETAINCTRL_SPEC, 21> {
        ACMP2DIS_W::new(self)
    }
    #[doc = "Bit 22 - Allow Power Down of ACMP3 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn acmp3dis(&mut self) -> ACMP3DIS_W<EM23PERNORETAINCTRL_SPEC, 22> {
        ACMP3DIS_W::new(self)
    }
    #[doc = "Bit 23 - Allow Power Down of RTC During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn rtcdis(&mut self) -> RTCDIS_W<EM23PERNORETAINCTRL_SPEC, 23> {
        RTCDIS_W::new(self)
    }
    #[doc = "Bit 24 - Allow Power Down of USB During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn usbdis(&mut self) -> USBDIS_W<EM23PERNORETAINCTRL_SPEC, 24> {
        USBDIS_W::new(self)
    }
