...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vmonio1fall(&mut self) -> VMONIO1FALL_W<IEN_SPEC, 8> {
        VMONIO1FALL_W::new(self)
    }
    #[doc = "Bit 9 - VMONIO1RISE Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn vmonio1rise(&mut self) -> VMONIO1RISE_W<IEN_SPEC, 9> {
        VMONIO1RISE_W::new(self)
    }
    #[doc = "Bit 10 - R5VREADY Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn r5vready(&mut self) -> R5VREADY_W<IEN_SPEC, 10> {
        R5VREADY_W::new(self)
    }
    #[doc = "Bit 12 - VMONBUVDDFALL Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn vmonbuvddfall(&mut self) -> VMONBUVDDFALL_W<IEN_SPEC, 12> {
        VMONBUVDDFALL_W::new(self)
    }
    #[doc = "Bit 13 - VMONBUVDDRISE Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn vmonbuvddrise(&mut self) -> VMONBUVDDRISE_W<IEN_SPEC, 13> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn burdy(&mut self) -> BURDY_W<IEN_SPEC, 22> {
        BURDY_W::new(self)
    }
    #[doc = "Bit 23 - R5VVSINT Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn r5vvsint(&mut self) -> R5VVSINT_W<IEN_SPEC, 23> {
        R5VVSINT_W::new(self)
    }
    #[doc = "Bit 24 - EM23WAKEUP Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn vscaledone(&mut self) -> VSCALEDONE_W<IEN_SPEC, 25> {
