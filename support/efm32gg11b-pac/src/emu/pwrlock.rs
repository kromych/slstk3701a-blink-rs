...
pub type R = crate::R<PwrlockSpec>;
#[doc = "Register `PWRLOCK` writer"]
pub type W = crate::W<PwrlockSpec>;
...
impl W {
    #[doc = "Bits 0:15 - Regulator and Supply Configuration Lock Key"]
    #[inline(always)]
    pub fn lockkey(&mut self) -> LockkeyW<'_, PwrlockSpec> {
        LockkeyW::new(self, 0)
    }
}
...
pub struct PwrlockSpec;
impl crate::RegisterSpec for PwrlockSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwrlock::R`](R) reader structure"]
impl crate::Readable for PwrlockSpec {}
#[doc = "`write(|w| ..)` method takes [`pwrlock::W`](W) writer structure"]
impl crate::Writable for PwrlockSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PWRLOCK to value 0"]
impl crate::Resettable for PwrlockSpec {}
