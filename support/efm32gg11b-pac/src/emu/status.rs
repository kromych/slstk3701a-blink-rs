...
pub type VMONIO1_R = crate::BitReader;
#[doc = "Field `VMONBUVDD` reader - VMON BUVDD Channel"]
pub type VMONBUVDD_R = crate::BitReader;
...
pub type VSCALE_R = crate::FieldReader<VSCALE_A>;
...
impl crate::FieldSpec for VSCALE_A {
    type Ux = u8;
}
impl VSCALE_R {
...
pub type VSCALEBUSY_R = crate::BitReader;
...
pub type TEMPACTIVE_R = crate::BitReader;
impl R {
