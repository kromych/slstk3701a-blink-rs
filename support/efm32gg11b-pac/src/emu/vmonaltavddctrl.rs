...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<VMONALTAVDDCTRL_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bit 2 - Rise Wakeup"]
    #[inline(always)]
    #[must_use]
    pub fn risewu(&mut self) -> RISEWU_W<VMONALTAVDDCTRL_SPEC> {
        RISEWU_W::new(self, 2)
    }
    #[doc = "Bit 3 - Fall Wakeup"]
    #[inline(always)]
    #[must_use]
    pub fn fallwu(&mut self) -> FALLWU_W<VMONALTAVDDCTRL_SPEC> {
        FALLWU_W::new(self, 3)
    }
    #[doc = "Bits 8:11 - Threshold Fine Adjust"]
    #[inline(always)]
    #[must_use]
    pub fn thresfine(&mut self) -> THRESFINE_W<VMONALTAVDDCTRL_SPEC> {
        THRESFINE_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Threshold Coarse Adjust"]
    #[inline(always)]
    #[must_use]
    pub fn threscoarse(&mut self) -> THRESCOARSE_W<VMONALTAVDDCTRL_SPEC> {
