...
pub type R = crate::R<VmondvddctrlSpec>;
#[doc = "Register `VMONDVDDCTRL` writer"]
pub type W = crate::W<VmondvddctrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Enable"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, VmondvddctrlSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bit 2 - Rise Wakeup"]
    #[inline(always)]
    pub fn risewu(&mut self) -> RisewuW<'_, VmondvddctrlSpec> {
        RisewuW::new(self, 2)
    }
    #[doc = "Bit 3 - Fall Wakeup"]
    #[inline(always)]
    pub fn fallwu(&mut self) -> FallwuW<'_, VmondvddctrlSpec> {
        FallwuW::new(self, 3)
    }
    #[doc = "Bits 8:11 - Threshold Fine Adjust"]
    #[inline(always)]
    pub fn thresfine(&mut self) -> ThresfineW<'_, VmondvddctrlSpec> {
        ThresfineW::new(self, 8)
    }
    #[doc = "Bits 12:15 - Threshold Coarse Adjust"]
    #[inline(always)]
    pub fn threscoarse(&mut self) -> ThrescoarseW<'_, VmondvddctrlSpec> {
...
pub struct VmondvddctrlSpec;
impl crate::RegisterSpec for VmondvddctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`vmondvddctrl::R`](R) reader structure"]
impl crate::Readable for VmondvddctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`vmondvddctrl::W`](W) writer structure"]
impl crate::Writable for VmondvddctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets VMONDVDDCTRL to value 0"]
impl crate::Resettable for VmondvddctrlSpec {}
