...
pub type R = crate::R<Framesrxed1024Spec>;
#[doc = "Register `FRAMESRXED1024` writer"]
pub type W = crate::W<Framesrxed1024Spec>;
...
impl W {
    #[doc = "Bits 0:31 - 1024 to 1518 byte frames received without error"]
    #[inline(always)]
    pub fn count(&mut self) -> CountW<'_, Framesrxed1024Spec> {
        CountW::new(self, 0)
    }
}
#[doc = "1024 to 1518 Byte Frames Received\n\nYou can [`read`](crate::Reg::read) this register and get [`framesrxed1024::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`framesrxed1024::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Framesrxed1024Spec;
impl crate::RegisterSpec for Framesrxed1024Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`framesrxed1024::R`](R) reader structure"]
impl crate::Readable for Framesrxed1024Spec {}
#[doc = "`write(|w| ..)` method takes [`framesrxed1024::W`](W) writer structure"]
impl crate::Writable for Framesrxed1024Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FRAMESRXED1024 to value 0"]
impl crate::Resettable for Framesrxed1024Spec {}
