...
pub type R = crate::R<FRAMESRXED1519_SPEC>;
#[doc = "Register `FRAMESRXED1519` writer"]
pub type W = crate::W<FRAMESRXED1519_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn count(&mut self) -> COUNT_W<FRAMESRXED1519_SPEC, 0> {
        COUNT_W::new(self)
    }
...
#[doc = "1519 to maximum Byte Frames Received\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`framesrxed1519::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`framesrxed1519::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
