...
pub type R = crate::R<FRAMESRXED65_SPEC>;
#[doc = "Register `FRAMESRXED65` writer"]
pub type W = crate::W<FRAMESRXED65_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn count(&mut self) -> COUNT_W<FRAMESRXED65_SPEC, 0> {
        COUNT_W::new(self)
    }
