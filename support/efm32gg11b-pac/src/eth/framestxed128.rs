...
pub type R = crate::R<FRAMESTXED128_SPEC>;
#[doc = "Register `FRAMESTXED128` writer"]
pub type W = crate::W<FRAMESTXED128_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn count(&mut self) -> COUNT_W<FRAMESTXED128_SPEC, 0> {
        COUNT_W::new(self)
    }
...
#[doc = "128 to 255 Byte Frames Transmitted\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`framestxed128::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`framestxed128::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
