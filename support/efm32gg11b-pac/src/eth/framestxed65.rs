...
pub type R = crate::R<FRAMESTXED65_SPEC>;
#[doc = "Register `FRAMESTXED65` writer"]
pub type W = crate::W<FRAMESTXED65_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn count(&mut self) -> COUNT_W<FRAMESTXED65_SPEC, 0> {
        COUNT_W::new(self)
    }
...
#[doc = "65 to 127 Byte Frames Transmitted\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`framestxed65::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`framestxed65::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
