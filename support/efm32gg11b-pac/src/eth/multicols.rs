...
pub type R = crate::R<MULTICOLS_SPEC>;
#[doc = "Register `MULTICOLS` writer"]
pub type W = crate::W<MULTICOLS_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn count(&mut self) -> COUNT_W<MULTICOLS_SPEC, 0> {
        COUNT_W::new(self)
    }
...
#[doc = "Multiple Collision Frames\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`multicols::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`multicols::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
