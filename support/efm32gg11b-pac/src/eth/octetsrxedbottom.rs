...
pub type R = crate::R<OCTETSRXEDBOTTOM_SPEC>;
#[doc = "Register `OCTETSRXEDBOTTOM` writer"]
pub type W = crate::W<OCTETSRXEDBOTTOM_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn count(&mut self) -> COUNT_W<OCTETSRXEDBOTTOM_SPEC, 0> {
        COUNT_W::new(self)
    }
...
#[doc = "Octets Received 31:0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`octetsrxedbottom::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`octetsrxedbottom::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
