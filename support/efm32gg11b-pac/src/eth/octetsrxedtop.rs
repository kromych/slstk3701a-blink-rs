...
pub type R = crate::R<OCTETSRXEDTOP_SPEC>;
#[doc = "Register `OCTETSRXEDTOP` writer"]
pub type W = crate::W<OCTETSRXEDTOP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn count(&mut self) -> COUNT_W<OCTETSRXEDTOP_SPEC, 0> {
        COUNT_W::new(self)
    }
