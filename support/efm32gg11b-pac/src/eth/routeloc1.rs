...
pub type TSUEXTCLKLOC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O, TSUEXTCLKLOC_A>;
impl<'a, REG, const O: u8> TSUEXTCLKLOC_W<'a, REG, O>
where
...
pub type TSUTMRTOGLOC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O, TSUTMRTOGLOC_A>;
impl<'a, REG, const O: u8> TSUTMRTOGLOC_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type MDIOLOC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O, MDIOLOC_A>;
impl<'a, REG, const O: u8> MDIOLOC_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type RMIILOC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O, RMIILOC_A>;
impl<'a, REG, const O: u8> RMIILOC_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tsuextclkloc(&mut self) -> TSUEXTCLKLOC_W<ROUTELOC1_SPEC, 0> {
        TSUEXTCLKLOC_W::new(self)
    }
    #[doc = "Bits 8:13 - I/O Location"]
    #[inline(always)]
    #[must_use]
    pub fn tsutmrtogloc(&mut self) -> TSUTMRTOGLOC_W<ROUTELOC1_SPEC, 8> {
        TSUTMRTOGLOC_W::new(self)
    }
    #[doc = "Bits 16:21 - I/O Location"]
    #[inline(always)]
    #[must_use]
    pub fn mdioloc(&mut self) -> MDIOLOC_W<ROUTELOC1_SPEC, 16> {
        MDIOLOC_W::new(self)
    }
    #[doc = "Bits 24:29 - I/O Location"]
    #[inline(always)]
    #[must_use]
    pub fn rmiiloc(&mut self) -> RMIILOC_W<ROUTELOC1_SPEC, 24> {
        RMIILOC_W::new(self)
    }
