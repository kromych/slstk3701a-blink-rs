...
pub type R = crate::R<SPECADDR2BOTTOM_SPEC>;
#[doc = "Register `SPECADDR2BOTTOM` writer"]
pub type W = crate::W<SPECADDR2BOTTOM_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addr(&mut self) -> ADDR_W<SPECADDR2BOTTOM_SPEC, 0> {
        ADDR_W::new(self)
    }
...
#[doc = "Specific Address 2 Bottom\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`specaddr2bottom::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`specaddr2bottom::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
