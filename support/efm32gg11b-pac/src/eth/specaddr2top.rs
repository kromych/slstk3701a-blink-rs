...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addr(&mut self) -> ADDR_W<SPECADDR2TOP_SPEC> {
        ADDR_W::new(self, 0)
    }
    #[doc = "Bit 16 - MAC SA or DA selection"]
    #[inline(always)]
    #[must_use]
    pub fn filtertype(&mut self) -> FILTERTYPE_W<SPECADDR2TOP_SPEC> {
        FILTERTYPE_W::new(self, 16)
    }
    #[doc = "Bits 24:29 - Filter byte Mask"]
    #[inline(always)]
    #[must_use]
    pub fn filterbytemask(&mut self) -> FILTERBYTEMASK_W<SPECADDR2TOP_SPEC> {
