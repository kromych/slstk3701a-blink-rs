...
pub type R = crate::R<Specaddr2topSpec>;
#[doc = "Register `SPECADDR2TOP` writer"]
pub type W = crate::W<Specaddr2topSpec>;
...
impl W {
    #[doc = "Bits 0:15 - Specific address 2 MSB"]
    #[inline(always)]
    pub fn addr(&mut self) -> AddrW<'_, Specaddr2topSpec> {
        AddrW::new(self, 0)
    }
    #[doc = "Bit 16 - MAC SA or DA selection"]
    #[inline(always)]
    pub fn filtertype(&mut self) -> FiltertypeW<'_, Specaddr2topSpec> {
        FiltertypeW::new(self, 16)
    }
    #[doc = "Bits 24:29 - Filter byte Mask"]
    #[inline(always)]
    pub fn filterbytemask(&mut self) -> FilterbytemaskW<'_, Specaddr2topSpec> {
        FilterbytemaskW::new(self, 24)
    }
}
#[doc = "Specific Address 2 Top\n\nYou can [`read`](crate::Reg::read) this register and get [`specaddr2top::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`specaddr2top::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Specaddr2topSpec;
impl crate::RegisterSpec for Specaddr2topSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`specaddr2top::R`](R) reader structure"]
impl crate::Readable for Specaddr2topSpec {}
#[doc = "`write(|w| ..)` method takes [`specaddr2top::W`](W) writer structure"]
impl crate::Writable for Specaddr2topSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPECADDR2TOP to value 0"]
impl crate::Resettable for Specaddr2topSpec {}
