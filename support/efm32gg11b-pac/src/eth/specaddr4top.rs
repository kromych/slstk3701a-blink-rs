...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addr(&mut self) -> ADDR_W<SPECADDR4TOP_SPEC, 0> {
        ADDR_W::new(self)
    }
    #[doc = "Bit 16 - MAC SA or DA selection"]
    #[inline(always)]
    #[must_use]
    pub fn filtertype(&mut self) -> FILTERTYPE_W<SPECADDR4TOP_SPEC, 16> {
        FILTERTYPE_W::new(self)
    }
    #[doc = "Bits 24:29 - Filter byte Mask"]
    #[inline(always)]
    #[must_use]
    pub fn filterbytemask(&mut self) -> FILTERBYTEMASK_W<SPECADDR4TOP_SPEC, 24> {
