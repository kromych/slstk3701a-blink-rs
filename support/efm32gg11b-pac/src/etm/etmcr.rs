...
pub type POWERDWN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BRANCHOUTPUT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DBGREQCTRL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ETMPROG` reader - ETM Programming"]
pub type ETMPROG_R = crate::BitReader;
#[doc = "Field `ETMPROG` writer - ETM Programming"]
pub type ETMPROG_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETMPORTSEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EPORTSIZE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type TSTAMPEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn powerdwn(&mut self) -> POWERDWN_W<ETMCR_SPEC, 0> {
        POWERDWN_W::new(self)
    }
    #[doc = "Bits 4:6 - ETM Port Size"]
    #[inline(always)]
    #[must_use]
    pub fn portsize(&mut self) -> PORTSIZE_W<ETMCR_SPEC, 4> {
        PORTSIZE_W::new(self)
    }
    #[doc = "Bit 7 - Stall Processor"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> STALL_W<ETMCR_SPEC, 7> {
        STALL_W::new(self)
    }
    #[doc = "Bit 8 - Branch Output"]
    #[inline(always)]
    #[must_use]
    pub fn branchoutput(&mut self) -> BRANCHOUTPUT_W<ETMCR_SPEC, 8> {
        BRANCHOUTPUT_W::new(self)
    }
    #[doc = "Bit 9 - Debug Request Control"]
    #[inline(always)]
    #[must_use]
    pub fn dbgreqctrl(&mut self) -> DBGREQCTRL_W<ETMCR_SPEC, 9> {
        DBGREQCTRL_W::new(self)
    }
    #[doc = "Bit 10 - ETM Programming"]
    #[inline(always)]
    #[must_use]
    pub fn etmprog(&mut self) -> ETMPROG_W<ETMCR_SPEC, 10> {
        ETMPROG_W::new(self)
    }
    #[doc = "Bit 11 - ETM Port Selection"]
    #[inline(always)]
    #[must_use]
    pub fn etmportsel(&mut self) -> ETMPORTSEL_W<ETMCR_SPEC, 11> {
        ETMPORTSEL_W::new(self)
    }
    #[doc = "Bit 13 - Port Mode\\[2\\]"]
    #[inline(always)]
    #[must_use]
    pub fn portmode2(&mut self) -> PORTMODE2_W<ETMCR_SPEC, 13> {
        PORTMODE2_W::new(self)
    }
    #[doc = "Bits 16:17 - Port Mode Control"]
    #[inline(always)]
    #[must_use]
    pub fn portmode(&mut self) -> PORTMODE_W<ETMCR_SPEC, 16> {
        PORTMODE_W::new(self)
    }
    #[doc = "Bits 21:22 - Port Size\\[3\\]"]
    #[inline(always)]
    #[must_use]
    pub fn eportsize(&mut self) -> EPORTSIZE_W<ETMCR_SPEC, 21> {
        EPORTSIZE_W::new(self)
    }
    #[doc = "Bit 28 - Time Stamp Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tstampen(&mut self) -> TSTAMPEN_W<ETMCR_SPEC, 28> {
        TSTAMPEN_W::new(self)
    }
