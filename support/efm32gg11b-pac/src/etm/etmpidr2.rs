...
#[doc = "Peripheral ID2 Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`etmpidr2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
