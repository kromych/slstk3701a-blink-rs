...
pub type W = crate::W<ETMPIDR5_SPEC>;
impl core::fmt::Debug for crate::generic::Reg<ETMPIDR5_SPEC> {
...
#[doc = "Peripheral ID5 Register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`etmpidr5::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
