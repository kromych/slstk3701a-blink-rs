...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn polysel(&mut self) -> POLYSEL_W<CTRL_SPEC> {
        POLYSEL_W::new(self, 4)
    }
    #[doc = "Bit 8 - Byte Mode Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bytemode(&mut self) -> BYTEMODE_W<CTRL_SPEC> {
        BYTEMODE_W::new(self, 8)
    }
    #[doc = "Bit 9 - Byte-level Bit Reverse Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bitreverse(&mut self) -> BITREVERSE_W<CTRL_SPEC> {
        BITREVERSE_W::new(self, 9)
    }
    #[doc = "Bit 10 - Byte Reverse Mode"]
    #[inline(always)]
    #[must_use]
    pub fn bytereverse(&mut self) -> BYTEREVERSE_W<CTRL_SPEC> {
        BYTEREVERSE_W::new(self, 10)
    }
    #[doc = "Bit 13 - Auto Init Enable"]
    #[inline(always)]
    #[must_use]
    pub fn autoinit(&mut self) -> AUTOINIT_W<CTRL_SPEC> {
