...
pub type EM4WU2_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EM4WU3_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EM4WU5_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EM4WU6_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EM4WU7_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn em4wu0(&mut self) -> EM4WU0_W<EXTILEVEL_SPEC> {
        EM4WU0_W::new(self, 16)
    }
    #[doc = "Bit 17 - EM4 Wake Up Level for EM4WU1 Pin"]
    #[inline(always)]
    #[must_use]
    pub fn em4wu1(&mut self) -> EM4WU1_W<EXTILEVEL_SPEC> {
        EM4WU1_W::new(self, 17)
    }
    #[doc = "Bit 18 - EM4 Wake Up Level for EM4WU2 Pin"]
    #[inline(always)]
    #[must_use]
    pub fn em4wu2(&mut self) -> EM4WU2_W<EXTILEVEL_SPEC> {
        EM4WU2_W::new(self, 18)
    }
    #[doc = "Bit 19 - EM4 Wake Up Level for EM4WU3 Pin"]
    #[inline(always)]
    #[must_use]
    pub fn em4wu3(&mut self) -> EM4WU3_W<EXTILEVEL_SPEC> {
        EM4WU3_W::new(self, 19)
    }
    #[doc = "Bit 20 - EM4 Wake Up Level for EM4WU4 Pin"]
    #[inline(always)]
    #[must_use]
    pub fn em4wu4(&mut self) -> EM4WU4_W<EXTILEVEL_SPEC> {
        EM4WU4_W::new(self, 20)
    }
    #[doc = "Bit 21 - EM4 Wake Up Level for EM4WU5 Pin"]
    #[inline(always)]
    #[must_use]
    pub fn em4wu5(&mut self) -> EM4WU5_W<EXTILEVEL_SPEC> {
        EM4WU5_W::new(self, 21)
    }
    #[doc = "Bit 22 - EM4 Wake Up Level for EM4WU6 Pin"]
    #[inline(always)]
    #[must_use]
    pub fn em4wu6(&mut self) -> EM4WU6_W<EXTILEVEL_SPEC> {
        EM4WU6_W::new(self, 22)
    }
    #[doc = "Bit 23 - EM4 Wake Up Level for EM4WU7 Pin"]
    #[inline(always)]
    #[must_use]
    pub fn em4wu7(&mut self) -> EM4WU7_W<EXTILEVEL_SPEC> {
        EM4WU7_W::new(self, 23)
    }
    #[doc = "Bit 24 - EM4 Wake Up Level for EM4WU8 Pin"]
    #[inline(always)]
    #[must_use]
    pub fn em4wu8(&mut self) -> EM4WU8_W<EXTILEVEL_SPEC> {
        EM4WU8_W::new(self, 24)
    }
    #[doc = "Bit 25 - EM4 Wake Up Level for EM4WU9 Pin"]
    #[inline(always)]
    #[must_use]
    pub fn em4wu9(&mut self) -> EM4WU9_W<EXTILEVEL_SPEC> {
