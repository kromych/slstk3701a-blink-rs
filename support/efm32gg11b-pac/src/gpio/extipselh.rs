...
impl Extipsel8R {
    ...
    pub const fn variant(&self) -> Option<Extipsel8> {
        match self.bits {
            ...
            6 => Some(Extipsel8::Portg),
            7 => Some(Extipsel8::Porth),
            8 => Some(Extipsel8::Porti),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn portg(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel8::Portg)
    }
    #[doc = "Port H group selected for external interrupt 8"]
    #[inline(always)]
    pub fn porth(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel8::Porth)
    }
    #[doc = "Port I group selected for external interrupt 8"]
    #[inline(always)]
    pub fn porti(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel8::Porti)
    }
}
...
impl Extipsel9R {
    ...
    pub const fn variant(&self) -> Option<Extipsel9> {
        match self.bits {
            ...
            6 => Some(Extipsel9::Portg),
            7 => Some(Extipsel9::Porth),
            8 => Some(Extipsel9::Porti),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn portg(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel9::Portg)
    }
    #[doc = "Port H group selected for external interrupt 9"]
    #[inline(always)]
    pub fn porth(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel9::Porth)
    }
    #[doc = "Port I group selected for external interrupt 9"]
    #[inline(always)]
    pub fn porti(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel9::Porti)
    }
}
...
impl Extipsel10R {
    ...
    pub const fn variant(&self) -> Option<Extipsel10> {
        match self.bits {
            ...
            6 => Some(Extipsel10::Portg),
            7 => Some(Extipsel10::Porth),
            8 => Some(Extipsel10::Porti),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn portg(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel10::Portg)
    }
    #[doc = "Port H group selected for external interrupt 10"]
    #[inline(always)]
    pub fn porth(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel10::Porth)
    }
    #[doc = "Port I group selected for external interrupt 10"]
    #[inline(always)]
    pub fn porti(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel10::Porti)
    }
}
...
impl Extipsel11R {
    ...
    pub const fn variant(&self) -> Option<Extipsel11> {
        match self.bits {
            ...
            6 => Some(Extipsel11::Portg),
            7 => Some(Extipsel11::Porth),
            8 => Some(Extipsel11::Porti),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn portg(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel11::Portg)
    }
    #[doc = "Port H group selected for external interrupt 11"]
    #[inline(always)]
    pub fn porth(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel11::Porth)
    }
    #[doc = "Port I group selected for external interrupt 11"]
    #[inline(always)]
    pub fn porti(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel11::Porti)
    }
}
...
impl Extipsel12R {
    ...
    pub const fn variant(&self) -> Option<Extipsel12> {
        match self.bits {
            ...
            6 => Some(Extipsel12::Portg),
            7 => Some(Extipsel12::Porth),
            8 => Some(Extipsel12::Porti),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn portg(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel12::Portg)
    }
    #[doc = "Port H group selected for external interrupt 12"]
    #[inline(always)]
    pub fn porth(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel12::Porth)
    }
    #[doc = "Port I group selected for external interrupt 12"]
    #[inline(always)]
    pub fn porti(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel12::Porti)
    }
}
...
impl Extipsel13R {
    ...
    pub const fn variant(&self) -> Option<Extipsel13> {
        match self.bits {
            ...
            6 => Some(Extipsel13::Portg),
            7 => Some(Extipsel13::Porth),
            8 => Some(Extipsel13::Porti),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn portg(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel13::Portg)
    }
    #[doc = "Port H group selected for external interrupt 13"]
    #[inline(always)]
    pub fn porth(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel13::Porth)
    }
    #[doc = "Port I group selected for external interrupt 13"]
    #[inline(always)]
    pub fn porti(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel13::Porti)
    }
}
...
impl Extipsel14R {
    ...
    pub const fn variant(&self) -> Option<Extipsel14> {
        match self.bits {
            ...
            6 => Some(Extipsel14::Portg),
            7 => Some(Extipsel14::Porth),
            8 => Some(Extipsel14::Porti),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn portg(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel14::Portg)
    }
    #[doc = "Port H group selected for external interrupt 14"]
    #[inline(always)]
    pub fn porth(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel14::Porth)
    }
    #[doc = "Port I group selected for external interrupt 14"]
    #[inline(always)]
    pub fn porti(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel14::Porti)
    }
}
...
impl Extipsel15R {
    ...
    pub const fn variant(&self) -> Option<Extipsel15> {
        match self.bits {
            ...
            6 => Some(Extipsel15::Portg),
            7 => Some(Extipsel15::Porth),
            8 => Some(Extipsel15::Porti),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn portg(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel15::Portg)
    }
    #[doc = "Port H group selected for external interrupt 15"]
    #[inline(always)]
    pub fn porth(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel15::Porth)
    }
    #[doc = "Port I group selected for external interrupt 15"]
    #[inline(always)]
    pub fn porti(self) -> &'a mut crate::W<REG> {
        self.variant(Extipsel15::Porti)
    }
}
impl R {
