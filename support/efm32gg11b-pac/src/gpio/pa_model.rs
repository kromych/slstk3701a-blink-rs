...
pub type R = crate::R<PaModelSpec>;
#[doc = "Register `PA_MODEL` writer"]
pub type W = crate::W<PaModelSpec>;
#[doc = "Pin 0 Mode\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:3 - Pin 0 Mode"]
    #[inline(always)]
    pub fn mode0(&mut self) -> Mode0W<'_, PaModelSpec> {
        Mode0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Pin 1 Mode"]
    #[inline(always)]
    pub fn mode1(&mut self) -> Mode1W<'_, PaModelSpec> {
        Mode1W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Pin 2 Mode"]
    #[inline(always)]
    pub fn mode2(&mut self) -> Mode2W<'_, PaModelSpec> {
        Mode2W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Pin 3 Mode"]
    #[inline(always)]
    pub fn mode3(&mut self) -> Mode3W<'_, PaModelSpec> {
        Mode3W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Pin 4 Mode"]
    #[inline(always)]
    pub fn mode4(&mut self) -> Mode4W<'_, PaModelSpec> {
        Mode4W::new(self, 16)
    }
    #[doc = "Bits 20:23 - Pin 5 Mode"]
    #[inline(always)]
    pub fn mode5(&mut self) -> Mode5W<'_, PaModelSpec> {
        Mode5W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Pin 6 Mode"]
    #[inline(always)]
    pub fn mode6(&mut self) -> Mode6W<'_, PaModelSpec> {
        Mode6W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Pin 7 Mode"]
    #[inline(always)]
    pub fn mode7(&mut self) -> Mode7W<'_, PaModelSpec> {
        Mode7W::new(self, 28)
    }
}
#[doc = "Port Pin Mode Low Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pa_model::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pa_model::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PaModelSpec;
impl crate::RegisterSpec for PaModelSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pa_model::R`](R) reader structure"]
impl crate::Readable for PaModelSpec {}
#[doc = "`write(|w| ..)` method takes [`pa_model::W`](W) writer structure"]
impl crate::Writable for PaModelSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PA_MODEL to value 0"]
impl crate::Resettable for PaModelSpec {}
