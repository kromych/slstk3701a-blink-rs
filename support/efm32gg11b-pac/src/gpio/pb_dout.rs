...
pub type R = crate::R<PB_DOUT_SPEC>;
#[doc = "Register `PB_DOUT` writer"]
pub type W = crate::W<PB_DOUT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout(&mut self) -> DOUT_W<PB_DOUT_SPEC, 0> {
        DOUT_W::new(self)
    }
...
#[doc = "Port Data Out Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pb_dout::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pb_dout::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
