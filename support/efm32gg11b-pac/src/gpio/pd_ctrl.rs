...
pub type R = crate::R<PdCtrlSpec>;
#[doc = "Register `PD_CTRL` writer"]
pub type W = crate::W<PdCtrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Drive Strength for Port"]
    #[inline(always)]
    pub fn drivestrength(&mut self) -> DrivestrengthW<'_, PdCtrlSpec> {
        DrivestrengthW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Slewrate Limit for Port"]
    #[inline(always)]
    pub fn slewrate(&mut self) -> SlewrateW<'_, PdCtrlSpec> {
        SlewrateW::new(self, 4)
    }
    #[doc = "Bit 12 - Data in Disable"]
    #[inline(always)]
    pub fn dindis(&mut self) -> DindisW<'_, PdCtrlSpec> {
        DindisW::new(self, 12)
    }
    #[doc = "Bit 16 - Alternate Drive Strength for Port"]
    #[inline(always)]
    pub fn drivestrengthalt(&mut self) -> DrivestrengthaltW<'_, PdCtrlSpec> {
        DrivestrengthaltW::new(self, 16)
    }
    #[doc = "Bits 20:22 - Alternate Slewrate Limit for Port"]
    #[inline(always)]
    pub fn slewratealt(&mut self) -> SlewratealtW<'_, PdCtrlSpec> {
        SlewratealtW::new(self, 20)
    }
    #[doc = "Bit 28 - Alternate Data in Disable"]
    #[inline(always)]
    pub fn dindisalt(&mut self) -> DindisaltW<'_, PdCtrlSpec> {
...
pub struct PdCtrlSpec;
impl crate::RegisterSpec for PdCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pd_ctrl::R`](R) reader structure"]
impl crate::Readable for PdCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`pd_ctrl::W`](W) writer structure"]
impl crate::Writable for PdCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PD_CTRL to value 0x0050_0050"]
impl crate::Resettable for PdCtrlSpec {
