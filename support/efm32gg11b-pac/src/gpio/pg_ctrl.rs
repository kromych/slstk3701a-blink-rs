...
pub type R = crate::R<PgCtrlSpec>;
#[doc = "Register `PG_CTRL` writer"]
pub type W = crate::W<PgCtrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Drive Strength for Port"]
    #[inline(always)]
    pub fn drivestrength(&mut self) -> DrivestrengthW<'_, PgCtrlSpec> {
        DrivestrengthW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Slewrate Limit for Port"]
    #[inline(always)]
    pub fn slewrate(&mut self) -> SlewrateW<'_, PgCtrlSpec> {
        SlewrateW::new(self, 4)
    }
    #[doc = "Bit 12 - Data in Disable"]
    #[inline(always)]
    pub fn dindis(&mut self) -> DindisW<'_, PgCtrlSpec> {
        DindisW::new(self, 12)
    }
    #[doc = "Bit 16 - Alternate Drive Strength for Port"]
    #[inline(always)]
    pub fn drivestrengthalt(&mut self) -> DrivestrengthaltW<'_, PgCtrlSpec> {
        DrivestrengthaltW::new(self, 16)
    }
    #[doc = "Bits 20:22 - Alternate Slewrate Limit for Port"]
    #[inline(always)]
    pub fn slewratealt(&mut self) -> SlewratealtW<'_, PgCtrlSpec> {
        SlewratealtW::new(self, 20)
    }
    #[doc = "Bit 28 - Alternate Data in Disable"]
    #[inline(always)]
    pub fn dindisalt(&mut self) -> DindisaltW<'_, PgCtrlSpec> {
...
pub struct PgCtrlSpec;
impl crate::RegisterSpec for PgCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pg_ctrl::R`](R) reader structure"]
impl crate::Readable for PgCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`pg_ctrl::W`](W) writer structure"]
impl crate::Writable for PgCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PG_CTRL to value 0x0050_0050"]
impl crate::Resettable for PgCtrlSpec {
