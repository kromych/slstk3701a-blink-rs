...
pub type R = crate::R<PG_DIN_SPEC>;
...
#[doc = "Port Data in Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pg_din::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
