...
pub type W = crate::W<PG_DOUTTGL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn douttgl(&mut self) -> DOUTTGL_W<PG_DOUTTGL_SPEC, 0> {
        DOUTTGL_W::new(self)
    }
...
#[doc = "Port Data Out Toggle Register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pg_douttgl::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
