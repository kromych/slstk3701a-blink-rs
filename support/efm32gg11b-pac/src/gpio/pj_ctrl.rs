...
pub type R = crate::R<PjCtrlSpec>;
#[doc = "Register `PJ_CTRL` writer"]
pub type W = crate::W<PjCtrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Drive Strength for Port"]
    #[inline(always)]
    pub fn drivestrength(&mut self) -> DrivestrengthW<'_, PjCtrlSpec> {
        DrivestrengthW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Slewrate Limit for Port"]
    #[inline(always)]
    pub fn slewrate(&mut self) -> SlewrateW<'_, PjCtrlSpec> {
        SlewrateW::new(self, 4)
    }
    #[doc = "Bit 12 - Data in Disable"]
    #[inline(always)]
    pub fn dindis(&mut self) -> DindisW<'_, PjCtrlSpec> {
        DindisW::new(self, 12)
    }
    #[doc = "Bit 16 - Alternate Drive Strength for Port"]
    #[inline(always)]
    pub fn drivestrengthalt(&mut self) -> DrivestrengthaltW<'_, PjCtrlSpec> {
        DrivestrengthaltW::new(self, 16)
    }
    #[doc = "Bits 20:22 - Alternate Slewrate Limit for Port"]
    #[inline(always)]
    pub fn slewratealt(&mut self) -> SlewratealtW<'_, PjCtrlSpec> {
        SlewratealtW::new(self, 20)
    }
    #[doc = "Bit 28 - Alternate Data in Disable"]
    #[inline(always)]
    pub fn dindisalt(&mut self) -> DindisaltW<'_, PjCtrlSpec> {
        DindisaltW::new(self, 28)
    }
}
#[doc = "Port Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pj_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pj_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PjCtrlSpec;
impl crate::RegisterSpec for PjCtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pj_ctrl::R`](R) reader structure"]
impl crate::Readable for PjCtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`pj_ctrl::W`](W) writer structure"]
impl crate::Writable for PjCtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PJ_CTRL to value 0x0050_0050"]
impl crate::Resettable for PjCtrlSpec {
