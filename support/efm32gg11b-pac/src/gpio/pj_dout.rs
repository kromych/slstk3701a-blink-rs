...
pub type R = crate::R<PJ_DOUT_SPEC>;
#[doc = "Register `PJ_DOUT` writer"]
pub type W = crate::W<PJ_DOUT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout(&mut self) -> DOUT_W<PJ_DOUT_SPEC, 0> {
        DOUT_W::new(self)
    }
