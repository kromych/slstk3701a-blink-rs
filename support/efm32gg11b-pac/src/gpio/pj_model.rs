...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mode0(&mut self) -> MODE0_W<PJ_MODEL_SPEC> {
        MODE0_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Pin 1 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode1(&mut self) -> MODE1_W<PJ_MODEL_SPEC> {
        MODE1_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Pin 2 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode2(&mut self) -> MODE2_W<PJ_MODEL_SPEC> {
        MODE2_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Pin 3 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode3(&mut self) -> MODE3_W<PJ_MODEL_SPEC> {
        MODE3_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Pin 4 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode4(&mut self) -> MODE4_W<PJ_MODEL_SPEC> {
        MODE4_W::new(self, 16)
    }
    #[doc = "Bits 20:23 - Pin 5 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode5(&mut self) -> MODE5_W<PJ_MODEL_SPEC> {
        MODE5_W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Pin 6 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode6(&mut self) -> MODE6_W<PJ_MODEL_SPEC> {
        MODE6_W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Pin 7 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode7(&mut self) -> MODE7_W<PJ_MODEL_SPEC> {
        MODE7_W::new(self, 28)
    }
