...
pub type R = crate::R<PkModehSpec>;
#[doc = "Register `PK_MODEH` writer"]
pub type W = crate::W<PkModehSpec>;
#[doc = "Pin 8 Mode\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:3 - Pin 8 Mode"]
    #[inline(always)]
    pub fn mode8(&mut self) -> Mode8W<'_, PkModehSpec> {
        Mode8W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Pin 9 Mode"]
    #[inline(always)]
    pub fn mode9(&mut self) -> Mode9W<'_, PkModehSpec> {
        Mode9W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Pin 10 Mode"]
    #[inline(always)]
    pub fn mode10(&mut self) -> Mode10W<'_, PkModehSpec> {
        Mode10W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Pin 11 Mode"]
    #[inline(always)]
    pub fn mode11(&mut self) -> Mode11W<'_, PkModehSpec> {
        Mode11W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Pin 12 Mode"]
    #[inline(always)]
    pub fn mode12(&mut self) -> Mode12W<'_, PkModehSpec> {
        Mode12W::new(self, 16)
    }
    #[doc = "Bits 20:23 - Pin 13 Mode"]
    #[inline(always)]
    pub fn mode13(&mut self) -> Mode13W<'_, PkModehSpec> {
        Mode13W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Pin 14 Mode"]
    #[inline(always)]
    pub fn mode14(&mut self) -> Mode14W<'_, PkModehSpec> {
        Mode14W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Pin 15 Mode"]
    #[inline(always)]
    pub fn mode15(&mut self) -> Mode15W<'_, PkModehSpec> {
        Mode15W::new(self, 28)
    }
}
#[doc = "Port Pin Mode High Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pk_modeh::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pk_modeh::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PkModehSpec;
impl crate::RegisterSpec for PkModehSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pk_modeh::R`](R) reader structure"]
impl crate::Readable for PkModehSpec {}
#[doc = "`write(|w| ..)` method takes [`pk_modeh::W`](W) writer structure"]
impl crate::Writable for PkModehSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PK_MODEH to value 0"]
impl crate::Resettable for PkModehSpec {}
