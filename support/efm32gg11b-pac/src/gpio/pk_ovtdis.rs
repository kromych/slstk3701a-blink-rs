...
pub type R = crate::R<PK_OVTDIS_SPEC>;
#[doc = "Register `PK_OVTDIS` writer"]
pub type W = crate::W<PK_OVTDIS_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovtdis(&mut self) -> OVTDIS_W<PK_OVTDIS_SPEC, 0> {
        OVTDIS_W::new(self)
    }
