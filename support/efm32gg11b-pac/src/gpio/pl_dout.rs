...
pub type R = crate::R<PL_DOUT_SPEC>;
#[doc = "Register `PL_DOUT` writer"]
pub type W = crate::W<PL_DOUT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout(&mut self) -> DOUT_W<PL_DOUT_SPEC, 0> {
        DOUT_W::new(self)
    }
