...
pub type R = crate::R<PL_MODEH_SPEC>;
#[doc = "Register `PL_MODEH` writer"]
pub type W = crate::W<PL_MODEH_SPEC>;
...
pub type MODE8_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 4, O, MODE8_A>;
...
pub type MODE9_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 4, O, MODE9_A>;
impl<'a, REG, const O: u8> MODE9_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type MODE10_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 4, O, MODE10_A>;
impl<'a, REG, const O: u8> MODE10_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type MODE11_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 4, O, MODE11_A>;
impl<'a, REG, const O: u8> MODE11_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type MODE12_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 4, O, MODE12_A>;
impl<'a, REG, const O: u8> MODE12_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type MODE13_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 4, O, MODE13_A>;
impl<'a, REG, const O: u8> MODE13_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type MODE14_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 4, O, MODE14_A>;
impl<'a, REG, const O: u8> MODE14_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type MODE15_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 4, O, MODE15_A>;
impl<'a, REG, const O: u8> MODE15_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mode8(&mut self) -> MODE8_W<PL_MODEH_SPEC, 0> {
        MODE8_W::new(self)
    }
    #[doc = "Bits 4:7 - Pin 9 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode9(&mut self) -> MODE9_W<PL_MODEH_SPEC, 4> {
        MODE9_W::new(self)
    }
    #[doc = "Bits 8:11 - Pin 10 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode10(&mut self) -> MODE10_W<PL_MODEH_SPEC, 8> {
        MODE10_W::new(self)
    }
    #[doc = "Bits 12:15 - Pin 11 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode11(&mut self) -> MODE11_W<PL_MODEH_SPEC, 12> {
        MODE11_W::new(self)
    }
    #[doc = "Bits 16:19 - Pin 12 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode12(&mut self) -> MODE12_W<PL_MODEH_SPEC, 16> {
        MODE12_W::new(self)
    }
    #[doc = "Bits 20:23 - Pin 13 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode13(&mut self) -> MODE13_W<PL_MODEH_SPEC, 20> {
        MODE13_W::new(self)
    }
    #[doc = "Bits 24:27 - Pin 14 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode14(&mut self) -> MODE14_W<PL_MODEH_SPEC, 24> {
        MODE14_W::new(self)
    }
    #[doc = "Bits 28:31 - Pin 15 Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode15(&mut self) -> MODE15_W<PL_MODEH_SPEC, 28> {
        MODE15_W::new(self)
    }
...
#[doc = "Port Pin Mode High Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pl_modeh::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pl_modeh::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
