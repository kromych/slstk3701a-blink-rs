...
pub type LcdgateR = crate::BitReader;
#[doc = "Field `LCDGATE` writer - LCD Gate"]
pub type LcdgateW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 1 - LCD Gate"]
    #[inline(always)]
    pub fn lcdgate(&mut self) -> LcdgateW<'_, FreezeSpec> {
        LcdgateW::new(self, 1)
    }
}
