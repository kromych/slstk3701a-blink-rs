...
pub type R = crate::R<CH0_LINK_SPEC>;
#[doc = "Register `CH0_LINK` writer"]
pub type W = crate::W<CH0_LINK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn link(&mut self) -> LINK_W<CH0_LINK_SPEC, 1> {
        LINK_W::new(self)
    }
    #[doc = "Bits 2:31 - Link Structure Address"]
    #[inline(always)]
    #[must_use]
    pub fn linkaddr(&mut self) -> LINKADDR_W<CH0_LINK_SPEC, 2> {
        LINKADDR_W::new(self)
    }
