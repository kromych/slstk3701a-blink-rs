...
pub type R = crate::R<CH0_REQSEL_SPEC>;
#[doc = "Register `CH0_REQSEL` writer"]
pub type W = crate::W<CH0_REQSEL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sigsel(&mut self) -> SIGSEL_W<CH0_REQSEL_SPEC, 0> {
        SIGSEL_W::new(self)
    }
    #[doc = "Bits 16:21 - Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn sourcesel(&mut self) -> SOURCESEL_W<CH0_REQSEL_SPEC, 16> {
