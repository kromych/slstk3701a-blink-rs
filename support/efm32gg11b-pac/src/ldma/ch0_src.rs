...
pub type R = crate::R<CH0_SRC_SPEC>;
#[doc = "Register `CH0_SRC` writer"]
pub type W = crate::W<CH0_SRC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srcaddr(&mut self) -> SRCADDR_W<CH0_SRC_SPEC, 0> {
        SRCADDR_W::new(self)
    }
...
#[doc = "Channel Descriptor Source Data Address Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch0_src::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch0_src::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
