#[doc = "Register `CH11_CFG` reader"]
pub type R = crate::R<Ch11CfgSpec>;
#[doc = "Register `CH11_CFG` writer"]
pub type W = crate::W<Ch11CfgSpec>;
...
impl W {
    #[doc = "Bits 16:17 - Arbitration Slot Number Select"]
    #[inline(always)]
    pub fn arbslots(&mut self) -> ArbslotsW<'_, Ch11CfgSpec> {
        ArbslotsW::new(self, 16)
    }
    #[doc = "Bit 20 - Source Address Increment Sign"]
    #[inline(always)]
    pub fn srcincsign(&mut self) -> SrcincsignW<'_, Ch11CfgSpec> {
        SrcincsignW::new(self, 20)
    }
    #[doc = "Bit 21 - Destination Address Increment Sign"]
    #[inline(always)]
    pub fn dstincsign(&mut self) -> DstincsignW<'_, Ch11CfgSpec> {
        DstincsignW::new(self, 21)
    }
}
#[doc = "Channel Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ch11_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch11_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch11CfgSpec;
impl crate::RegisterSpec for Ch11CfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch11_cfg::R`](R) reader structure"]
impl crate::Readable for Ch11CfgSpec {}
#[doc = "`write(|w| ..)` method takes [`ch11_cfg::W`](W) writer structure"]
impl crate::Writable for Ch11CfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH11_CFG to value 0"]
impl crate::Resettable for Ch11CfgSpec {}
