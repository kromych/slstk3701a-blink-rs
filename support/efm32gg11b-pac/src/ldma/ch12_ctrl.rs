#[doc = "Register `CH12_CTRL` reader"]
pub type R = crate::R<Ch12CtrlSpec>;
#[doc = "Register `CH12_CTRL` writer"]
pub type W = crate::W<Ch12CtrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn structreq(&mut self) -> StructreqW<'_, Ch12CtrlSpec> {
        StructreqW::new(self, 3)
    }
    #[doc = "Bits 4:14 - DMA Unit Data Transfer Count"]
    #[inline(always)]
    pub fn xfercnt(&mut self) -> XfercntW<'_, Ch12CtrlSpec> {
        XfercntW::new(self, 4)
    }
    #[doc = "Bit 15 - Endian Byte Swap"]
    #[inline(always)]
    pub fn byteswap(&mut self) -> ByteswapW<'_, Ch12CtrlSpec> {
        ByteswapW::new(self, 15)
    }
    #[doc = "Bits 16:19 - Block Transfer Size"]
    #[inline(always)]
    pub fn blocksize(&mut self) -> BlocksizeW<'_, Ch12CtrlSpec> {
        BlocksizeW::new(self, 16)
    }
    #[doc = "Bit 20 - DMA Operation Done Interrupt Flag Set Enable"]
    #[inline(always)]
    pub fn doneifsen(&mut self) -> DoneifsenW<'_, Ch12CtrlSpec> {
        DoneifsenW::new(self, 20)
    }
    #[doc = "Bit 21 - DMA Request Transfer Mode Select"]
    #[inline(always)]
    pub fn reqmode(&mut self) -> ReqmodeW<'_, Ch12CtrlSpec> {
        ReqmodeW::new(self, 21)
    }
    #[doc = "Bit 22 - Decrement Loop Count"]
    #[inline(always)]
    pub fn decloopcnt(&mut self) -> DecloopcntW<'_, Ch12CtrlSpec> {
        DecloopcntW::new(self, 22)
    }
    #[doc = "Bit 23 - Ignore Sreq"]
    #[inline(always)]
    pub fn ignoresreq(&mut self) -> IgnoresreqW<'_, Ch12CtrlSpec> {
        IgnoresreqW::new(self, 23)
    }
    #[doc = "Bits 24:25 - Source Address Increment Size"]
    #[inline(always)]
    pub fn srcinc(&mut self) -> SrcincW<'_, Ch12CtrlSpec> {
        SrcincW::new(self, 24)
    }
    #[doc = "Bits 26:27 - Unit Data Transfer Size"]
    #[inline(always)]
    pub fn size(&mut self) -> SizeW<'_, Ch12CtrlSpec> {
        SizeW::new(self, 26)
    }
    #[doc = "Bits 28:29 - Destination Address Increment Size"]
    #[inline(always)]
    pub fn dstinc(&mut self) -> DstincW<'_, Ch12CtrlSpec> {
        DstincW::new(self, 28)
    }
}
#[doc = "Channel Descriptor Control Word Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ch12_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch12_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch12CtrlSpec;
impl crate::RegisterSpec for Ch12CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch12_ctrl::R`](R) reader structure"]
impl crate::Readable for Ch12CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`ch12_ctrl::W`](W) writer structure"]
impl crate::Writable for Ch12CtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH12_CTRL to value 0"]
impl crate::Resettable for Ch12CtrlSpec {}
