...
pub type R = crate::R<CH12_LOOP_SPEC>;
#[doc = "Register `CH12_LOOP` writer"]
pub type W = crate::W<CH12_LOOP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn loopcnt(&mut self) -> LOOPCNT_W<CH12_LOOP_SPEC, 0> {
        LOOPCNT_W::new(self)
    }
...
#[doc = "Channel Loop Counter Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch12_loop::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch12_loop::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH12_LOOP_SPEC;
impl crate::RegisterSpec for CH12_LOOP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch12_loop::R`](R) reader structure"]
impl crate::Readable for CH12_LOOP_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ch12_loop::W`](W) writer structure"]
impl crate::Writable for CH12_LOOP_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CH12_LOOP to value 0"]
impl crate::Resettable for CH12_LOOP_SPEC {
