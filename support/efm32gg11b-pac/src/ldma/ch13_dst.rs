...
pub type R = crate::R<CH13_DST_SPEC>;
#[doc = "Register `CH13_DST` writer"]
pub type W = crate::W<CH13_DST_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dstaddr(&mut self) -> DSTADDR_W<CH13_DST_SPEC, 0> {
        DSTADDR_W::new(self)
    }
...
#[doc = "Channel Descriptor Destination Data Address Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch13_dst::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch13_dst::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH13_DST_SPEC;
impl crate::RegisterSpec for CH13_DST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch13_dst::R`](R) reader structure"]
impl crate::Readable for CH13_DST_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ch13_dst::W`](W) writer structure"]
impl crate::Writable for CH13_DST_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CH13_DST to value 0"]
impl crate::Resettable for CH13_DST_SPEC {
