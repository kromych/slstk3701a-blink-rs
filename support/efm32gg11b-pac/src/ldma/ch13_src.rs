...
pub type R = crate::R<CH13_SRC_SPEC>;
#[doc = "Register `CH13_SRC` writer"]
pub type W = crate::W<CH13_SRC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srcaddr(&mut self) -> SRCADDR_W<CH13_SRC_SPEC, 0> {
        SRCADDR_W::new(self)
    }
