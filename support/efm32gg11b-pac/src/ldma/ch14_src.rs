...
pub type R = crate::R<CH14_SRC_SPEC>;
#[doc = "Register `CH14_SRC` writer"]
pub type W = crate::W<CH14_SRC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srcaddr(&mut self) -> SRCADDR_W<CH14_SRC_SPEC, 0> {
        SRCADDR_W::new(self)
    }
...
#[doc = "Channel Descriptor Source Data Address Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch14_src::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch14_src::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH14_SRC_SPEC;
impl crate::RegisterSpec for CH14_SRC_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch14_src::R`](R) reader structure"]
impl crate::Readable for CH14_SRC_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ch14_src::W`](W) writer structure"]
impl crate::Writable for CH14_SRC_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CH14_SRC to value 0"]
impl crate::Resettable for CH14_SRC_SPEC {
