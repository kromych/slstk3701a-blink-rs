...
pub type R = crate::R<CH15_LOOP_SPEC>;
#[doc = "Register `CH15_LOOP` writer"]
pub type W = crate::W<CH15_LOOP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn loopcnt(&mut self) -> LOOPCNT_W<CH15_LOOP_SPEC, 0> {
        LOOPCNT_W::new(self)
    }
...
pub struct CH15_LOOP_SPEC;
impl crate::RegisterSpec for CH15_LOOP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch15_loop::R`](R) reader structure"]
impl crate::Readable for CH15_LOOP_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ch15_loop::W`](W) writer structure"]
impl crate::Writable for CH15_LOOP_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CH15_LOOP to value 0"]
impl crate::Resettable for CH15_LOOP_SPEC {
