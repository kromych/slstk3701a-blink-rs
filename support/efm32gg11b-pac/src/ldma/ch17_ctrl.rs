...
pub type R = crate::R<CH17_CTRL_SPEC>;
#[doc = "Register `CH17_CTRL` writer"]
pub type W = crate::W<CH17_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn structreq(&mut self) -> STRUCTREQ_W<CH17_CTRL_SPEC, 3> {
        STRUCTREQ_W::new(self)
    }
    #[doc = "Bits 4:14 - DMA Unit Data Transfer Count"]
    #[inline(always)]
    #[must_use]
    pub fn xfercnt(&mut self) -> XFERCNT_W<CH17_CTRL_SPEC, 4> {
        XFERCNT_W::new(self)
    }
    #[doc = "Bit 15 - Endian Byte Swap"]
    #[inline(always)]
    #[must_use]
    pub fn byteswap(&mut self) -> BYTESWAP_W<CH17_CTRL_SPEC, 15> {
        BYTESWAP_W::new(self)
    }
    #[doc = "Bits 16:19 - Block Transfer Size"]
    #[inline(always)]
    #[must_use]
    pub fn blocksize(&mut self) -> BLOCKSIZE_W<CH17_CTRL_SPEC, 16> {
        BLOCKSIZE_W::new(self)
    }
    #[doc = "Bit 20 - DMA Operation Done Interrupt Flag Set Enable"]
    #[inline(always)]
    #[must_use]
    pub fn doneifsen(&mut self) -> DONEIFSEN_W<CH17_CTRL_SPEC, 20> {
        DONEIFSEN_W::new(self)
    }
    #[doc = "Bit 21 - DMA Request Transfer Mode Select"]
    #[inline(always)]
    #[must_use]
    pub fn reqmode(&mut self) -> REQMODE_W<CH17_CTRL_SPEC, 21> {
        REQMODE_W::new(self)
    }
    #[doc = "Bit 22 - Decrement Loop Count"]
    #[inline(always)]
    #[must_use]
    pub fn decloopcnt(&mut self) -> DECLOOPCNT_W<CH17_CTRL_SPEC, 22> {
        DECLOOPCNT_W::new(self)
    }
    #[doc = "Bit 23 - Ignore Sreq"]
    #[inline(always)]
    #[must_use]
    pub fn ignoresreq(&mut self) -> IGNORESREQ_W<CH17_CTRL_SPEC, 23> {
        IGNORESREQ_W::new(self)
    }
    #[doc = "Bits 24:25 - Source Address Increment Size"]
    #[inline(always)]
    #[must_use]
    pub fn srcinc(&mut self) -> SRCINC_W<CH17_CTRL_SPEC, 24> {
        SRCINC_W::new(self)
    }
    #[doc = "Bits 26:27 - Unit Data Transfer Size"]
    #[inline(always)]
    #[must_use]
    pub fn size(&mut self) -> SIZE_W<CH17_CTRL_SPEC, 26> {
        SIZE_W::new(self)
    }
    #[doc = "Bits 28:29 - Destination Address Increment Size"]
    #[inline(always)]
    #[must_use]
    pub fn dstinc(&mut self) -> DSTINC_W<CH17_CTRL_SPEC, 28> {
        DSTINC_W::new(self)
    }
...
#[doc = "Channel Descriptor Control Word Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch17_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch17_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH17_CTRL_SPEC;
impl crate::RegisterSpec for CH17_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch17_ctrl::R`](R) reader structure"]
impl crate::Readable for CH17_CTRL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ch17_ctrl::W`](W) writer structure"]
impl crate::Writable for CH17_CTRL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CH17_CTRL to value 0"]
impl crate::Resettable for CH17_CTRL_SPEC {
