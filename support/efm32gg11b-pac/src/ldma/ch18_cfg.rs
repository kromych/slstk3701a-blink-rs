#[doc = "Register `CH18_CFG` reader"]
pub type R = crate::R<Ch18CfgSpec>;
#[doc = "Register `CH18_CFG` writer"]
pub type W = crate::W<Ch18CfgSpec>;
...
impl W {
    #[doc = "Bits 16:17 - Arbitration Slot Number Select"]
    #[inline(always)]
    pub fn arbslots(&mut self) -> ArbslotsW<'_, Ch18CfgSpec> {
        ArbslotsW::new(self, 16)
    }
    #[doc = "Bit 20 - Source Address Increment Sign"]
    #[inline(always)]
    pub fn srcincsign(&mut self) -> SrcincsignW<'_, Ch18CfgSpec> {
        SrcincsignW::new(self, 20)
    }
    #[doc = "Bit 21 - Destination Address Increment Sign"]
    #[inline(always)]
    pub fn dstincsign(&mut self) -> DstincsignW<'_, Ch18CfgSpec> {
        DstincsignW::new(self, 21)
    }
}
#[doc = "Channel Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ch18_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch18_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch18CfgSpec;
impl crate::RegisterSpec for Ch18CfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch18_cfg::R`](R) reader structure"]
impl crate::Readable for Ch18CfgSpec {}
#[doc = "`write(|w| ..)` method takes [`ch18_cfg::W`](W) writer structure"]
impl crate::Writable for Ch18CfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH18_CFG to value 0"]
impl crate::Resettable for Ch18CfgSpec {}
