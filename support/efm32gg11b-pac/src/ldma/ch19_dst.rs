...
pub type R = crate::R<CH19_DST_SPEC>;
#[doc = "Register `CH19_DST` writer"]
pub type W = crate::W<CH19_DST_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dstaddr(&mut self) -> DSTADDR_W<CH19_DST_SPEC, 0> {
        DSTADDR_W::new(self)
    }
