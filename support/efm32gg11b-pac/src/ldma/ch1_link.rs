...
pub type R = crate::R<CH1_LINK_SPEC>;
#[doc = "Register `CH1_LINK` writer"]
pub type W = crate::W<CH1_LINK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn link(&mut self) -> LINK_W<CH1_LINK_SPEC, 1> {
        LINK_W::new(self)
    }
    #[doc = "Bits 2:31 - Link Structure Address"]
    #[inline(always)]
    #[must_use]
    pub fn linkaddr(&mut self) -> LINKADDR_W<CH1_LINK_SPEC, 2> {
        LINKADDR_W::new(self)
    }
...
#[doc = "Channel Descriptor Link Structure Address Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch1_link::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch1_link::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
