...
pub type R = crate::R<Ch1ReqselSpec>;
#[doc = "Register `CH1_REQSEL` writer"]
pub type W = crate::W<Ch1ReqselSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Signal Select"]
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, Ch1ReqselSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bits 16:21 - Source Select"]
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, Ch1ReqselSpec> {
...
pub struct Ch1ReqselSpec;
impl crate::RegisterSpec for Ch1ReqselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch1_reqsel::R`](R) reader structure"]
impl crate::Readable for Ch1ReqselSpec {}
#[doc = "`write(|w| ..)` method takes [`ch1_reqsel::W`](W) writer structure"]
impl crate::Writable for Ch1ReqselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH1_REQSEL to value 0"]
impl crate::Resettable for Ch1ReqselSpec {}
