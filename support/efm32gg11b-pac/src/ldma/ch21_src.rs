...
pub type R = crate::R<CH21_SRC_SPEC>;
#[doc = "Register `CH21_SRC` writer"]
pub type W = crate::W<CH21_SRC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srcaddr(&mut self) -> SRCADDR_W<CH21_SRC_SPEC, 0> {
        SRCADDR_W::new(self)
    }
