...
pub type R = crate::R<CH23_DST_SPEC>;
#[doc = "Register `CH23_DST` writer"]
pub type W = crate::W<CH23_DST_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dstaddr(&mut self) -> DSTADDR_W<CH23_DST_SPEC, 0> {
        DSTADDR_W::new(self)
    }
