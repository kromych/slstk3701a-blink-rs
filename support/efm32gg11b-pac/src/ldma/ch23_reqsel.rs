#[doc = "Register `CH23_REQSEL` reader"]
pub type R = crate::R<Ch23ReqselSpec>;
#[doc = "Register `CH23_REQSEL` writer"]
pub type W = crate::W<Ch23ReqselSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Signal Select"]
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, Ch23ReqselSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bits 16:21 - Source Select"]
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, Ch23ReqselSpec> {
        SourceselW::new(self, 16)
    }
}
#[doc = "Channel Peripheral Request Select Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ch23_reqsel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch23_reqsel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch23ReqselSpec;
impl crate::RegisterSpec for Ch23ReqselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch23_reqsel::R`](R) reader structure"]
impl crate::Readable for Ch23ReqselSpec {}
#[doc = "`write(|w| ..)` method takes [`ch23_reqsel::W`](W) writer structure"]
impl crate::Writable for Ch23ReqselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH23_REQSEL to value 0"]
impl crate::Resettable for Ch23ReqselSpec {}
