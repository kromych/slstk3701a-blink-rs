...
pub type R = crate::R<CH2_DST_SPEC>;
#[doc = "Register `CH2_DST` writer"]
pub type W = crate::W<CH2_DST_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dstaddr(&mut self) -> DSTADDR_W<CH2_DST_SPEC, 0> {
        DSTADDR_W::new(self)
    }
...
#[doc = "Channel Descriptor Destination Data Address Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch2_dst::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch2_dst::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
