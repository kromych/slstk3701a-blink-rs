...
pub type R = crate::R<Ch2ReqselSpec>;
#[doc = "Register `CH2_REQSEL` writer"]
pub type W = crate::W<Ch2ReqselSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Signal Select"]
    #[inline(always)]
    pub fn sigsel(&mut self) -> SigselW<'_, Ch2ReqselSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bits 16:21 - Source Select"]
    #[inline(always)]
    pub fn sourcesel(&mut self) -> SourceselW<'_, Ch2ReqselSpec> {
...
pub struct Ch2ReqselSpec;
impl crate::RegisterSpec for Ch2ReqselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch2_reqsel::R`](R) reader structure"]
impl crate::Readable for Ch2ReqselSpec {}
