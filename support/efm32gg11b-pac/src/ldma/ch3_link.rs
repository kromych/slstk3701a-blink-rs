...
pub type R = crate::R<Ch3LinkSpec>;
#[doc = "Register `CH3_LINK` writer"]
pub type W = crate::W<Ch3LinkSpec>;
...
impl W {
    #[doc = "Bit 1 - Link Next Structure"]
    #[inline(always)]
    pub fn link(&mut self) -> LinkW<'_, Ch3LinkSpec> {
        LinkW::new(self, 1)
    }
    #[doc = "Bits 2:31 - Link Structure Address"]
    #[inline(always)]
    pub fn linkaddr(&mut self) -> LinkaddrW<'_, Ch3LinkSpec> {
        LinkaddrW::new(self, 2)
    }
}
#[doc = "Channel Descriptor Link Structure Address Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ch3_link::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch3_link::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch3LinkSpec;
impl crate::RegisterSpec for Ch3LinkSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch3_link::R`](R) reader structure"]
impl crate::Readable for Ch3LinkSpec {}
#[doc = "`write(|w| ..)` method takes [`ch3_link::W`](W) writer structure"]
impl crate::Writable for Ch3LinkSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH3_LINK to value 0"]
impl crate::Resettable for Ch3LinkSpec {}
