...
pub type R = crate::R<CH5_CFG_SPEC>;
#[doc = "Register `CH5_CFG` writer"]
pub type W = crate::W<CH5_CFG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn arbslots(&mut self) -> ARBSLOTS_W<CH5_CFG_SPEC, 16> {
        ARBSLOTS_W::new(self)
    }
    #[doc = "Bit 20 - Source Address Increment Sign"]
    #[inline(always)]
    #[must_use]
    pub fn srcincsign(&mut self) -> SRCINCSIGN_W<CH5_CFG_SPEC, 20> {
        SRCINCSIGN_W::new(self)
    }
    #[doc = "Bit 21 - Destination Address Increment Sign"]
    #[inline(always)]
    #[must_use]
    pub fn dstincsign(&mut self) -> DSTINCSIGN_W<CH5_CFG_SPEC, 21> {
