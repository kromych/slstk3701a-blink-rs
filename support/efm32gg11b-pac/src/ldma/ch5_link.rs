...
pub type R = crate::R<Ch5LinkSpec>;
#[doc = "Register `CH5_LINK` writer"]
pub type W = crate::W<Ch5LinkSpec>;
...
impl W {
    #[doc = "Bit 1 - Link Next Structure"]
    #[inline(always)]
    pub fn link(&mut self) -> LinkW<'_, Ch5LinkSpec> {
        LinkW::new(self, 1)
    }
    #[doc = "Bits 2:31 - Link Structure Address"]
    #[inline(always)]
    pub fn linkaddr(&mut self) -> LinkaddrW<'_, Ch5LinkSpec> {
        LinkaddrW::new(self, 2)
    }
}
#[doc = "Channel Descriptor Link Structure Address Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ch5_link::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch5_link::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch5LinkSpec;
impl crate::RegisterSpec for Ch5LinkSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch5_link::R`](R) reader structure"]
impl crate::Readable for Ch5LinkSpec {}
#[doc = "`write(|w| ..)` method takes [`ch5_link::W`](W) writer structure"]
impl crate::Writable for Ch5LinkSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH5_LINK to value 0"]
impl crate::Resettable for Ch5LinkSpec {}
