...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn structreq(&mut self) -> STRUCTREQ_W<CH6_CTRL_SPEC, 3> {
        STRUCTREQ_W::new(self)
    }
    #[doc = "Bits 4:14 - DMA Unit Data Transfer Count"]
    #[inline(always)]
    #[must_use]
    pub fn xfercnt(&mut self) -> XFERCNT_W<CH6_CTRL_SPEC, 4> {
        XFERCNT_W::new(self)
    }
    #[doc = "Bit 15 - Endian Byte Swap"]
    #[inline(always)]
    #[must_use]
    pub fn byteswap(&mut self) -> BYTESWAP_W<CH6_CTRL_SPEC, 15> {
        BYTESWAP_W::new(self)
    }
    #[doc = "Bits 16:19 - Block Transfer Size"]
    #[inline(always)]
    #[must_use]
    pub fn blocksize(&mut self) -> BLOCKSIZE_W<CH6_CTRL_SPEC, 16> {
        BLOCKSIZE_W::new(self)
    }
    #[doc = "Bit 20 - DMA Operation Done Interrupt Flag Set Enable"]
    #[inline(always)]
    #[must_use]
    pub fn doneifsen(&mut self) -> DONEIFSEN_W<CH6_CTRL_SPEC, 20> {
        DONEIFSEN_W::new(self)
    }
    #[doc = "Bit 21 - DMA Request Transfer Mode Select"]
    #[inline(always)]
    #[must_use]
    pub fn reqmode(&mut self) -> REQMODE_W<CH6_CTRL_SPEC, 21> {
        REQMODE_W::new(self)
    }
    #[doc = "Bit 22 - Decrement Loop Count"]
    #[inline(always)]
    #[must_use]
    pub fn decloopcnt(&mut self) -> DECLOOPCNT_W<CH6_CTRL_SPEC, 22> {
        DECLOOPCNT_W::new(self)
    }
    #[doc = "Bit 23 - Ignore Sreq"]
    #[inline(always)]
    #[must_use]
    pub fn ignoresreq(&mut self) -> IGNORESREQ_W<CH6_CTRL_SPEC, 23> {
        IGNORESREQ_W::new(self)
    }
    #[doc = "Bits 24:25 - Source Address Increment Size"]
    #[inline(always)]
    #[must_use]
    pub fn srcinc(&mut self) -> SRCINC_W<CH6_CTRL_SPEC, 24> {
        SRCINC_W::new(self)
    }
    #[doc = "Bits 26:27 - Unit Data Transfer Size"]
    #[inline(always)]
    #[must_use]
    pub fn size(&mut self) -> SIZE_W<CH6_CTRL_SPEC, 26> {
        SIZE_W::new(self)
    }
    #[doc = "Bits 28:29 - Destination Address Increment Size"]
    #[inline(always)]
    #[must_use]
    pub fn dstinc(&mut self) -> DSTINC_W<CH6_CTRL_SPEC, 28> {
        DSTINC_W::new(self)
    }
