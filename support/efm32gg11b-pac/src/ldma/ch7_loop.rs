...
pub type R = crate::R<CH7_LOOP_SPEC>;
#[doc = "Register `CH7_LOOP` writer"]
pub type W = crate::W<CH7_LOOP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn loopcnt(&mut self) -> LOOPCNT_W<CH7_LOOP_SPEC, 0> {
        LOOPCNT_W::new(self)
    }
...
#[doc = "Channel Loop Counter Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch7_loop::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch7_loop::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
