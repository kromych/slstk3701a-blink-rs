...
pub type R = crate::R<CH8_CFG_SPEC>;
#[doc = "Register `CH8_CFG` writer"]
pub type W = crate::W<CH8_CFG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn arbslots(&mut self) -> ARBSLOTS_W<CH8_CFG_SPEC, 16> {
        ARBSLOTS_W::new(self)
    }
    #[doc = "Bit 20 - Source Address Increment Sign"]
    #[inline(always)]
    #[must_use]
    pub fn srcincsign(&mut self) -> SRCINCSIGN_W<CH8_CFG_SPEC, 20> {
        SRCINCSIGN_W::new(self)
    }
    #[doc = "Bit 21 - Destination Address Increment Sign"]
    #[inline(always)]
    #[must_use]
    pub fn dstincsign(&mut self) -> DSTINCSIGN_W<CH8_CFG_SPEC, 21> {
...
#[doc = "Channel Configuration Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch8_cfg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch8_cfg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH8_CFG_SPEC;
impl crate::RegisterSpec for CH8_CFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch8_cfg::R`](R) reader structure"]
impl crate::Readable for CH8_CFG_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ch8_cfg::W`](W) writer structure"]
impl crate::Writable for CH8_CFG_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CH8_CFG to value 0"]
impl crate::Resettable for CH8_CFG_SPEC {
