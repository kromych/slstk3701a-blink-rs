...
pub type R = crate::R<Ch8LinkSpec>;
#[doc = "Register `CH8_LINK` writer"]
pub type W = crate::W<Ch8LinkSpec>;
...
impl W {
    #[doc = "Bit 1 - Link Next Structure"]
    #[inline(always)]
    pub fn link(&mut self) -> LinkW<'_, Ch8LinkSpec> {
        LinkW::new(self, 1)
    }
    #[doc = "Bits 2:31 - Link Structure Address"]
    #[inline(always)]
    pub fn linkaddr(&mut self) -> LinkaddrW<'_, Ch8LinkSpec> {
        LinkaddrW::new(self, 2)
    }
}
#[doc = "Channel Descriptor Link Structure Address Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ch8_link::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch8_link::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch8LinkSpec;
impl crate::RegisterSpec for Ch8LinkSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch8_link::R`](R) reader structure"]
impl crate::Readable for Ch8LinkSpec {}
#[doc = "`write(|w| ..)` method takes [`ch8_link::W`](W) writer structure"]
impl crate::Writable for Ch8LinkSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH8_LINK to value 0"]
impl crate::Resettable for Ch8LinkSpec {}
