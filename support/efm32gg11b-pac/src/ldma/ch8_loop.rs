...
pub type R = crate::R<CH8_LOOP_SPEC>;
#[doc = "Register `CH8_LOOP` writer"]
pub type W = crate::W<CH8_LOOP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn loopcnt(&mut self) -> LOOPCNT_W<CH8_LOOP_SPEC, 0> {
        LOOPCNT_W::new(self)
    }
