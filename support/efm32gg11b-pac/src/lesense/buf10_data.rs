...
pub type R = crate::R<BUF10_DATA_SPEC>;
#[doc = "Register `BUF10_DATA` writer"]
pub type W = crate::W<BUF10_DATA_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DATA_W<BUF10_DATA_SPEC, 0> {
        DATA_W::new(self)
    }
...
#[doc = "Scan Results\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`buf10_data::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`buf10_data::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
