...
pub type R = crate::R<Ch0TimingSpec>;
#[doc = "Register `CH0_TIMING` writer"]
pub type W = crate::W<Ch0TimingSpec>;
...
impl W {
    #[doc = "Bits 0:5 - Set Excitation Time"]
    #[inline(always)]
    pub fn extime(&mut self) -> ExtimeW<'_, Ch0TimingSpec> {
        ExtimeW::new(self, 0)
    }
    #[doc = "Bits 6:13 - Set Sample Delay"]
    #[inline(always)]
    pub fn sampledly(&mut self) -> SampledlyW<'_, Ch0TimingSpec> {
        SampledlyW::new(self, 6)
    }
    #[doc = "Bits 14:23 - Set Measure Delay"]
    #[inline(always)]
    pub fn measuredly(&mut self) -> MeasuredlyW<'_, Ch0TimingSpec> {
        MeasuredlyW::new(self, 14)
    }
}
#[doc = "Scan Configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`ch0_timing::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch0_timing::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch0TimingSpec;
impl crate::RegisterSpec for Ch0TimingSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch0_timing::R`](R) reader structure"]
impl crate::Readable for Ch0TimingSpec {}
#[doc = "`write(|w| ..)` method takes [`ch0_timing::W`](W) writer structure"]
impl crate::Writable for Ch0TimingSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH0_TIMING to value 0"]
impl crate::Resettable for Ch0TimingSpec {}
