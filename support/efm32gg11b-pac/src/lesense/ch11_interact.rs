...
pub type R = crate::R<CH11_INTERACT_SPEC>;
#[doc = "Register `CH11_INTERACT` writer"]
pub type W = crate::W<CH11_INTERACT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn thres(&mut self) -> THRES_W<CH11_INTERACT_SPEC, 0> {
        THRES_W::new(self)
    }
    #[doc = "Bits 12:13 - Select Sample Mode"]
    #[inline(always)]
    #[must_use]
    pub fn sample(&mut self) -> SAMPLE_W<CH11_INTERACT_SPEC, 12> {
        SAMPLE_W::new(self)
    }
    #[doc = "Bits 14:16 - Enable Interrupt Generation"]
    #[inline(always)]
    #[must_use]
    pub fn setif(&mut self) -> SETIF_W<CH11_INTERACT_SPEC, 14> {
        SETIF_W::new(self)
    }
    #[doc = "Bits 17:18 - Set GPIO Mode"]
    #[inline(always)]
    #[must_use]
    pub fn exmode(&mut self) -> EXMODE_W<CH11_INTERACT_SPEC, 17> {
        EXMODE_W::new(self)
    }
    #[doc = "Bit 19 - Select Clock Used for Excitation Timing"]
    #[inline(always)]
    #[must_use]
    pub fn exclk(&mut self) -> EXCLK_W<CH11_INTERACT_SPEC, 19> {
        EXCLK_W::new(self)
    }
    #[doc = "Bit 20 - Select Clock Used for Timing of Sample Delay"]
    #[inline(always)]
    #[must_use]
    pub fn sampleclk(&mut self) -> SAMPLECLK_W<CH11_INTERACT_SPEC, 20> {
        SAMPLECLK_W::new(self)
    }
    #[doc = "Bit 21 - Use Alternative Excite Pin"]
    #[inline(always)]
    #[must_use]
    pub fn altex(&mut self) -> ALTEX_W<CH11_INTERACT_SPEC, 21> {
        ALTEX_W::new(self)
    }
