...
pub type R = crate::R<CH11_TIMING_SPEC>;
#[doc = "Register `CH11_TIMING` writer"]
pub type W = crate::W<CH11_TIMING_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn extime(&mut self) -> EXTIME_W<CH11_TIMING_SPEC, 0> {
        EXTIME_W::new(self)
    }
    #[doc = "Bits 6:13 - Set Sample Delay"]
    #[inline(always)]
    #[must_use]
    pub fn sampledly(&mut self) -> SAMPLEDLY_W<CH11_TIMING_SPEC, 6> {
        SAMPLEDLY_W::new(self)
    }
    #[doc = "Bits 14:23 - Set Measure Delay"]
    #[inline(always)]
    #[must_use]
    pub fn measuredly(&mut self) -> MEASUREDLY_W<CH11_TIMING_SPEC, 14> {
