...
pub type R = crate::R<Ch12InteractSpec>;
#[doc = "Register `CH12_INTERACT` writer"]
pub type W = crate::W<Ch12InteractSpec>;
...
impl W {
    #[doc = "Bits 0:11 - ACMP Threshold or VDAC Data"]
    #[inline(always)]
    pub fn thres(&mut self) -> ThresW<'_, Ch12InteractSpec> {
        ThresW::new(self, 0)
    }
    #[doc = "Bits 12:13 - Select Sample Mode"]
    #[inline(always)]
    pub fn sample(&mut self) -> SampleW<'_, Ch12InteractSpec> {
        SampleW::new(self, 12)
    }
    #[doc = "Bits 14:16 - Enable Interrupt Generation"]
    #[inline(always)]
    pub fn setif(&mut self) -> SetifW<'_, Ch12InteractSpec> {
        SetifW::new(self, 14)
    }
    #[doc = "Bits 17:18 - Set GPIO Mode"]
    #[inline(always)]
    pub fn exmode(&mut self) -> ExmodeW<'_, Ch12InteractSpec> {
        ExmodeW::new(self, 17)
    }
    #[doc = "Bit 19 - Select Clock Used for Excitation Timing"]
    #[inline(always)]
    pub fn exclk(&mut self) -> ExclkW<'_, Ch12InteractSpec> {
        ExclkW::new(self, 19)
    }
    #[doc = "Bit 20 - Select Clock Used for Timing of Sample Delay"]
    #[inline(always)]
    pub fn sampleclk(&mut self) -> SampleclkW<'_, Ch12InteractSpec> {
        SampleclkW::new(self, 20)
    }
    #[doc = "Bit 21 - Use Alternative Excite Pin"]
    #[inline(always)]
    pub fn altex(&mut self) -> AltexW<'_, Ch12InteractSpec> {
        AltexW::new(self, 21)
    }
}
#[doc = "Scan Configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`ch12_interact::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch12_interact::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch12InteractSpec;
impl crate::RegisterSpec for Ch12InteractSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch12_interact::R`](R) reader structure"]
impl crate::Readable for Ch12InteractSpec {}
#[doc = "`write(|w| ..)` method takes [`ch12_interact::W`](W) writer structure"]
impl crate::Writable for Ch12InteractSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH12_INTERACT to value 0"]
impl crate::Resettable for Ch12InteractSpec {}
