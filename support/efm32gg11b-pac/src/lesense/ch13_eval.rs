...
pub type R = crate::R<Ch13EvalSpec>;
#[doc = "Register `CH13_EVAL` writer"]
pub type W = crate::W<Ch13EvalSpec>;
...
impl W {
    #[doc = "Bits 0:15 - Decision Threshold for Sensor Data"]
    #[inline(always)]
    pub fn compthres(&mut self) -> CompthresW<'_, Ch13EvalSpec> {
        CompthresW::new(self, 0)
    }
    #[doc = "Bit 16 - Select Mode for Threshold Comparison"]
    #[inline(always)]
    pub fn comp(&mut self) -> CompW<'_, Ch13EvalSpec> {
        CompW::new(self, 16)
    }
    #[doc = "Bit 17 - Send Result to Decoder"]
    #[inline(always)]
    pub fn decode(&mut self) -> DecodeW<'_, Ch13EvalSpec> {
        DecodeW::new(self, 17)
    }
    #[doc = "Bits 18:19 - Enable Storing of Sensor Sample in Result Buffer"]
    #[inline(always)]
    pub fn strsample(&mut self) -> StrsampleW<'_, Ch13EvalSpec> {
        StrsampleW::new(self, 18)
    }
    #[doc = "Bit 20 - Enable Inversion of Result"]
    #[inline(always)]
    pub fn scanresinv(&mut self) -> ScanresinvW<'_, Ch13EvalSpec> {
        ScanresinvW::new(self, 20)
    }
    #[doc = "Bits 21:22 - Configure Evaluation Mode"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, Ch13EvalSpec> {
        ModeW::new(self, 21)
    }
}
#[doc = "Scan Configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`ch13_eval::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch13_eval::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch13EvalSpec;
impl crate::RegisterSpec for Ch13EvalSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch13_eval::R`](R) reader structure"]
impl crate::Readable for Ch13EvalSpec {}
#[doc = "`write(|w| ..)` method takes [`ch13_eval::W`](W) writer structure"]
impl crate::Writable for Ch13EvalSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH13_EVAL to value 0"]
impl crate::Resettable for Ch13EvalSpec {}
