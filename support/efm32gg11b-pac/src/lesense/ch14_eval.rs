...
pub type R = crate::R<Ch14EvalSpec>;
#[doc = "Register `CH14_EVAL` writer"]
pub type W = crate::W<Ch14EvalSpec>;
...
impl W {
    #[doc = "Bits 0:15 - Decision Threshold for Sensor Data"]
    #[inline(always)]
    pub fn compthres(&mut self) -> CompthresW<'_, Ch14EvalSpec> {
        CompthresW::new(self, 0)
    }
    #[doc = "Bit 16 - Select Mode for Threshold Comparison"]
    #[inline(always)]
    pub fn comp(&mut self) -> CompW<'_, Ch14EvalSpec> {
        CompW::new(self, 16)
    }
    #[doc = "Bit 17 - Send Result to Decoder"]
    #[inline(always)]
    pub fn decode(&mut self) -> DecodeW<'_, Ch14EvalSpec> {
        DecodeW::new(self, 17)
    }
    #[doc = "Bits 18:19 - Enable Storing of Sensor Sample in Result Buffer"]
    #[inline(always)]
    pub fn strsample(&mut self) -> StrsampleW<'_, Ch14EvalSpec> {
        StrsampleW::new(self, 18)
    }
    #[doc = "Bit 20 - Enable Inversion of Result"]
    #[inline(always)]
    pub fn scanresinv(&mut self) -> ScanresinvW<'_, Ch14EvalSpec> {
        ScanresinvW::new(self, 20)
    }
    #[doc = "Bits 21:22 - Configure Evaluation Mode"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, Ch14EvalSpec> {
        ModeW::new(self, 21)
    }
}
#[doc = "Scan Configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`ch14_eval::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch14_eval::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch14EvalSpec;
impl crate::RegisterSpec for Ch14EvalSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch14_eval::R`](R) reader structure"]
impl crate::Readable for Ch14EvalSpec {}
#[doc = "`write(|w| ..)` method takes [`ch14_eval::W`](W) writer structure"]
impl crate::Writable for Ch14EvalSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH14_EVAL to value 0"]
impl crate::Resettable for Ch14EvalSpec {}
