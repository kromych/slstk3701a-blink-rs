...
pub type R = crate::R<Ch15InteractSpec>;
#[doc = "Register `CH15_INTERACT` writer"]
pub type W = crate::W<Ch15InteractSpec>;
...
impl W {
    #[doc = "Bits 0:11 - ACMP Threshold or VDAC Data"]
    #[inline(always)]
    pub fn thres(&mut self) -> ThresW<'_, Ch15InteractSpec> {
        ThresW::new(self, 0)
    }
    #[doc = "Bits 12:13 - Select Sample Mode"]
    #[inline(always)]
    pub fn sample(&mut self) -> SampleW<'_, Ch15InteractSpec> {
        SampleW::new(self, 12)
    }
    #[doc = "Bits 14:16 - Enable Interrupt Generation"]
    #[inline(always)]
    pub fn setif(&mut self) -> SetifW<'_, Ch15InteractSpec> {
        SetifW::new(self, 14)
    }
    #[doc = "Bits 17:18 - Set GPIO Mode"]
    #[inline(always)]
    pub fn exmode(&mut self) -> ExmodeW<'_, Ch15InteractSpec> {
        ExmodeW::new(self, 17)
    }
    #[doc = "Bit 19 - Select Clock Used for Excitation Timing"]
    #[inline(always)]
    pub fn exclk(&mut self) -> ExclkW<'_, Ch15InteractSpec> {
        ExclkW::new(self, 19)
    }
    #[doc = "Bit 20 - Select Clock Used for Timing of Sample Delay"]
    #[inline(always)]
    pub fn sampleclk(&mut self) -> SampleclkW<'_, Ch15InteractSpec> {
        SampleclkW::new(self, 20)
    }
    #[doc = "Bit 21 - Use Alternative Excite Pin"]
    #[inline(always)]
    pub fn altex(&mut self) -> AltexW<'_, Ch15InteractSpec> {
        AltexW::new(self, 21)
    }
}
#[doc = "Scan Configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`ch15_interact::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch15_interact::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch15InteractSpec;
impl crate::RegisterSpec for Ch15InteractSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch15_interact::R`](R) reader structure"]
impl crate::Readable for Ch15InteractSpec {}
#[doc = "`write(|w| ..)` method takes [`ch15_interact::W`](W) writer structure"]
impl crate::Writable for Ch15InteractSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH15_INTERACT to value 0"]
impl crate::Resettable for Ch15InteractSpec {}
