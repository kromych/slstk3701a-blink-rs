...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn thres(&mut self) -> THRES_W<CH15_INTERACT_SPEC> {
        THRES_W::new(self, 0)
    }
    #[doc = "Bits 12:13 - Select Sample Mode"]
    #[inline(always)]
    #[must_use]
    pub fn sample(&mut self) -> SAMPLE_W<CH15_INTERACT_SPEC> {
        SAMPLE_W::new(self, 12)
    }
    #[doc = "Bits 14:16 - Enable Interrupt Generation"]
    #[inline(always)]
    #[must_use]
    pub fn setif(&mut self) -> SETIF_W<CH15_INTERACT_SPEC> {
        SETIF_W::new(self, 14)
    }
    #[doc = "Bits 17:18 - Set GPIO Mode"]
    #[inline(always)]
    #[must_use]
    pub fn exmode(&mut self) -> EXMODE_W<CH15_INTERACT_SPEC> {
        EXMODE_W::new(self, 17)
    }
    #[doc = "Bit 19 - Select Clock Used for Excitation Timing"]
    #[inline(always)]
    #[must_use]
    pub fn exclk(&mut self) -> EXCLK_W<CH15_INTERACT_SPEC> {
        EXCLK_W::new(self, 19)
    }
    #[doc = "Bit 20 - Select Clock Used for Timing of Sample Delay"]
    #[inline(always)]
    #[must_use]
    pub fn sampleclk(&mut self) -> SAMPLECLK_W<CH15_INTERACT_SPEC> {
        SAMPLECLK_W::new(self, 20)
    }
    #[doc = "Bit 21 - Use Alternative Excite Pin"]
    #[inline(always)]
    #[must_use]
    pub fn altex(&mut self) -> ALTEX_W<CH15_INTERACT_SPEC> {
        ALTEX_W::new(self, 21)
    }
