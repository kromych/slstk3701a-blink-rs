...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn extime(&mut self) -> EXTIME_W<CH15_TIMING_SPEC> {
        EXTIME_W::new(self, 0)
    }
    #[doc = "Bits 6:13 - Set Sample Delay"]
    #[inline(always)]
    #[must_use]
    pub fn sampledly(&mut self) -> SAMPLEDLY_W<CH15_TIMING_SPEC> {
        SAMPLEDLY_W::new(self, 6)
    }
    #[doc = "Bits 14:23 - Set Measure Delay"]
    #[inline(always)]
    #[must_use]
    pub fn measuredly(&mut self) -> MEASUREDLY_W<CH15_TIMING_SPEC> {
