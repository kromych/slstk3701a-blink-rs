...
pub type R = crate::R<Ch4TimingSpec>;
#[doc = "Register `CH4_TIMING` writer"]
pub type W = crate::W<Ch4TimingSpec>;
...
impl W {
    #[doc = "Bits 0:5 - Set Excitation Time"]
    #[inline(always)]
    pub fn extime(&mut self) -> ExtimeW<'_, Ch4TimingSpec> {
        ExtimeW::new(self, 0)
    }
    #[doc = "Bits 6:13 - Set Sample Delay"]
    #[inline(always)]
    pub fn sampledly(&mut self) -> SampledlyW<'_, Ch4TimingSpec> {
        SampledlyW::new(self, 6)
    }
    #[doc = "Bits 14:23 - Set Measure Delay"]
    #[inline(always)]
    pub fn measuredly(&mut self) -> MeasuredlyW<'_, Ch4TimingSpec> {
        MeasuredlyW::new(self, 14)
    }
}
#[doc = "Scan Configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`ch4_timing::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch4_timing::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch4TimingSpec;
impl crate::RegisterSpec for Ch4TimingSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch4_timing::R`](R) reader structure"]
impl crate::Readable for Ch4TimingSpec {}
#[doc = "`write(|w| ..)` method takes [`ch4_timing::W`](W) writer structure"]
impl crate::Writable for Ch4TimingSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH4_TIMING to value 0"]
impl crate::Resettable for Ch4TimingSpec {}
