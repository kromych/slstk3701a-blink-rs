...
pub type R = crate::R<Ch6InteractSpec>;
#[doc = "Register `CH6_INTERACT` writer"]
pub type W = crate::W<Ch6InteractSpec>;
...
impl W {
    #[doc = "Bits 0:11 - ACMP Threshold or VDAC Data"]
    #[inline(always)]
    pub fn thres(&mut self) -> ThresW<'_, Ch6InteractSpec> {
        ThresW::new(self, 0)
    }
    #[doc = "Bits 12:13 - Select Sample Mode"]
    #[inline(always)]
    pub fn sample(&mut self) -> SampleW<'_, Ch6InteractSpec> {
        SampleW::new(self, 12)
    }
    #[doc = "Bits 14:16 - Enable Interrupt Generation"]
    #[inline(always)]
    pub fn setif(&mut self) -> SetifW<'_, Ch6InteractSpec> {
        SetifW::new(self, 14)
    }
    #[doc = "Bits 17:18 - Set GPIO Mode"]
    #[inline(always)]
    pub fn exmode(&mut self) -> ExmodeW<'_, Ch6InteractSpec> {
        ExmodeW::new(self, 17)
    }
    #[doc = "Bit 19 - Select Clock Used for Excitation Timing"]
    #[inline(always)]
    pub fn exclk(&mut self) -> ExclkW<'_, Ch6InteractSpec> {
        ExclkW::new(self, 19)
    }
    #[doc = "Bit 20 - Select Clock Used for Timing of Sample Delay"]
    #[inline(always)]
    pub fn sampleclk(&mut self) -> SampleclkW<'_, Ch6InteractSpec> {
        SampleclkW::new(self, 20)
    }
    #[doc = "Bit 21 - Use Alternative Excite Pin"]
    #[inline(always)]
    pub fn altex(&mut self) -> AltexW<'_, Ch6InteractSpec> {
        AltexW::new(self, 21)
    }
}
#[doc = "Scan Configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`ch6_interact::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch6_interact::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch6InteractSpec;
impl crate::RegisterSpec for Ch6InteractSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch6_interact::R`](R) reader structure"]
impl crate::Readable for Ch6InteractSpec {}
#[doc = "`write(|w| ..)` method takes [`ch6_interact::W`](W) writer structure"]
impl crate::Writable for Ch6InteractSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH6_INTERACT to value 0"]
impl crate::Resettable for Ch6InteractSpec {}
