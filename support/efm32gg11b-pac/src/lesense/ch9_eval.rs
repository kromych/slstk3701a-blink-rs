...
pub type R = crate::R<CH9_EVAL_SPEC>;
#[doc = "Register `CH9_EVAL` writer"]
pub type W = crate::W<CH9_EVAL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn compthres(&mut self) -> COMPTHRES_W<CH9_EVAL_SPEC, 0> {
        COMPTHRES_W::new(self)
    }
    #[doc = "Bit 16 - Select Mode for Threshold Comparison"]
    #[inline(always)]
    #[must_use]
    pub fn comp(&mut self) -> COMP_W<CH9_EVAL_SPEC, 16> {
        COMP_W::new(self)
    }
    #[doc = "Bit 17 - Send Result to Decoder"]
    #[inline(always)]
    #[must_use]
    pub fn decode(&mut self) -> DECODE_W<CH9_EVAL_SPEC, 17> {
        DECODE_W::new(self)
    }
    #[doc = "Bits 18:19 - Enable Storing of Sensor Sample in Result Buffer"]
    #[inline(always)]
    #[must_use]
    pub fn strsample(&mut self) -> STRSAMPLE_W<CH9_EVAL_SPEC, 18> {
        STRSAMPLE_W::new(self)
    }
    #[doc = "Bit 20 - Enable Inversion of Result"]
    #[inline(always)]
    #[must_use]
    pub fn scanresinv(&mut self) -> SCANRESINV_W<CH9_EVAL_SPEC, 20> {
        SCANRESINV_W::new(self)
    }
    #[doc = "Bits 21:22 - Configure Evaluation Mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> MODE_W<CH9_EVAL_SPEC, 21> {
        MODE_W::new(self)
    }
...
#[doc = "Scan Configuration\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch9_eval::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch9_eval::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
