...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0(&mut self) -> CH0_W<IEN_SPEC, 0> {
        CH0_W::new(self)
    }
    #[doc = "Bit 1 - CH1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1(&mut self) -> CH1_W<IEN_SPEC, 1> {
        CH1_W::new(self)
    }
    #[doc = "Bit 2 - CH2 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch2(&mut self) -> CH2_W<IEN_SPEC, 2> {
        CH2_W::new(self)
    }
    #[doc = "Bit 3 - CH3 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch3(&mut self) -> CH3_W<IEN_SPEC, 3> {
        CH3_W::new(self)
    }
    #[doc = "Bit 4 - CH4 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch4(&mut self) -> CH4_W<IEN_SPEC, 4> {
        CH4_W::new(self)
    }
    #[doc = "Bit 5 - CH5 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch5(&mut self) -> CH5_W<IEN_SPEC, 5> {
        CH5_W::new(self)
    }
    #[doc = "Bit 6 - CH6 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch6(&mut self) -> CH6_W<IEN_SPEC, 6> {
        CH6_W::new(self)
    }
    #[doc = "Bit 7 - CH7 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch7(&mut self) -> CH7_W<IEN_SPEC, 7> {
        CH7_W::new(self)
    }
    #[doc = "Bit 8 - CH8 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch8(&mut self) -> CH8_W<IEN_SPEC, 8> {
        CH8_W::new(self)
    }
    #[doc = "Bit 9 - CH9 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch9(&mut self) -> CH9_W<IEN_SPEC, 9> {
        CH9_W::new(self)
    }
    #[doc = "Bit 10 - CH10 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch10(&mut self) -> CH10_W<IEN_SPEC, 10> {
        CH10_W::new(self)
    }
    #[doc = "Bit 11 - CH11 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch11(&mut self) -> CH11_W<IEN_SPEC, 11> {
        CH11_W::new(self)
    }
    #[doc = "Bit 12 - CH12 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch12(&mut self) -> CH12_W<IEN_SPEC, 12> {
        CH12_W::new(self)
    }
    #[doc = "Bit 13 - CH13 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch13(&mut self) -> CH13_W<IEN_SPEC, 13> {
        CH13_W::new(self)
    }
    #[doc = "Bit 14 - CH14 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch14(&mut self) -> CH14_W<IEN_SPEC, 14> {
        CH14_W::new(self)
    }
    #[doc = "Bit 15 - CH15 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch15(&mut self) -> CH15_W<IEN_SPEC, 15> {
        CH15_W::new(self)
    }
    #[doc = "Bit 16 - SCANCOMPLETE Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn scancomplete(&mut self) -> SCANCOMPLETE_W<IEN_SPEC, 16> {
        SCANCOMPLETE_W::new(self)
    }
    #[doc = "Bit 17 - DEC Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dec(&mut self) -> DEC_W<IEN_SPEC, 17> {
        DEC_W::new(self)
    }
    #[doc = "Bit 18 - DECERR Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn decerr(&mut self) -> DECERR_W<IEN_SPEC, 18> {
        DECERR_W::new(self)
    }
    #[doc = "Bit 19 - BUFDATAV Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bufdatav(&mut self) -> BUFDATAV_W<IEN_SPEC, 19> {
        BUFDATAV_W::new(self)
    }
    #[doc = "Bit 20 - BUFLEVEL Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn buflevel(&mut self) -> BUFLEVEL_W<IEN_SPEC, 20> {
        BUFLEVEL_W::new(self)
    }
    #[doc = "Bit 21 - BUFOF Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bufof(&mut self) -> BUFOF_W<IEN_SPEC, 21> {
        BUFOF_W::new(self)
    }
    #[doc = "Bit 22 - CNTOF Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cntof(&mut self) -> CNTOF_W<IEN_SPEC, 22> {
        CNTOF_W::new(self)
    }
