...
pub type ALTEX0PEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ALTEX1PEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ALTEX2PEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ALTEX3PEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ALTEX4PEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ALTEX5PEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ALTEX6PEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ALTEX7PEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch12pen(&mut self) -> CH12PEN_W<ROUTEPEN_SPEC, 12> {
        CH12PEN_W::new(self)
    }
    #[doc = "Bit 13 - CH13 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch13pen(&mut self) -> CH13PEN_W<ROUTEPEN_SPEC, 13> {
        CH13PEN_W::new(self)
    }
    #[doc = "Bit 14 - CH14 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch14pen(&mut self) -> CH14PEN_W<ROUTEPEN_SPEC, 14> {
        CH14PEN_W::new(self)
    }
    #[doc = "Bit 15 - CH15 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch15pen(&mut self) -> CH15PEN_W<ROUTEPEN_SPEC, 15> {
        CH15PEN_W::new(self)
    }
    #[doc = "Bit 16 - ALTEX0 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn altex0pen(&mut self) -> ALTEX0PEN_W<ROUTEPEN_SPEC, 16> {
        ALTEX0PEN_W::new(self)
    }
    #[doc = "Bit 17 - ALTEX1 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn altex1pen(&mut self) -> ALTEX1PEN_W<ROUTEPEN_SPEC, 17> {
        ALTEX1PEN_W::new(self)
    }
    #[doc = "Bit 18 - ALTEX2 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn altex2pen(&mut self) -> ALTEX2PEN_W<ROUTEPEN_SPEC, 18> {
        ALTEX2PEN_W::new(self)
    }
    #[doc = "Bit 19 - ALTEX3 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn altex3pen(&mut self) -> ALTEX3PEN_W<ROUTEPEN_SPEC, 19> {
        ALTEX3PEN_W::new(self)
    }
    #[doc = "Bit 20 - ALTEX4 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn altex4pen(&mut self) -> ALTEX4PEN_W<ROUTEPEN_SPEC, 20> {
        ALTEX4PEN_W::new(self)
    }
    #[doc = "Bit 21 - ALTEX5 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn altex5pen(&mut self) -> ALTEX5PEN_W<ROUTEPEN_SPEC, 21> {
        ALTEX5PEN_W::new(self)
    }
    #[doc = "Bit 22 - ALTEX6 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn altex6pen(&mut self) -> ALTEX6PEN_W<ROUTEPEN_SPEC, 22> {
        ALTEX6PEN_W::new(self)
    }
    #[doc = "Bit 23 - ALTEX7 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn altex7pen(&mut self) -> ALTEX7PEN_W<ROUTEPEN_SPEC, 23> {
