...
pub type R = crate::R<ST12_TCONFA_SPEC>;
#[doc = "Register `ST12_TCONFA` writer"]
pub type W = crate::W<ST12_TCONFA_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp(&mut self) -> COMP_W<ST12_TCONFA_SPEC, 0> {
        COMP_W::new(self)
    }
    #[doc = "Bits 4:7 - Sensor Mask"]
    #[inline(always)]
    #[must_use]
    pub fn mask(&mut self) -> MASK_W<ST12_TCONFA_SPEC, 4> {
        MASK_W::new(self)
    }
    #[doc = "Bits 8:12 - Next State Index"]
    #[inline(always)]
    #[must_use]
    pub fn nextstate(&mut self) -> NEXTSTATE_W<ST12_TCONFA_SPEC, 8> {
        NEXTSTATE_W::new(self)
    }
    #[doc = "Bit 14 - Enable State Descriptor Chaining"]
    #[inline(always)]
    #[must_use]
    pub fn chain(&mut self) -> CHAIN_W<ST12_TCONFA_SPEC, 14> {
        CHAIN_W::new(self)
    }
    #[doc = "Bit 15 - Set Interrupt Flag Enable"]
    #[inline(always)]
    #[must_use]
    pub fn setif(&mut self) -> SETIF_W<ST12_TCONFA_SPEC, 15> {
        SETIF_W::new(self)
    }
    #[doc = "Bits 16:18 - Configure Transition Action"]
    #[inline(always)]
    #[must_use]
    pub fn prsact(&mut self) -> PRSACT_W<ST12_TCONFA_SPEC, 16> {
        PRSACT_W::new(self)
    }
...
#[doc = "State Transition Configuration a\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st12_tconfa::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st12_tconfa::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
