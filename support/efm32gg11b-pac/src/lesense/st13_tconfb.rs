...
pub type R = crate::R<St13TconfbSpec>;
#[doc = "Register `ST13_TCONFB` writer"]
pub type W = crate::W<St13TconfbSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Sensor Compare Value"]
    #[inline(always)]
    pub fn comp(&mut self) -> CompW<'_, St13TconfbSpec> {
        CompW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Sensor Mask"]
    #[inline(always)]
    pub fn mask(&mut self) -> MaskW<'_, St13TconfbSpec> {
        MaskW::new(self, 4)
    }
    #[doc = "Bits 8:12 - Next State Index"]
    #[inline(always)]
    pub fn nextstate(&mut self) -> NextstateW<'_, St13TconfbSpec> {
        NextstateW::new(self, 8)
    }
    #[doc = "Bit 15 - Set Interrupt Flag"]
    #[inline(always)]
    pub fn setif(&mut self) -> SetifW<'_, St13TconfbSpec> {
        SetifW::new(self, 15)
    }
    #[doc = "Bits 16:18 - Configure Transition Action"]
    #[inline(always)]
    pub fn prsact(&mut self) -> PrsactW<'_, St13TconfbSpec> {
        PrsactW::new(self, 16)
    }
}
#[doc = "State Transition Configuration B\n\nYou can [`read`](crate::Reg::read) this register and get [`st13_tconfb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st13_tconfb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St13TconfbSpec;
impl crate::RegisterSpec for St13TconfbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st13_tconfb::R`](R) reader structure"]
impl crate::Readable for St13TconfbSpec {}
#[doc = "`write(|w| ..)` method takes [`st13_tconfb::W`](W) writer structure"]
impl crate::Writable for St13TconfbSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST13_TCONFB to value 0"]
impl crate::Resettable for St13TconfbSpec {}
