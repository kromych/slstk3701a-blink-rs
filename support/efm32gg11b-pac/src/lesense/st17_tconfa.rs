...
pub type R = crate::R<St17TconfaSpec>;
#[doc = "Register `ST17_TCONFA` writer"]
pub type W = crate::W<St17TconfaSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Sensor Compare Value"]
    #[inline(always)]
    pub fn comp(&mut self) -> CompW<'_, St17TconfaSpec> {
        CompW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Sensor Mask"]
    #[inline(always)]
    pub fn mask(&mut self) -> MaskW<'_, St17TconfaSpec> {
        MaskW::new(self, 4)
    }
    #[doc = "Bits 8:12 - Next State Index"]
    #[inline(always)]
    pub fn nextstate(&mut self) -> NextstateW<'_, St17TconfaSpec> {
        NextstateW::new(self, 8)
    }
    #[doc = "Bit 14 - Enable State Descriptor Chaining"]
    #[inline(always)]
    pub fn chain(&mut self) -> ChainW<'_, St17TconfaSpec> {
        ChainW::new(self, 14)
    }
    #[doc = "Bit 15 - Set Interrupt Flag Enable"]
    #[inline(always)]
    pub fn setif(&mut self) -> SetifW<'_, St17TconfaSpec> {
        SetifW::new(self, 15)
    }
    #[doc = "Bits 16:18 - Configure Transition Action"]
    #[inline(always)]
    pub fn prsact(&mut self) -> PrsactW<'_, St17TconfaSpec> {
        PrsactW::new(self, 16)
    }
}
#[doc = "State Transition Configuration a\n\nYou can [`read`](crate::Reg::read) this register and get [`st17_tconfa::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st17_tconfa::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St17TconfaSpec;
impl crate::RegisterSpec for St17TconfaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st17_tconfa::R`](R) reader structure"]
impl crate::Readable for St17TconfaSpec {}
#[doc = "`write(|w| ..)` method takes [`st17_tconfa::W`](W) writer structure"]
impl crate::Writable for St17TconfaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST17_TCONFA to value 0"]
impl crate::Resettable for St17TconfaSpec {}
