...
pub type R = crate::R<ST22_TCONFB_SPEC>;
#[doc = "Register `ST22_TCONFB` writer"]
pub type W = crate::W<ST22_TCONFB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp(&mut self) -> COMP_W<ST22_TCONFB_SPEC, 0> {
        COMP_W::new(self)
    }
    #[doc = "Bits 4:7 - Sensor Mask"]
    #[inline(always)]
    #[must_use]
    pub fn mask(&mut self) -> MASK_W<ST22_TCONFB_SPEC, 4> {
        MASK_W::new(self)
    }
    #[doc = "Bits 8:12 - Next State Index"]
    #[inline(always)]
    #[must_use]
    pub fn nextstate(&mut self) -> NEXTSTATE_W<ST22_TCONFB_SPEC, 8> {
        NEXTSTATE_W::new(self)
    }
    #[doc = "Bit 15 - Set Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn setif(&mut self) -> SETIF_W<ST22_TCONFB_SPEC, 15> {
        SETIF_W::new(self)
    }
    #[doc = "Bits 16:18 - Configure Transition Action"]
    #[inline(always)]
    #[must_use]
    pub fn prsact(&mut self) -> PRSACT_W<ST22_TCONFB_SPEC, 16> {
        PRSACT_W::new(self)
    }
