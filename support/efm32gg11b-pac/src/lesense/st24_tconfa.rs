...
pub type R = crate::R<St24TconfaSpec>;
#[doc = "Register `ST24_TCONFA` writer"]
pub type W = crate::W<St24TconfaSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Sensor Compare Value"]
    #[inline(always)]
    pub fn comp(&mut self) -> CompW<'_, St24TconfaSpec> {
        CompW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Sensor Mask"]
    #[inline(always)]
    pub fn mask(&mut self) -> MaskW<'_, St24TconfaSpec> {
        MaskW::new(self, 4)
    }
    #[doc = "Bits 8:12 - Next State Index"]
    #[inline(always)]
    pub fn nextstate(&mut self) -> NextstateW<'_, St24TconfaSpec> {
        NextstateW::new(self, 8)
    }
    #[doc = "Bit 14 - Enable State Descriptor Chaining"]
    #[inline(always)]
    pub fn chain(&mut self) -> ChainW<'_, St24TconfaSpec> {
        ChainW::new(self, 14)
    }
    #[doc = "Bit 15 - Set Interrupt Flag Enable"]
    #[inline(always)]
    pub fn setif(&mut self) -> SetifW<'_, St24TconfaSpec> {
        SetifW::new(self, 15)
    }
    #[doc = "Bits 16:18 - Configure Transition Action"]
    #[inline(always)]
    pub fn prsact(&mut self) -> PrsactW<'_, St24TconfaSpec> {
        PrsactW::new(self, 16)
    }
}
#[doc = "State Transition Configuration a\n\nYou can [`read`](crate::Reg::read) this register and get [`st24_tconfa::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st24_tconfa::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St24TconfaSpec;
impl crate::RegisterSpec for St24TconfaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st24_tconfa::R`](R) reader structure"]
impl crate::Readable for St24TconfaSpec {}
#[doc = "`write(|w| ..)` method takes [`st24_tconfa::W`](W) writer structure"]
impl crate::Writable for St24TconfaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST24_TCONFA to value 0"]
impl crate::Resettable for St24TconfaSpec {}
