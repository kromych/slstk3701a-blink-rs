...
pub type R = crate::R<St24TconfbSpec>;
#[doc = "Register `ST24_TCONFB` writer"]
pub type W = crate::W<St24TconfbSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Sensor Compare Value"]
    #[inline(always)]
    pub fn comp(&mut self) -> CompW<'_, St24TconfbSpec> {
        CompW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Sensor Mask"]
    #[inline(always)]
    pub fn mask(&mut self) -> MaskW<'_, St24TconfbSpec> {
        MaskW::new(self, 4)
    }
    #[doc = "Bits 8:12 - Next State Index"]
    #[inline(always)]
    pub fn nextstate(&mut self) -> NextstateW<'_, St24TconfbSpec> {
        NextstateW::new(self, 8)
    }
    #[doc = "Bit 15 - Set Interrupt Flag"]
    #[inline(always)]
    pub fn setif(&mut self) -> SetifW<'_, St24TconfbSpec> {
        SetifW::new(self, 15)
    }
    #[doc = "Bits 16:18 - Configure Transition Action"]
    #[inline(always)]
    pub fn prsact(&mut self) -> PrsactW<'_, St24TconfbSpec> {
        PrsactW::new(self, 16)
    }
}
#[doc = "State Transition Configuration B\n\nYou can [`read`](crate::Reg::read) this register and get [`st24_tconfb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st24_tconfb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St24TconfbSpec;
impl crate::RegisterSpec for St24TconfbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st24_tconfb::R`](R) reader structure"]
impl crate::Readable for St24TconfbSpec {}
#[doc = "`write(|w| ..)` method takes [`st24_tconfb::W`](W) writer structure"]
impl crate::Writable for St24TconfbSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST24_TCONFB to value 0"]
impl crate::Resettable for St24TconfbSpec {}
