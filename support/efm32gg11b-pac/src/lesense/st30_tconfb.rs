...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp(&mut self) -> COMP_W<ST30_TCONFB_SPEC> {
        COMP_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Sensor Mask"]
    #[inline(always)]
    #[must_use]
    pub fn mask(&mut self) -> MASK_W<ST30_TCONFB_SPEC> {
        MASK_W::new(self, 4)
    }
    #[doc = "Bits 8:12 - Next State Index"]
    #[inline(always)]
    #[must_use]
    pub fn nextstate(&mut self) -> NEXTSTATE_W<ST30_TCONFB_SPEC> {
        NEXTSTATE_W::new(self, 8)
    }
    #[doc = "Bit 15 - Set Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn setif(&mut self) -> SETIF_W<ST30_TCONFB_SPEC> {
        SETIF_W::new(self, 15)
    }
    #[doc = "Bits 16:18 - Configure Transition Action"]
    #[inline(always)]
    #[must_use]
    pub fn prsact(&mut self) -> PRSACT_W<ST30_TCONFB_SPEC> {
