...
pub type RAMECCEWEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RAMECCCHKEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RAM1ECCEWEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RAM1ECCCHKEN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rameccewen(&mut self) -> RAMECCEWEN_W<ECCCTRL_SPEC> {
        RAMECCEWEN_W::new(self, 0)
    }
    #[doc = "Bit 1 - RAM ECC Check Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rameccchken(&mut self) -> RAMECCCHKEN_W<ECCCTRL_SPEC> {
        RAMECCCHKEN_W::new(self, 1)
    }
    #[doc = "Bit 2 - RAM1 ECC Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ram1eccewen(&mut self) -> RAM1ECCEWEN_W<ECCCTRL_SPEC> {
        RAM1ECCEWEN_W::new(self, 2)
    }
    #[doc = "Bit 3 - RAM1 ECC Check Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ram1eccchken(&mut self) -> RAM1ECCCHKEN_W<ECCCTRL_SPEC> {
        RAM1ECCCHKEN_W::new(self, 3)
    }
