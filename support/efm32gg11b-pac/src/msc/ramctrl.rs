...
pub type RAMWSEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RAMPREFETCHEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RAM1WSEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RAM1PREFETCHEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RAM2CACHEEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RAM2WSEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RAM2PREFETCHEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ramwsen(&mut self) -> RAMWSEN_W<RAMCTRL_SPEC, 1> {
        RAMWSEN_W::new(self)
    }
    #[doc = "Bit 2 - RAM Prefetch Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ramprefetchen(&mut self) -> RAMPREFETCHEN_W<RAMCTRL_SPEC, 2> {
        RAMPREFETCHEN_W::new(self)
    }
    #[doc = "Bit 9 - RAM1 WAIT STATE Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ram1wsen(&mut self) -> RAM1WSEN_W<RAMCTRL_SPEC, 9> {
        RAM1WSEN_W::new(self)
    }
    #[doc = "Bit 10 - RAM1 Prefetch Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ram1prefetchen(&mut self) -> RAM1PREFETCHEN_W<RAMCTRL_SPEC, 10> {
        RAM1PREFETCHEN_W::new(self)
    }
    #[doc = "Bit 16 - RAM2 CACHE Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ram2cacheen(&mut self) -> RAM2CACHEEN_W<RAMCTRL_SPEC, 16> {
        RAM2CACHEEN_W::new(self)
    }
    #[doc = "Bit 17 - RAM2 WAIT STATE Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ram2wsen(&mut self) -> RAM2WSEN_W<RAMCTRL_SPEC, 17> {
        RAM2WSEN_W::new(self)
    }
    #[doc = "Bit 18 - RAM2 Prefetch Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ram2prefetchen(&mut self) -> RAM2PREFETCHEN_W<RAMCTRL_SPEC, 18> {
