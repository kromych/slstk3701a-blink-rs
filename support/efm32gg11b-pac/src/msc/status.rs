...
pub type BankswitchedR = crate::BitReader;
#[doc = "Field `WDATAVALID` reader - Write Data Buffer Valid Flag"]
pub type WdatavalidR = crate::FieldReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn bankswitched(&self) -> BankswitchedR {
        BankswitchedR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bits 24:27 - Write Data Buffer Valid Flag"]
    #[inline(always)]
    pub fn wdatavalid(&self) -> WdatavalidR {
        WdatavalidR::new(((self.bits >> 24) & 0x0f) as u8)
    }
