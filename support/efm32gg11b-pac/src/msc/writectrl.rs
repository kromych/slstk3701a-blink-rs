...
pub type RwwenR = crate::BitReader;
#[doc = "Field `RWWEN` writer - Read-While-Write Enable"]
pub type RwwenW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn rwwen(&self) -> RwwenR {
        RwwenR::new(((self.bits >> 5) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Enable Write/Erase Controller"]
    ...
    #[doc = "Bit 5 - Read-While-Write Enable"]
    #[inline(always)]
    pub fn rwwen(&mut self) -> RwwenW<'_, WritectrlSpec> {
        RwwenW::new(self, 5)
    }
}
