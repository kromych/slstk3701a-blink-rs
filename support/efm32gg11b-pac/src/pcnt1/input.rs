...
pub type S0PRSSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O, S0PRSSEL_A>;
...
pub type S1PRSSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O, S1PRSSEL_A>;
