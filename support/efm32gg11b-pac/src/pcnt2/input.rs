...
impl S0PRSSEL_R {
    ...
    pub const fn variant(&self) -> Option<S0PRSSEL_A> {
        match self.bits {
            ...
            12 => Some(S0PRSSEL_A::PRSCH12),
            13 => Some(S0PRSSEL_A::PRSCH13),
            14 => Some(S0PRSSEL_A::PRSCH14),
            15 => Some(S0PRSSEL_A::PRSCH15),
            16 => Some(S0PRSSEL_A::PRSCH16),
            17 => Some(S0PRSSEL_A::PRSCH17),
            18 => Some(S0PRSSEL_A::PRSCH18),
            19 => Some(S0PRSSEL_A::PRSCH19),
            20 => Some(S0PRSSEL_A::PRSCH20),
            21 => Some(S0PRSSEL_A::PRSCH21),
            22 => Some(S0PRSSEL_A::PRSCH22),
            23 => Some(S0PRSSEL_A::PRSCH23),
            _ => None,
        }
    }
...
pub type S0PRSSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 5, S0PRSSEL_A>;
...
impl S1PRSSEL_R {
    ...
    pub const fn variant(&self) -> Option<S1PRSSEL_A> {
        match self.bits {
            ...
            12 => Some(S1PRSSEL_A::PRSCH12),
            13 => Some(S1PRSSEL_A::PRSCH13),
            14 => Some(S1PRSSEL_A::PRSCH14),
            15 => Some(S1PRSSEL_A::PRSCH15),
            16 => Some(S1PRSSEL_A::PRSCH16),
            17 => Some(S1PRSSEL_A::PRSCH17),
            18 => Some(S1PRSSEL_A::PRSCH18),
            19 => Some(S1PRSSEL_A::PRSCH19),
            20 => Some(S1PRSSEL_A::PRSCH20),
            21 => Some(S1PRSSEL_A::PRSCH21),
            22 => Some(S1PRSSEL_A::PRSCH22),
            23 => Some(S1PRSSEL_A::PRSCH23),
            _ => None,
        }
    }
    #[doc = "PRS Channel 0 selected."]
...
pub type S1PRSSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 5, S1PRSSEL_A>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn s0prssel(&mut self) -> S0PRSSEL_W<INPUT_SPEC> {
        S0PRSSEL_W::new(self, 0)
    }
    #[doc = "Bit 5 - S0IN PRS Enable"]
    #[inline(always)]
    #[must_use]
    pub fn s0prsen(&mut self) -> S0PRSEN_W<INPUT_SPEC> {
        S0PRSEN_W::new(self, 5)
    }
    #[doc = "Bits 6:10 - S1IN PRS Channel Select"]
    #[inline(always)]
    #[must_use]
    pub fn s1prssel(&mut self) -> S1PRSSEL_W<INPUT_SPEC> {
        S1PRSSEL_W::new(self, 6)
    }
    #[doc = "Bit 11 - S1IN PRS Enable"]
    #[inline(always)]
    #[must_use]
    pub fn s1prsen(&mut self) -> S1PRSEN_W<INPUT_SPEC> {
