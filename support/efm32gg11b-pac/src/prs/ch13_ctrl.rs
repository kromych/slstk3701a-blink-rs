...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sigsel(&mut self) -> SIGSEL_W<CH13_CTRL_SPEC> {
        SIGSEL_W::new(self, 0)
    }
    #[doc = "Bits 8:14 - Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn sourcesel(&mut self) -> SOURCESEL_W<CH13_CTRL_SPEC> {
        SOURCESEL_W::new(self, 8)
    }
    #[doc = "Bits 20:21 - Edge Detect Select"]
    #[inline(always)]
    #[must_use]
    pub fn edsel(&mut self) -> EDSEL_W<CH13_CTRL_SPEC> {
        EDSEL_W::new(self, 20)
    }
    #[doc = "Bit 25 - Stretch Channel Output"]
    #[inline(always)]
    #[must_use]
    pub fn stretch(&mut self) -> STRETCH_W<CH13_CTRL_SPEC> {
        STRETCH_W::new(self, 25)
    }
    #[doc = "Bit 26 - Invert Channel"]
    #[inline(always)]
    #[must_use]
    pub fn inv(&mut self) -> INV_W<CH13_CTRL_SPEC> {
        INV_W::new(self, 26)
    }
    #[doc = "Bit 27 - Or Previous"]
    #[inline(always)]
    #[must_use]
    pub fn orprev(&mut self) -> ORPREV_W<CH13_CTRL_SPEC> {
        ORPREV_W::new(self, 27)
    }
    #[doc = "Bit 28 - And Next"]
    #[inline(always)]
    #[must_use]
    pub fn andnext(&mut self) -> ANDNEXT_W<CH13_CTRL_SPEC> {
        ANDNEXT_W::new(self, 28)
    }
    #[doc = "Bit 30 - Asynchronous Reflex"]
    #[inline(always)]
    #[must_use]
    pub fn async_(&mut self) -> ASYNC_W<CH13_CTRL_SPEC> {
        ASYNC_W::new(self, 30)
    }
