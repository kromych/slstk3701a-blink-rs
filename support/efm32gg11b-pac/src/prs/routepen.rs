...
pub type CH16PEN_R = crate::BitReader;
#[doc = "Field `CH16PEN` writer - CH16 Pin Enable"]
pub type CH16PEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CH17PEN` reader - CH17 Pin Enable"]
pub type CH17PEN_R = crate::BitReader;
#[doc = "Field `CH17PEN` writer - CH17 Pin Enable"]
pub type CH17PEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CH18PEN` reader - CH18 Pin Enable"]
pub type CH18PEN_R = crate::BitReader;
#[doc = "Field `CH18PEN` writer - CH18 Pin Enable"]
pub type CH18PEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CH19PEN` reader - CH19 Pin Enable"]
pub type CH19PEN_R = crate::BitReader;
#[doc = "Field `CH19PEN` writer - CH19 Pin Enable"]
pub type CH19PEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CH20PEN` reader - CH20 Pin Enable"]
pub type CH20PEN_R = crate::BitReader;
#[doc = "Field `CH20PEN` writer - CH20 Pin Enable"]
pub type CH20PEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CH21PEN` reader - CH21 Pin Enable"]
pub type CH21PEN_R = crate::BitReader;
#[doc = "Field `CH21PEN` writer - CH21 Pin Enable"]
pub type CH21PEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CH22PEN` reader - CH22 Pin Enable"]
pub type CH22PEN_R = crate::BitReader;
#[doc = "Field `CH22PEN` writer - CH22 Pin Enable"]
pub type CH22PEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CH23PEN` reader - CH23 Pin Enable"]
pub type CH23PEN_R = crate::BitReader;
#[doc = "Field `CH23PEN` writer - CH23 Pin Enable"]
pub type CH23PEN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch16pen(&mut self) -> CH16PEN_W<ROUTEPEN_SPEC> {
        CH16PEN_W::new(self, 16)
    }
    #[doc = "Bit 17 - CH17 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch17pen(&mut self) -> CH17PEN_W<ROUTEPEN_SPEC> {
        CH17PEN_W::new(self, 17)
    }
    #[doc = "Bit 18 - CH18 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch18pen(&mut self) -> CH18PEN_W<ROUTEPEN_SPEC> {
        CH18PEN_W::new(self, 18)
    }
    #[doc = "Bit 19 - CH19 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch19pen(&mut self) -> CH19PEN_W<ROUTEPEN_SPEC> {
        CH19PEN_W::new(self, 19)
    }
    #[doc = "Bit 20 - CH20 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch20pen(&mut self) -> CH20PEN_W<ROUTEPEN_SPEC> {
        CH20PEN_W::new(self, 20)
    }
    #[doc = "Bit 21 - CH21 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch21pen(&mut self) -> CH21PEN_W<ROUTEPEN_SPEC> {
        CH21PEN_W::new(self, 21)
    }
    #[doc = "Bit 22 - CH22 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch22pen(&mut self) -> CH22PEN_W<ROUTEPEN_SPEC> {
        CH22PEN_W::new(self, 22)
    }
    #[doc = "Bit 23 - CH23 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch23pen(&mut self) -> CH23PEN_W<ROUTEPEN_SPEC> {
        CH23PEN_W::new(self, 23)
    }
