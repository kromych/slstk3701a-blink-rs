...
pub type CH6LEVEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CH7LEVEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CH8LEVEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CH9LEVEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CH10LEVEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch6level(&mut self) -> CH6LEVEL_W<SWLEVEL_SPEC, 6> {
        CH6LEVEL_W::new(self)
    }
    #[doc = "Bit 7 - Channel 7 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch7level(&mut self) -> CH7LEVEL_W<SWLEVEL_SPEC, 7> {
        CH7LEVEL_W::new(self)
    }
    #[doc = "Bit 8 - Channel 8 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch8level(&mut self) -> CH8LEVEL_W<SWLEVEL_SPEC, 8> {
        CH8LEVEL_W::new(self)
    }
    #[doc = "Bit 9 - Channel 9 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch9level(&mut self) -> CH9LEVEL_W<SWLEVEL_SPEC, 9> {
        CH9LEVEL_W::new(self)
    }
    #[doc = "Bit 10 - Channel 10 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch10level(&mut self) -> CH10LEVEL_W<SWLEVEL_SPEC, 10> {
        CH10LEVEL_W::new(self)
    }
    #[doc = "Bit 11 - Channel 11 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch11level(&mut self) -> CH11LEVEL_W<SWLEVEL_SPEC, 11> {
        CH11LEVEL_W::new(self)
    }
    #[doc = "Bit 12 - Channel 12 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch12level(&mut self) -> CH12LEVEL_W<SWLEVEL_SPEC, 12> {
        CH12LEVEL_W::new(self)
    }
    #[doc = "Bit 13 - Channel 13 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch13level(&mut self) -> CH13LEVEL_W<SWLEVEL_SPEC, 13> {
        CH13LEVEL_W::new(self)
    }
    #[doc = "Bit 14 - Channel 14 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch14level(&mut self) -> CH14LEVEL_W<SWLEVEL_SPEC, 14> {
        CH14LEVEL_W::new(self)
    }
    #[doc = "Bit 15 - Channel 15 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch15level(&mut self) -> CH15LEVEL_W<SWLEVEL_SPEC, 15> {
        CH15LEVEL_W::new(self)
    }
    #[doc = "Bit 16 - Channel 16 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch16level(&mut self) -> CH16LEVEL_W<SWLEVEL_SPEC, 16> {
        CH16LEVEL_W::new(self)
    }
    #[doc = "Bit 17 - Channel 17 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch17level(&mut self) -> CH17LEVEL_W<SWLEVEL_SPEC, 17> {
        CH17LEVEL_W::new(self)
    }
    #[doc = "Bit 18 - Channel 18 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch18level(&mut self) -> CH18LEVEL_W<SWLEVEL_SPEC, 18> {
        CH18LEVEL_W::new(self)
    }
    #[doc = "Bit 19 - Channel 19 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch19level(&mut self) -> CH19LEVEL_W<SWLEVEL_SPEC, 19> {
        CH19LEVEL_W::new(self)
    }
    #[doc = "Bit 20 - Channel 20 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch20level(&mut self) -> CH20LEVEL_W<SWLEVEL_SPEC, 20> {
        CH20LEVEL_W::new(self)
    }
    #[doc = "Bit 21 - Channel 21 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch21level(&mut self) -> CH21LEVEL_W<SWLEVEL_SPEC, 21> {
        CH21LEVEL_W::new(self)
    }
    #[doc = "Bit 22 - Channel 22 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch22level(&mut self) -> CH22LEVEL_W<SWLEVEL_SPEC, 22> {
        CH22LEVEL_W::new(self)
    }
    #[doc = "Bit 23 - Channel 23 Software Level"]
    #[inline(always)]
    #[must_use]
    pub fn ch23level(&mut self) -> CH23LEVEL_W<SWLEVEL_SPEC, 23> {
