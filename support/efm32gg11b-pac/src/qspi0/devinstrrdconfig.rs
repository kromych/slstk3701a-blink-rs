...
pub type RDOPCODENONXIP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type INSTRTYPE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type MODEBITENABLE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUMMYRDCLKCYCLES_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdopcodenonxip(&mut self) -> RDOPCODENONXIP_W<DEVINSTRRDCONFIG_SPEC, 0> {
        RDOPCODENONXIP_W::new(self)
    }
    #[doc = "Bits 8:9 - Instruction Type"]
    #[inline(always)]
    #[must_use]
    pub fn instrtype(&mut self) -> INSTRTYPE_W<DEVINSTRRDCONFIG_SPEC, 8> {
        INSTRTYPE_W::new(self)
    }
    #[doc = "Bit 10 - DDR Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ddren(&mut self) -> DDREN_W<DEVINSTRRDCONFIG_SPEC, 10> {
        DDREN_W::new(self)
    }
    #[doc = "Bits 12:13 - Address Transfer Type for Standard SPI Modes"]
    #[inline(always)]
    #[must_use]
    pub fn addrxfertypestdmode(&mut self) -> ADDRXFERTYPESTDMODE_W<DEVINSTRRDCONFIG_SPEC, 12> {
        ADDRXFERTYPESTDMODE_W::new(self)
    }
    #[doc = "Bits 16:17 - Data Transfer Type for Standard SPI Modes"]
    #[inline(always)]
    #[must_use]
    pub fn dataxfertypeextmode(&mut self) -> DATAXFERTYPEEXTMODE_W<DEVINSTRRDCONFIG_SPEC, 16> {
        DATAXFERTYPEEXTMODE_W::new(self)
    }
    #[doc = "Bit 20 - Mode Bit Enable"]
    #[inline(always)]
    #[must_use]
    pub fn modebitenable(&mut self) -> MODEBITENABLE_W<DEVINSTRRDCONFIG_SPEC, 20> {
        MODEBITENABLE_W::new(self)
    }
    #[doc = "Bits 24:28 - Dummy Read Clock Cycles"]
    #[inline(always)]
    #[must_use]
    pub fn dummyrdclkcycles(&mut self) -> DUMMYRDCLKCYCLES_W<DEVINSTRRDCONFIG_SPEC, 24> {
