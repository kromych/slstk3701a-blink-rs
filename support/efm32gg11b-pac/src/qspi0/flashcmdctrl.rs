...
pub type CMDEXEC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type STIGMEMBANKEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type NUMDUMMYCYCLES_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
pub type NUMWRDATABYTES_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type ENBWRITEDATA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type NUMADDRBYTES_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type ENBMODEBIT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ENBCOMDADDR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type NUMRDDATABYTES_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type ENBREADDATA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CMDOPCODE` reader - Command Opcode"]
pub type CMDOPCODE_R = crate::FieldReader;
#[doc = "Field `CMDOPCODE` writer - Command Opcode"]
pub type CMDOPCODE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmdexec(&mut self) -> CMDEXEC_W<FLASHCMDCTRL_SPEC, 0> {
        CMDEXEC_W::new(self)
    }
    #[doc = "Bit 2 - STIG Memory Bank Enable Bit"]
    #[inline(always)]
    #[must_use]
    pub fn stigmembanken(&mut self) -> STIGMEMBANKEN_W<FLASHCMDCTRL_SPEC, 2> {
        STIGMEMBANKEN_W::new(self)
    }
    #[doc = "Bits 7:11 - Number of Dummy Cycles"]
    #[inline(always)]
    #[must_use]
    pub fn numdummycycles(&mut self) -> NUMDUMMYCYCLES_W<FLASHCMDCTRL_SPEC, 7> {
        NUMDUMMYCYCLES_W::new(self)
    }
    #[doc = "Bits 12:14 - Number of Write Data Bytes"]
    #[inline(always)]
    #[must_use]
    pub fn numwrdatabytes(&mut self) -> NUMWRDATABYTES_W<FLASHCMDCTRL_SPEC, 12> {
        NUMWRDATABYTES_W::new(self)
    }
    #[doc = "Bit 15 - Write Data Enable"]
    #[inline(always)]
    #[must_use]
    pub fn enbwritedata(&mut self) -> ENBWRITEDATA_W<FLASHCMDCTRL_SPEC, 15> {
        ENBWRITEDATA_W::new(self)
    }
    #[doc = "Bits 16:17 - Number of Address Bytes"]
    #[inline(always)]
    #[must_use]
    pub fn numaddrbytes(&mut self) -> NUMADDRBYTES_W<FLASHCMDCTRL_SPEC, 16> {
        NUMADDRBYTES_W::new(self)
    }
    #[doc = "Bit 18 - Mode Bit Enable"]
    #[inline(always)]
    #[must_use]
    pub fn enbmodebit(&mut self) -> ENBMODEBIT_W<FLASHCMDCTRL_SPEC, 18> {
        ENBMODEBIT_W::new(self)
    }
    #[doc = "Bit 19 - Command Address Enable"]
    #[inline(always)]
    #[must_use]
    pub fn enbcomdaddr(&mut self) -> ENBCOMDADDR_W<FLASHCMDCTRL_SPEC, 19> {
        ENBCOMDADDR_W::new(self)
    }
    #[doc = "Bits 20:22 - Number of Read Data Bytes"]
    #[inline(always)]
    #[must_use]
    pub fn numrddatabytes(&mut self) -> NUMRDDATABYTES_W<FLASHCMDCTRL_SPEC, 20> {
        NUMRDDATABYTES_W::new(self)
    }
    #[doc = "Bit 23 - Read Data Enable"]
    #[inline(always)]
    #[must_use]
    pub fn enbreaddata(&mut self) -> ENBREADDATA_W<FLASHCMDCTRL_SPEC, 23> {
        ENBREADDATA_W::new(self)
    }
    #[doc = "Bits 24:31 - Command Opcode"]
    #[inline(always)]
    #[must_use]
    pub fn cmdopcode(&mut self) -> CMDOPCODE_W<FLASHCMDCTRL_SPEC, 24> {
