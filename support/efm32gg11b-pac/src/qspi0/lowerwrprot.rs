...
pub type R = crate::R<LOWERWRPROT_SPEC>;
#[doc = "Register `LOWERWRPROT` writer"]
pub type W = crate::W<LOWERWRPROT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn subsector(&mut self) -> SUBSECTOR_W<LOWERWRPROT_SPEC, 0> {
...
#[doc = "Lower Write Protection Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lowerwrprot::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lowerwrprot::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
