...
pub type R = crate::R<COMPD_COMP_SPEC>;
#[doc = "Register `COMPD_COMP` writer"]
pub type W = crate::W<COMPD_COMP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp(&mut self) -> COMP_W<COMPD_COMP_SPEC, 0> {
        COMP_W::new(self)
    }
