...
pub type R = crate::R<COMPF_COMP_SPEC>;
#[doc = "Register `COMPF_COMP` writer"]
pub type W = crate::W<COMPF_COMP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp(&mut self) -> COMP_W<COMPF_COMP_SPEC, 0> {
        COMP_W::new(self)
    }
...
#[doc = "Compare Value Register X\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`compf_comp::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`compf_comp::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
