...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dayu(&mut self) -> DAYU_W<CC0_DATE_SPEC> {
        DAYU_W::new(self, 0)
    }
    #[doc = "Bits 4:5 - Day of Month/week, Tens"]
    #[inline(always)]
    #[must_use]
    pub fn dayt(&mut self) -> DAYT_W<CC0_DATE_SPEC> {
        DAYT_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Month, Units"]
    #[inline(always)]
    #[must_use]
    pub fn monthu(&mut self) -> MONTHU_W<CC0_DATE_SPEC> {
        MONTHU_W::new(self, 8)
    }
    #[doc = "Bit 12 - Month, Tens"]
    #[inline(always)]
    #[must_use]
    pub fn montht(&mut self) -> MONTHT_W<CC0_DATE_SPEC> {
