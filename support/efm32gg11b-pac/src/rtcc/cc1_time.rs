...
pub type R = crate::R<Cc1TimeSpec>;
#[doc = "Register `CC1_TIME` writer"]
pub type W = crate::W<Cc1TimeSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Seconds, Units"]
    #[inline(always)]
    pub fn secu(&mut self) -> SecuW<'_, Cc1TimeSpec> {
        SecuW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Seconds, Tens"]
    #[inline(always)]
    pub fn sect(&mut self) -> SectW<'_, Cc1TimeSpec> {
        SectW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Minutes, Units"]
    #[inline(always)]
    pub fn minu(&mut self) -> MinuW<'_, Cc1TimeSpec> {
        MinuW::new(self, 8)
    }
    #[doc = "Bits 12:14 - Minutes, Tens"]
    #[inline(always)]
    pub fn mint(&mut self) -> MintW<'_, Cc1TimeSpec> {
        MintW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Hours, Units"]
    #[inline(always)]
    pub fn houru(&mut self) -> HouruW<'_, Cc1TimeSpec> {
        HouruW::new(self, 16)
    }
    #[doc = "Bits 20:21 - Hours, Tens"]
    #[inline(always)]
    pub fn hourt(&mut self) -> HourtW<'_, Cc1TimeSpec> {
        HourtW::new(self, 20)
    }
}
#[doc = "Capture/Compare Time Register\n\nYou can [`read`](crate::Reg::read) this register and get [`cc1_time::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cc1_time::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cc1TimeSpec;
impl crate::RegisterSpec for Cc1TimeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cc1_time::R`](R) reader structure"]
impl crate::Readable for Cc1TimeSpec {}
#[doc = "`write(|w| ..)` method takes [`cc1_time::W`](W) writer structure"]
impl crate::Writable for Cc1TimeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CC1_TIME to value 0"]
impl crate::Resettable for Cc1TimeSpec {}
