...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn secu(&mut self) -> SECU_W<CC1_TIME_SPEC> {
        SECU_W::new(self, 0)
    }
    #[doc = "Bits 4:6 - Seconds, Tens"]
    #[inline(always)]
    #[must_use]
    pub fn sect(&mut self) -> SECT_W<CC1_TIME_SPEC> {
        SECT_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Minutes, Units"]
    #[inline(always)]
    #[must_use]
    pub fn minu(&mut self) -> MINU_W<CC1_TIME_SPEC> {
        MINU_W::new(self, 8)
    }
    #[doc = "Bits 12:14 - Minutes, Tens"]
    #[inline(always)]
    #[must_use]
    pub fn mint(&mut self) -> MINT_W<CC1_TIME_SPEC> {
        MINT_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Hours, Units"]
    #[inline(always)]
    #[must_use]
    pub fn houru(&mut self) -> HOURU_W<CC1_TIME_SPEC> {
        HOURU_W::new(self, 16)
    }
    #[doc = "Bits 20:21 - Hours, Tens"]
    #[inline(always)]
    #[must_use]
    pub fn hourt(&mut self) -> HOURT_W<CC1_TIME_SPEC> {
        HOURT_W::new(self, 20)
    }
