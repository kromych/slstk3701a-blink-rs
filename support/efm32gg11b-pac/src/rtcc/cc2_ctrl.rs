...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmoa(&mut self) -> CMOA_W<CC2_CTRL_SPEC, 2> {
        CMOA_W::new(self)
    }
    #[doc = "Bits 4:5 - Input Capture Edge Select"]
    #[inline(always)]
    #[must_use]
    pub fn icedge(&mut self) -> ICEDGE_W<CC2_CTRL_SPEC, 4> {
        ICEDGE_W::new(self)
    }
    #[doc = "Bits 6:10 - Compare/Capture Channel PRS Input Channel Selection"]
    #[inline(always)]
    #[must_use]
    pub fn prssel(&mut self) -> PRSSEL_W<CC2_CTRL_SPEC, 6> {
        PRSSEL_W::new(self)
    }
    #[doc = "Bit 11 - Capture Compare Channel Comparison Base"]
    #[inline(always)]
    #[must_use]
    pub fn compbase(&mut self) -> COMPBASE_W<CC2_CTRL_SPEC, 11> {
        COMPBASE_W::new(self)
    }
    #[doc = "Bits 12:16 - Capture Compare Channel Comparison Mask"]
    #[inline(always)]
    #[must_use]
    pub fn compmask(&mut self) -> COMPMASK_W<CC2_CTRL_SPEC, 12> {
        COMPMASK_W::new(self)
    }
    #[doc = "Bit 17 - Day Capture/Compare Selection"]
    #[inline(always)]
    #[must_use]
    pub fn daycc(&mut self) -> DAYCC_W<CC2_CTRL_SPEC, 17> {
        DAYCC_W::new(self)
    }
