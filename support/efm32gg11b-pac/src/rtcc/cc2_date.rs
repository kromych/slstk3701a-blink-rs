...
pub type R = crate::R<CC2_DATE_SPEC>;
#[doc = "Register `CC2_DATE` writer"]
pub type W = crate::W<CC2_DATE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dayu(&mut self) -> DAYU_W<CC2_DATE_SPEC, 0> {
        DAYU_W::new(self)
    }
    #[doc = "Bits 4:5 - Day of Month/week, Tens"]
    #[inline(always)]
    #[must_use]
    pub fn dayt(&mut self) -> DAYT_W<CC2_DATE_SPEC, 4> {
        DAYT_W::new(self)
    }
    #[doc = "Bits 8:11 - Month, Units"]
    #[inline(always)]
    #[must_use]
    pub fn monthu(&mut self) -> MONTHU_W<CC2_DATE_SPEC, 8> {
        MONTHU_W::new(self)
    }
    #[doc = "Bit 12 - Month, Tens"]
    #[inline(always)]
    #[must_use]
    pub fn montht(&mut self) -> MONTHT_W<CC2_DATE_SPEC, 12> {
        MONTHT_W::new(self)
    }
