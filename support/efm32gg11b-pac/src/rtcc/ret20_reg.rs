...
pub type R = crate::R<RET20_REG_SPEC>;
#[doc = "Register `RET20_REG` writer"]
pub type W = crate::W<RET20_REG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg(&mut self) -> REG_W<RET20_REG_SPEC, 0> {
        REG_W::new(self)
    }
...
pub struct RET20_REG_SPEC;
impl crate::RegisterSpec for RET20_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ret20_reg::R`](R) reader structure"]
impl crate::Readable for RET20_REG_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ret20_reg::W`](W) writer structure"]
impl crate::Writable for RET20_REG_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RET20_REG to value 0"]
impl crate::Resettable for RET20_REG_SPEC {
