...
pub type R = crate::R<Ret25RegSpec>;
#[doc = "Register `RET25_REG` writer"]
pub type W = crate::W<Ret25RegSpec>;
...
impl W {
    #[doc = "Bits 0:31 - General Purpose Retention Register"]
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, Ret25RegSpec> {
        RegW::new(self, 0)
    }
}
...
pub struct Ret25RegSpec;
impl crate::RegisterSpec for Ret25RegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ret25_reg::R`](R) reader structure"]
impl crate::Readable for Ret25RegSpec {}
#[doc = "`write(|w| ..)` method takes [`ret25_reg::W`](W) writer structure"]
impl crate::Writable for Ret25RegSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RET25_REG to value 0"]
impl crate::Resettable for Ret25RegSpec {}
