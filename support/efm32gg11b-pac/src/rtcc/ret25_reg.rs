...
pub type R = crate::R<RET25_REG_SPEC>;
#[doc = "Register `RET25_REG` writer"]
pub type W = crate::W<RET25_REG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg(&mut self) -> REG_W<RET25_REG_SPEC, 0> {
        REG_W::new(self)
    }
