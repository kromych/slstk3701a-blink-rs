...
pub type R = crate::R<RET28_REG_SPEC>;
#[doc = "Register `RET28_REG` writer"]
pub type W = crate::W<RET28_REG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg(&mut self) -> REG_W<RET28_REG_SPEC, 0> {
        REG_W::new(self)
    }
...
#[doc = "Retention Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ret28_reg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ret28_reg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RET28_REG_SPEC;
impl crate::RegisterSpec for RET28_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ret28_reg::R`](R) reader structure"]
impl crate::Readable for RET28_REG_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ret28_reg::W`](W) writer structure"]
impl crate::Writable for RET28_REG_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RET28_REG to value 0"]
impl crate::Resettable for RET28_REG_SPEC {
