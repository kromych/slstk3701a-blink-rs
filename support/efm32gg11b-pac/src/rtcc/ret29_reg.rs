...
pub type R = crate::R<Ret29RegSpec>;
#[doc = "Register `RET29_REG` writer"]
pub type W = crate::W<Ret29RegSpec>;
...
impl W {
    #[doc = "Bits 0:31 - General Purpose Retention Register"]
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, Ret29RegSpec> {
        RegW::new(self, 0)
    }
}
...
pub struct Ret29RegSpec;
impl crate::RegisterSpec for Ret29RegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ret29_reg::R`](R) reader structure"]
impl crate::Readable for Ret29RegSpec {}
#[doc = "`write(|w| ..)` method takes [`ret29_reg::W`](W) writer structure"]
impl crate::Writable for Ret29RegSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RET29_REG to value 0"]
impl crate::Resettable for Ret29RegSpec {}
