...
pub type R = crate::R<Ret31RegSpec>;
#[doc = "Register `RET31_REG` writer"]
pub type W = crate::W<Ret31RegSpec>;
...
impl W {
    #[doc = "Bits 0:31 - General Purpose Retention Register"]
    #[inline(always)]
    pub fn reg(&mut self) -> RegW<'_, Ret31RegSpec> {
        RegW::new(self, 0)
    }
}
...
pub struct Ret31RegSpec;
impl crate::RegisterSpec for Ret31RegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ret31_reg::R`](R) reader structure"]
impl crate::Readable for Ret31RegSpec {}
#[doc = "`write(|w| ..)` method takes [`ret31_reg::W`](W) writer structure"]
impl crate::Writable for Ret31RegSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RET31_REG to value 0"]
impl crate::Resettable for Ret31RegSpec {}
