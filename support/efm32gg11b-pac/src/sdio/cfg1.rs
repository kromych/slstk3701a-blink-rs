...
pub type ASYNCINTRSUP_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl SLOTTYPE_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<SLOTTYPE_A> {
        match self.bits {
...
pub type SLOTTYPE_W<'a, REG> = crate::FieldWriter<'a, REG, 2, SLOTTYPE_A>;
impl<'a, REG> SLOTTYPE_W<'a, REG>
where
...
pub type CSDR50SUP_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CDRVASUP_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CDRVCSUP_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type CDRVDSUP_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type ASYNCWKUPEN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn asyncintrsup(&mut self) -> ASYNCINTRSUP_W<CFG1_SPEC> {
        ASYNCINTRSUP_W::new(self, 0)
    }
    #[doc = "Bits 1:2 - Slot Type"]
    #[inline(always)]
    #[must_use]
    pub fn slottype(&mut self) -> SLOTTYPE_W<CFG1_SPEC> {
        SLOTTYPE_W::new(self, 1)
    }
    #[doc = "Bit 3 - Core Support SDR50"]
    #[inline(always)]
    #[must_use]
    pub fn csdr50sup(&mut self) -> CSDR50SUP_W<CFG1_SPEC> {
        CSDR50SUP_W::new(self, 3)
    }
    #[doc = "Bit 4 - Support SDR104"]
    #[inline(always)]
    #[must_use]
    pub fn csdr104sup(&mut self) -> CSDR104SUP_W<CFG1_SPEC> {
        CSDR104SUP_W::new(self, 4)
    }
    #[doc = "Bit 5 - Support DDR50"]
    #[inline(always)]
    #[must_use]
    pub fn cddr50sup(&mut self) -> CDDR50SUP_W<CFG1_SPEC> {
        CDDR50SUP_W::new(self, 5)
    }
    #[doc = "Bit 6 - Support Type a Driver"]
    #[inline(always)]
    #[must_use]
    pub fn cdrvasup(&mut self) -> CDRVASUP_W<CFG1_SPEC> {
        CDRVASUP_W::new(self, 6)
    }
    #[doc = "Bit 7 - Support Type C Driver"]
    #[inline(always)]
    #[must_use]
    pub fn cdrvcsup(&mut self) -> CDRVCSUP_W<CFG1_SPEC> {
        CDRVCSUP_W::new(self, 7)
    }
    #[doc = "Bit 8 - Support Type D Driver"]
    #[inline(always)]
    #[must_use]
    pub fn cdrvdsup(&mut self) -> CDRVDSUP_W<CFG1_SPEC> {
        CDRVDSUP_W::new(self, 8)
    }
    #[doc = "Bits 9:12 - Retuning Timer Control"]
    #[inline(always)]
    #[must_use]
    pub fn retuntmrctl(&mut self) -> RETUNTMRCTL_W<CFG1_SPEC> {
        RETUNTMRCTL_W::new(self, 9)
    }
    #[doc = "Bit 13 - Tuning for SDR50"]
    #[inline(always)]
    #[must_use]
    pub fn tunsdr50(&mut self) -> TUNSDR50_W<CFG1_SPEC> {
        TUNSDR50_W::new(self, 13)
    }
    #[doc = "Bits 14:15 - Retuning Modes"]
    #[inline(always)]
    #[must_use]
    pub fn retunmodes(&mut self) -> RETUNMODES_W<CFG1_SPEC> {
        RETUNMODES_W::new(self, 14)
    }
    #[doc = "Bit 16 - SPI Support"]
    #[inline(always)]
    #[must_use]
    pub fn spisup(&mut self) -> SPISUP_W<CFG1_SPEC> {
        SPISUP_W::new(self, 16)
    }
    #[doc = "Bit 18 - Asynchronous Wakeup Enable"]
    #[inline(always)]
    #[must_use]
    pub fn asyncwkupen(&mut self) -> ASYNCWKUPEN_W<CFG1_SPEC> {
        ASYNCWKUPEN_W::new(self, 18)
    }
