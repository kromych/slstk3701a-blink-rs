...
pub type SDR104SDCLKFREQ_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 10, O, u16>;
...
pub type SDR104CLKGENEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SDR104DRVST_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type DDR50SDCLKFREQ_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 10, O, u16>;
...
pub type DDR50CLKGENEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DDR50DRVST_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdr104sdclkfreq(&mut self) -> SDR104SDCLKFREQ_W<CFGPRESETVAL3_SPEC, 0> {
        SDR104SDCLKFREQ_W::new(self)
    }
    #[doc = "Bit 10 - SDR104 SD_CLK Gen Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sdr104clkgenen(&mut self) -> SDR104CLKGENEN_W<CFGPRESETVAL3_SPEC, 10> {
        SDR104CLKGENEN_W::new(self)
    }
    #[doc = "Bits 11:12 - SDR104 SD Drive Strength"]
    #[inline(always)]
    #[must_use]
    pub fn sdr104drvst(&mut self) -> SDR104DRVST_W<CFGPRESETVAL3_SPEC, 11> {
        SDR104DRVST_W::new(self)
    }
    #[doc = "Bits 16:25 - Preset Value for DDR50 Speed of SD_CLK"]
    #[inline(always)]
    #[must_use]
    pub fn ddr50sdclkfreq(&mut self) -> DDR50SDCLKFREQ_W<CFGPRESETVAL3_SPEC, 16> {
        DDR50SDCLKFREQ_W::new(self)
    }
    #[doc = "Bit 26 - DDR50 Speed Clock Gen Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ddr50clkgenen(&mut self) -> DDR50CLKGENEN_W<CFGPRESETVAL3_SPEC, 26> {
        DDR50CLKGENEN_W::new(self)
    }
    #[doc = "Bits 27:28 - DDR50 Speed Drive Strength"]
    #[inline(always)]
    #[must_use]
    pub fn ddr50drvst(&mut self) -> DDR50DRVST_W<CFGPRESETVAL3_SPEC, 27> {
