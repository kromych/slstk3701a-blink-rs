...
pub type INTCLKEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SDCLKEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CLKGENSEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type UPPSDCLKFRE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type SDCLKFREQSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O, SDCLKFREQSEL_A>;
impl<'a, REG, const O: u8> SDCLKFREQSEL_W<'a, REG, O>
where
...
pub type DATTOUTCNTVAL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type SFTRSTA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SFTRSTCMD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SFTRSTDAT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn intclken(&mut self) -> INTCLKEN_W<CLOCKCTRL_SPEC, 0> {
        INTCLKEN_W::new(self)
    }
    #[doc = "Bit 2 - SDIO_CLK Pin Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sdclken(&mut self) -> SDCLKEN_W<CLOCKCTRL_SPEC, 2> {
        SDCLKEN_W::new(self)
    }
    #[doc = "Bit 5 - Clock Generator Select"]
    #[inline(always)]
    #[must_use]
    pub fn clkgensel(&mut self) -> CLKGENSEL_W<CLOCKCTRL_SPEC, 5> {
        CLKGENSEL_W::new(self)
    }
    #[doc = "Bits 6:7 - Upper Bits of SD_CLK Frequency Select"]
    #[inline(always)]
    #[must_use]
    pub fn uppsdclkfre(&mut self) -> UPPSDCLKFRE_W<CLOCKCTRL_SPEC, 6> {
        UPPSDCLKFRE_W::new(self)
    }
    #[doc = "Bits 8:15 - SD_CLK Frequency Select"]
    #[inline(always)]
    #[must_use]
    pub fn sdclkfreqsel(&mut self) -> SDCLKFREQSEL_W<CLOCKCTRL_SPEC, 8> {
        SDCLKFREQSEL_W::new(self)
    }
    #[doc = "Bits 16:19 - Data Timeout Counter Value"]
    #[inline(always)]
    #[must_use]
    pub fn dattoutcntval(&mut self) -> DATTOUTCNTVAL_W<CLOCKCTRL_SPEC, 16> {
        DATTOUTCNTVAL_W::new(self)
    }
    #[doc = "Bit 24 - Software Reset for All"]
    #[inline(always)]
    #[must_use]
    pub fn sftrsta(&mut self) -> SFTRSTA_W<CLOCKCTRL_SPEC, 24> {
        SFTRSTA_W::new(self)
    }
    #[doc = "Bit 25 - Software Reset for CMD Line"]
    #[inline(always)]
    #[must_use]
    pub fn sftrstcmd(&mut self) -> SFTRSTCMD_W<CLOCKCTRL_SPEC, 25> {
        SFTRSTCMD_W::new(self)
    }
    #[doc = "Bit 26 - Software Reset for DAT Line"]
    #[inline(always)]
    #[must_use]
    pub fn sftrstdat(&mut self) -> SFTRSTDAT_W<CLOCKCTRL_SPEC, 26> {
