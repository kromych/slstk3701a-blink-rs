...
pub type CMDCOMEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TRANCOMEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BLKGAPEVTEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMAINTEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BUFWRRDYEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BUFRDRDYEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CARDINSEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CARDRMEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CARDINTEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RETUNINGEVTEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BOOTACKRCVEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BOOTTERMINATEEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CMDTOUTERREN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CMDCRCERREN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CMDENDBITERREN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CMDINDEXERREN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DATTOUTERREN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DATCRCERREN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DATENDBITERREN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CURRENTLIMITERREN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type AUTOCMDERREN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ADMAERREN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TUNINGERREN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TARGETRESPEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmdcomen(&mut self) -> CMDCOMEN_W<IFENC_SPEC, 0> {
        CMDCOMEN_W::new(self)
    }
    #[doc = "Bit 1 - Transfer Complete Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn trancomen(&mut self) -> TRANCOMEN_W<IFENC_SPEC, 1> {
        TRANCOMEN_W::new(self)
    }
    #[doc = "Bit 2 - Block Gap Event Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn blkgapevten(&mut self) -> BLKGAPEVTEN_W<IFENC_SPEC, 2> {
        BLKGAPEVTEN_W::new(self)
    }
    #[doc = "Bit 3 - DMA Interrupt Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmainten(&mut self) -> DMAINTEN_W<IFENC_SPEC, 3> {
        DMAINTEN_W::new(self)
    }
    #[doc = "Bit 4 - Buffer Write Ready Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bufwrrdyen(&mut self) -> BUFWRRDYEN_W<IFENC_SPEC, 4> {
        BUFWRRDYEN_W::new(self)
    }
    #[doc = "Bit 5 - Buffer Read Ready Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bufrdrdyen(&mut self) -> BUFRDRDYEN_W<IFENC_SPEC, 5> {
        BUFRDRDYEN_W::new(self)
    }
    #[doc = "Bit 6 - Card Insertion Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cardinsen(&mut self) -> CARDINSEN_W<IFENC_SPEC, 6> {
        CARDINSEN_W::new(self)
    }
    #[doc = "Bit 7 - Card Removal Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cardrmen(&mut self) -> CARDRMEN_W<IFENC_SPEC, 7> {
        CARDRMEN_W::new(self)
    }
    #[doc = "Bit 8 - Card Interrupt Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cardinten(&mut self) -> CARDINTEN_W<IFENC_SPEC, 8> {
        CARDINTEN_W::new(self)
    }
    #[doc = "Bit 12 - Re-Tunning Event Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn retuningevten(&mut self) -> RETUNINGEVTEN_W<IFENC_SPEC, 12> {
        RETUNINGEVTEN_W::new(self)
    }
    #[doc = "Bit 13 - Boot Ack Received Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bootackrcven(&mut self) -> BOOTACKRCVEN_W<IFENC_SPEC, 13> {
        BOOTACKRCVEN_W::new(self)
    }
    #[doc = "Bit 14 - Boot Terminate Interrupt Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn bootterminateen(&mut self) -> BOOTTERMINATEEN_W<IFENC_SPEC, 14> {
        BOOTTERMINATEEN_W::new(self)
    }
    #[doc = "Bit 16 - Command Time-out Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmdtouterren(&mut self) -> CMDTOUTERREN_W<IFENC_SPEC, 16> {
        CMDTOUTERREN_W::new(self)
    }
    #[doc = "Bit 17 - Command CRC Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmdcrcerren(&mut self) -> CMDCRCERREN_W<IFENC_SPEC, 17> {
        CMDCRCERREN_W::new(self)
    }
    #[doc = "Bit 18 - Command End Bit Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmdendbiterren(&mut self) -> CMDENDBITERREN_W<IFENC_SPEC, 18> {
        CMDENDBITERREN_W::new(self)
    }
    #[doc = "Bit 19 - Command Index Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmdindexerren(&mut self) -> CMDINDEXERREN_W<IFENC_SPEC, 19> {
        CMDINDEXERREN_W::new(self)
    }
    #[doc = "Bit 20 - Data Timeout Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dattouterren(&mut self) -> DATTOUTERREN_W<IFENC_SPEC, 20> {
        DATTOUTERREN_W::new(self)
    }
    #[doc = "Bit 21 - Data CRC Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn datcrcerren(&mut self) -> DATCRCERREN_W<IFENC_SPEC, 21> {
        DATCRCERREN_W::new(self)
    }
    #[doc = "Bit 22 - Data End Bit Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn datendbiterren(&mut self) -> DATENDBITERREN_W<IFENC_SPEC, 22> {
        DATENDBITERREN_W::new(self)
    }
    #[doc = "Bit 23 - Current Limit Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn currentlimiterren(&mut self) -> CURRENTLIMITERREN_W<IFENC_SPEC, 23> {
        CURRENTLIMITERREN_W::new(self)
    }
    #[doc = "Bit 24 - Auto CMD12 Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn autocmderren(&mut self) -> AUTOCMDERREN_W<IFENC_SPEC, 24> {
        AUTOCMDERREN_W::new(self)
    }
    #[doc = "Bit 25 - ADMA Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn admaerren(&mut self) -> ADMAERREN_W<IFENC_SPEC, 25> {
        ADMAERREN_W::new(self)
    }
    #[doc = "Bit 26 - Tuning Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tuningerren(&mut self) -> TUNINGERREN_W<IFENC_SPEC, 26> {
        TUNINGERREN_W::new(self)
    }
    #[doc = "Bit 28 - Target Response/Host Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn targetrespen(&mut self) -> TARGETRESPEN_W<IFENC_SPEC, 28> {
