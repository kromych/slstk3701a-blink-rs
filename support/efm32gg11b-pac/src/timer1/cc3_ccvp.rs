...
pub type R = crate::R<Cc3CcvpSpec>;
...
pub struct Cc3CcvpSpec;
impl crate::RegisterSpec for Cc3CcvpSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cc3_ccvp::R`](R) reader structure"]
impl crate::Readable for Cc3CcvpSpec {}
#[doc = "`reset()` method sets CC3_CCVP to value 0"]
impl crate::Resettable for Cc3CcvpSpec {}
