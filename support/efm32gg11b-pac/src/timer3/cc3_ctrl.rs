...
pub type R = crate::R<CC3_CTRL_SPEC>;
#[doc = "Register `CC3_CTRL` writer"]
pub type W = crate::W<CC3_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> MODE_W<CC3_CTRL_SPEC, 0> {
        MODE_W::new(self)
    }
    #[doc = "Bit 2 - Output Invert"]
    #[inline(always)]
    #[must_use]
    pub fn outinv(&mut self) -> OUTINV_W<CC3_CTRL_SPEC, 2> {
        OUTINV_W::new(self)
    }
    #[doc = "Bit 4 - Compare Output Initial State"]
    #[inline(always)]
    #[must_use]
    pub fn coist(&mut self) -> COIST_W<CC3_CTRL_SPEC, 4> {
        COIST_W::new(self)
    }
    #[doc = "Bits 8:9 - Compare Match Output Action"]
    #[inline(always)]
    #[must_use]
    pub fn cmoa(&mut self) -> CMOA_W<CC3_CTRL_SPEC, 8> {
        CMOA_W::new(self)
    }
    #[doc = "Bits 10:11 - Counter Overflow Output Action"]
    #[inline(always)]
    #[must_use]
    pub fn cofoa(&mut self) -> COFOA_W<CC3_CTRL_SPEC, 10> {
        COFOA_W::new(self)
    }
    #[doc = "Bits 12:13 - Counter Underflow Output Action"]
    #[inline(always)]
    #[must_use]
    pub fn cufoa(&mut self) -> CUFOA_W<CC3_CTRL_SPEC, 12> {
        CUFOA_W::new(self)
    }
    #[doc = "Bits 16:20 - Compare/Capture Channel PRS Input Channel Selection"]
    #[inline(always)]
    #[must_use]
    pub fn prssel(&mut self) -> PRSSEL_W<CC3_CTRL_SPEC, 16> {
        PRSSEL_W::new(self)
    }
    #[doc = "Bits 24:25 - Input Capture Edge Select"]
    #[inline(always)]
    #[must_use]
    pub fn icedge(&mut self) -> ICEDGE_W<CC3_CTRL_SPEC, 24> {
        ICEDGE_W::new(self)
    }
    #[doc = "Bits 26:27 - Input Capture Event Control"]
    #[inline(always)]
    #[must_use]
    pub fn icevctrl(&mut self) -> ICEVCTRL_W<CC3_CTRL_SPEC, 26> {
        ICEVCTRL_W::new(self)
    }
    #[doc = "Bit 28 - PRS Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn prsconf(&mut self) -> PRSCONF_W<CC3_CTRL_SPEC, 28> {
        PRSCONF_W::new(self)
    }
    #[doc = "Bit 29 - Input Selection"]
    #[inline(always)]
    #[must_use]
    pub fn insel(&mut self) -> INSEL_W<CC3_CTRL_SPEC, 29> {
        INSEL_W::new(self)
    }
    #[doc = "Bit 30 - Digital Filter"]
    #[inline(always)]
    #[must_use]
    pub fn filt(&mut self) -> FILT_W<CC3_CTRL_SPEC, 30> {
        FILT_W::new(self)
    }
