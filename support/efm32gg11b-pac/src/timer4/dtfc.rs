...
pub type DTPRS0FSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O, DTPRS0FSEL_A>;
...
pub type DTPRS1FSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O, DTPRS1FSEL_A>;
