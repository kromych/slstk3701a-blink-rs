...
impl R {
    ...
    pub fn dissyncout(&self) -> DissyncoutR {
        DissyncoutR::new(((self.bits >> 14) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 14 - Disable Timer From Start/Stop/Reload Other Synchronized Timers"]
    #[inline(always)]
    pub fn dissyncout(&mut self) -> DissyncoutW<'_, CtrlSpec> {
        DissyncoutW::new(self, 14)
    }
    #[doc = "Bits 16:17 - Clock Source Select"]
    #[inline(always)]
