...
pub type R = crate::R<Cc1CcvSpec>;
#[doc = "Register `CC1_CCV` writer"]
pub type W = crate::W<Cc1CcvSpec>;
...
impl W {
    #[doc = "Bits 0:31 - CC Channel Value"]
    #[inline(always)]
    pub fn ccv(&mut self) -> CcvW<'_, Cc1CcvSpec> {
        CcvW::new(self, 0)
    }
}
...
pub struct Cc1CcvSpec;
impl crate::RegisterSpec for Cc1CcvSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cc1_ccv::R`](R) reader structure"]
impl crate::Readable for Cc1CcvSpec {}
#[doc = "`write(|w| ..)` method takes [`cc1_ccv::W`](W) writer structure"]
impl crate::Writable for Cc1CcvSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CC1_CCV to value 0"]
impl crate::Resettable for Cc1CcvSpec {}
