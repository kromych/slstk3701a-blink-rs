...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc0pen(&mut self) -> CC0PEN_W<ROUTEPEN_SPEC> {
        CC0PEN_W::new(self, 0)
    }
    #[doc = "Bit 1 - CC Channel 1 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cc1pen(&mut self) -> CC1PEN_W<ROUTEPEN_SPEC> {
        CC1PEN_W::new(self, 1)
    }
    #[doc = "Bit 2 - CC Channel 2 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cc2pen(&mut self) -> CC2PEN_W<ROUTEPEN_SPEC> {
        CC2PEN_W::new(self, 2)
    }
    #[doc = "Bit 3 - CC Channel 3 Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cc3pen(&mut self) -> CC3PEN_W<ROUTEPEN_SPEC> {
        CC3PEN_W::new(self, 3)
    }
    #[doc = "Bit 8 - CC Channel 0 Complementary Dead-Time Insertion Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cdti0pen(&mut self) -> CDTI0PEN_W<ROUTEPEN_SPEC> {
        CDTI0PEN_W::new(self, 8)
    }
    #[doc = "Bit 9 - CC Channel 1 Complementary Dead-Time Insertion Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cdti1pen(&mut self) -> CDTI1PEN_W<ROUTEPEN_SPEC> {
        CDTI1PEN_W::new(self, 9)
    }
    #[doc = "Bit 10 - CC Channel 2 Complementary Dead-Time Insertion Pin Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cdti2pen(&mut self) -> CDTI2PEN_W<ROUTEPEN_SPEC> {
