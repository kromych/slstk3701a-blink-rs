...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbghalt(&mut self) -> DBGHALT_W<CTRLX_SPEC> {
        DBGHALT_W::new(self, 0)
    }
    #[doc = "Bit 1 - CTS Pin Inversion"]
    #[inline(always)]
    #[must_use]
    pub fn ctsinv(&mut self) -> CTSINV_W<CTRLX_SPEC> {
        CTSINV_W::new(self, 1)
    }
    #[doc = "Bit 2 - CTS Function Enabled"]
    #[inline(always)]
    #[must_use]
    pub fn ctsen(&mut self) -> CTSEN_W<CTRLX_SPEC> {
        CTSEN_W::new(self, 2)
    }
    #[doc = "Bit 3 - RTS Pin Inversion"]
    #[inline(always)]
    #[must_use]
    pub fn rtsinv(&mut self) -> RTSINV_W<CTRLX_SPEC> {
        RTSINV_W::new(self, 3)
    }
