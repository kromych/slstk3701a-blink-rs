...
impl CLKPRSSEL_R {
    ...
    pub const fn variant(&self) -> Option<CLKPRSSEL_A> {
        match self.bits {
            ...
            12 => Some(CLKPRSSEL_A::PRSCH12),
            13 => Some(CLKPRSSEL_A::PRSCH13),
            14 => Some(CLKPRSSEL_A::PRSCH14),
            15 => Some(CLKPRSSEL_A::PRSCH15),
            16 => Some(CLKPRSSEL_A::PRSCH16),
            17 => Some(CLKPRSSEL_A::PRSCH17),
            18 => Some(CLKPRSSEL_A::PRSCH18),
            19 => Some(CLKPRSSEL_A::PRSCH19),
            20 => Some(CLKPRSSEL_A::PRSCH20),
            21 => Some(CLKPRSSEL_A::PRSCH21),
            22 => Some(CLKPRSSEL_A::PRSCH22),
            23 => Some(CLKPRSSEL_A::PRSCH23),
            _ => None,
        }
    }
    #[doc = "PRS Channel 0 selected"]
    ...
    #[inline(always)]
    pub fn is_prsch16(&self) -> bool {
        *self == CLKPRSSEL_A::PRSCH16
    }
    #[doc = "PRS Channel 17 selected"]
    #[inline(always)]
    pub fn is_prsch17(&self) -> bool {
        *self == CLKPRSSEL_A::PRSCH17
    }
    #[doc = "PRS Channel 18 selected"]
    #[inline(always)]
    pub fn is_prsch18(&self) -> bool {
        *self == CLKPRSSEL_A::PRSCH18
    }
    #[doc = "PRS Channel 19 selected"]
    #[inline(always)]
    pub fn is_prsch19(&self) -> bool {
        *self == CLKPRSSEL_A::PRSCH19
    }
    #[doc = "PRS Channel 20 selected"]
    #[inline(always)]
    pub fn is_prsch20(&self) -> bool {
        *self == CLKPRSSEL_A::PRSCH20
    }
    #[doc = "PRS Channel 21 selected"]
    #[inline(always)]
    pub fn is_prsch21(&self) -> bool {
        *self == CLKPRSSEL_A::PRSCH21
    }
    #[doc = "PRS Channel 22 selected"]
    #[inline(always)]
    pub fn is_prsch22(&self) -> bool {
        *self == CLKPRSSEL_A::PRSCH22
    }
    #[doc = "PRS Channel 23 selected"]
    #[inline(always)]
    pub fn is_prsch23(&self) -> bool {
        *self == CLKPRSSEL_A::PRSCH23
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn prsch16(self) -> &'a mut crate::W<REG> {
        self.variant(CLKPRSSEL_A::PRSCH16)
    }
    #[doc = "PRS Channel 17 selected"]
    #[inline(always)]
    pub fn prsch17(self) -> &'a mut crate::W<REG> {
        self.variant(CLKPRSSEL_A::PRSCH17)
    }
    #[doc = "PRS Channel 18 selected"]
    #[inline(always)]
    pub fn prsch18(self) -> &'a mut crate::W<REG> {
        self.variant(CLKPRSSEL_A::PRSCH18)
    }
    #[doc = "PRS Channel 19 selected"]
    #[inline(always)]
    pub fn prsch19(self) -> &'a mut crate::W<REG> {
        self.variant(CLKPRSSEL_A::PRSCH19)
    }
    #[doc = "PRS Channel 20 selected"]
    #[inline(always)]
    pub fn prsch20(self) -> &'a mut crate::W<REG> {
        self.variant(CLKPRSSEL_A::PRSCH20)
    }
    #[doc = "PRS Channel 21 selected"]
    #[inline(always)]
    pub fn prsch21(self) -> &'a mut crate::W<REG> {
        self.variant(CLKPRSSEL_A::PRSCH21)
    }
    #[doc = "PRS Channel 22 selected"]
    #[inline(always)]
    pub fn prsch22(self) -> &'a mut crate::W<REG> {
        self.variant(CLKPRSSEL_A::PRSCH22)
    }
    #[doc = "PRS Channel 23 selected"]
    #[inline(always)]
    pub fn prsch23(self) -> &'a mut crate::W<REG> {
        self.variant(CLKPRSSEL_A::PRSCH23)
    }
}
...
impl R {
    ...
    pub fn clkprssel(&self) -> CLKPRSSEL_R {
        CLKPRSSEL_R::new(((self.bits >> 8) & 0x1f) as u8)
    }
