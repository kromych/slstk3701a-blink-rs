...
pub type ROUT_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
pub type ENDLYPULLUP_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DLYPULLUPFS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type VCRSFS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type TFDMFS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type TRDMFS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type TFDPFS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type TRDPFS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rout(&mut self) -> ROUT_W<DATTRIM1_SPEC> {
        ROUT_W::new(self, 0)
    }
    #[doc = "Bit 7 - Enables Delay of Pull in TX Mode for Both FS and LS"]
    #[inline(always)]
    #[must_use]
    pub fn endlypullup(&mut self) -> ENDLYPULLUP_W<DATTRIM1_SPEC> {
        ENDLYPULLUP_W::new(self, 7)
    }
    #[doc = "Bits 8:9 - Trim for Rising Crossover Voltage in FS"]
    #[inline(always)]
    #[must_use]
    pub fn dlypullupfs(&mut self) -> DLYPULLUPFS_W<DATTRIM1_SPEC> {
        DLYPULLUPFS_W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Trim for Falling Crossover Voltage in FS"]
    #[inline(always)]
    #[must_use]
    pub fn vcrsfs(&mut self) -> VCRSFS_W<DATTRIM1_SPEC> {
        VCRSFS_W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Trim for DM Fall Time in FS"]
    #[inline(always)]
    #[must_use]
    pub fn tfdmfs(&mut self) -> TFDMFS_W<DATTRIM1_SPEC> {
        TFDMFS_W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Trim for DM Rise Time in FS"]
    #[inline(always)]
    #[must_use]
    pub fn trdmfs(&mut self) -> TRDMFS_W<DATTRIM1_SPEC> {
        TRDMFS_W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Trim for DP Fall Time in FS"]
    #[inline(always)]
    #[must_use]
    pub fn tfdpfs(&mut self) -> TFDPFS_W<DATTRIM1_SPEC> {
        TFDPFS_W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Trim for DP Rise Time in FS"]
    #[inline(always)]
    #[must_use]
    pub fn trdpfs(&mut self) -> TRDPFS_W<DATTRIM1_SPEC> {
        TRDPFS_W::new(self, 18)
    }
