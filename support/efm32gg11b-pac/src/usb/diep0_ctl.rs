...
impl W {
    ...
    #[doc = "Bit 15 - USB Active Endpoint"]
    #[inline(always)]
    pub fn usbactep(&mut self) -> UsbactepW<'_, Diep0CtlSpec> {
        UsbactepW::new(self, 15)
    }
    #[doc = "Bits 18:19 - Endpoint Type"]
    #[inline(always)]
    pub fn eptype(&mut self) -> EptypeW<'_, Diep0CtlSpec> {
        EptypeW::new(self, 18)
    }
    #[doc = "Bit 21 - Handshake"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn setd0pidef(&mut self) -> Setd0pidefW<'_, Diep0CtlSpec> {
        Setd0pidefW::new(self, 28)
    }
    #[doc = "Bit 29 - Set DATA1 PID / Odd Frame"]
    #[inline(always)]
    pub fn setd1pidof(&mut self) -> Setd1pidofW<'_, Diep0CtlSpec> {
...
#[doc = "Device Control IN Endpoint x+1 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`diep0_ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`diep0_ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
