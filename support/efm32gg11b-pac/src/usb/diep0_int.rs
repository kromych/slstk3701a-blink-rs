...
impl W {
    ...
    #[doc = "Bit 5 - IN Token Received with EP Mismatch"]
    #[inline(always)]
    pub fn intknepmis(&mut self) -> IntknepmisW<'_, Diep0IntSpec> {
    ...
    #[doc = "Bit 8 - Fifo Underrun"]
    #[inline(always)]
    pub fn txfifoundrn(&mut self) -> TxfifoundrnW<'_, Diep0IntSpec> {
...
#[doc = "Device IN Endpoint x+1 Interrupt Register\n\nYou can [`read`](crate::Reg::read) this register and get [`diep0_int::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`diep0_int::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
