...
pub type R = crate::R<Diep2DtxfstsSpec>;
...
#[doc = "Device IN Endpoint Transmit FIFO Status Register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`diep2_dtxfsts::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Diep2DtxfstsSpec;
impl crate::RegisterSpec for Diep2DtxfstsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep2_dtxfsts::R`](R) reader structure"]
impl crate::Readable for Diep2DtxfstsSpec {}
#[doc = "`reset()` method sets DIEP2_DTXFSTS to value 0x0200"]
impl crate::Resettable for Diep2DtxfstsSpec {
