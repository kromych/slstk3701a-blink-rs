...
pub type R = crate::R<Diep3DtxfstsSpec>;
...
#[doc = "Device IN Endpoint Transmit FIFO Status Register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`diep3_dtxfsts::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Diep3DtxfstsSpec;
impl crate::RegisterSpec for Diep3DtxfstsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep3_dtxfsts::R`](R) reader structure"]
impl crate::Readable for Diep3DtxfstsSpec {}
#[doc = "`reset()` method sets DIEP3_DTXFSTS to value 0x0200"]
impl crate::Resettable for Diep3DtxfstsSpec {
