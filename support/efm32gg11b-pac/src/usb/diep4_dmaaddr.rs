...
pub type R = crate::R<DIEP4_DMAADDR_SPEC>;
#[doc = "Register `DIEP4_DMAADDR` writer"]
pub type W = crate::W<DIEP4_DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<DIEP4_DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
#[doc = "Device IN Endpoint x+1 DMA Address Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`diep4_dmaaddr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`diep4_dmaaddr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
