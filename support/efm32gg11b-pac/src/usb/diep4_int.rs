...
pub type R = crate::R<Diep4IntSpec>;
#[doc = "Register `DIEP4_INT` writer"]
pub type W = crate::W<Diep4IntSpec>;
...
impl W {
    #[doc = "Bit 0 - Transfer Completed Interrupt"]
    #[inline(always)]
    pub fn xfercompl(&mut self) -> XfercomplW<'_, Diep4IntSpec> {
        XfercomplW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint Disabled Interrupt"]
    #[inline(always)]
    pub fn epdisbld(&mut self) -> EpdisbldW<'_, Diep4IntSpec> {
        EpdisbldW::new(self, 1)
    }
    #[doc = "Bit 2 - AHB Error"]
    #[inline(always)]
    pub fn ahberr(&mut self) -> AhberrW<'_, Diep4IntSpec> {
        AhberrW::new(self, 2)
    }
    #[doc = "Bit 3 - Timeout Condition"]
    #[inline(always)]
    pub fn timeout(&mut self) -> TimeoutW<'_, Diep4IntSpec> {
        TimeoutW::new(self, 3)
    }
    #[doc = "Bit 4 - IN Token Received When TxFIFO is Empty"]
    #[inline(always)]
    pub fn intkntxfemp(&mut self) -> IntkntxfempW<'_, Diep4IntSpec> {
        IntkntxfempW::new(self, 4)
    }
    #[doc = "Bit 5 - IN Token Received with EP Mismatch"]
    #[inline(always)]
    pub fn intknepmis(&mut self) -> IntknepmisW<'_, Diep4IntSpec> {
        IntknepmisW::new(self, 5)
    }
    #[doc = "Bit 6 - IN Endpoint NAK Effective"]
    #[inline(always)]
    pub fn inepnakeff(&mut self) -> InepnakeffW<'_, Diep4IntSpec> {
        InepnakeffW::new(self, 6)
    }
    #[doc = "Bit 8 - Fifo Underrun"]
    #[inline(always)]
    pub fn txfifoundrn(&mut self) -> TxfifoundrnW<'_, Diep4IntSpec> {
        TxfifoundrnW::new(self, 8)
    }
    #[doc = "Bit 11 - Packet Drop Status"]
    #[inline(always)]
    pub fn pktdrpsts(&mut self) -> PktdrpstsW<'_, Diep4IntSpec> {
        PktdrpstsW::new(self, 11)
    }
    #[doc = "Bit 12 - Babble Interrupt"]
    #[inline(always)]
    pub fn bbleerr(&mut self) -> BbleerrW<'_, Diep4IntSpec> {
        BbleerrW::new(self, 12)
    }
    #[doc = "Bit 13 - NAK Interrupt"]
    #[inline(always)]
    pub fn nakintrpt(&mut self) -> NakintrptW<'_, Diep4IntSpec> {
        NakintrptW::new(self, 13)
    }
}
#[doc = "Device IN Endpoint x+1 Interrupt Register\n\nYou can [`read`](crate::Reg::read) this register and get [`diep4_int::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`diep4_int::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Diep4IntSpec;
impl crate::RegisterSpec for Diep4IntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep4_int::R`](R) reader structure"]
impl crate::Readable for Diep4IntSpec {}
#[doc = "`write(|w| ..)` method takes [`diep4_int::W`](W) writer structure"]
impl crate::Writable for Diep4IntSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DIEP4_INT to value 0x80"]
impl crate::Resettable for Diep4IntSpec {
