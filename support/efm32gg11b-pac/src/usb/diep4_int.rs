#[doc = "Register `DIEP4_INT` reader"]
pub type R = crate::R<DIEP4_INT_SPEC>;
#[doc = "Register `DIEP4_INT` writer"]
pub type W = crate::W<DIEP4_INT_SPEC>;
...
pub type INTKNEPMIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfercompl(&mut self) -> XFERCOMPL_W<DIEP4_INT_SPEC, 0> {
        XFERCOMPL_W::new(self)
    }
    #[doc = "Bit 1 - Endpoint Disabled Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn epdisbld(&mut self) -> EPDISBLD_W<DIEP4_INT_SPEC, 1> {
        EPDISBLD_W::new(self)
    }
    #[doc = "Bit 2 - AHB Error"]
    #[inline(always)]
    #[must_use]
    pub fn ahberr(&mut self) -> AHBERR_W<DIEP4_INT_SPEC, 2> {
        AHBERR_W::new(self)
    }
    #[doc = "Bit 3 - Timeout Condition"]
    #[inline(always)]
    #[must_use]
    pub fn timeout(&mut self) -> TIMEOUT_W<DIEP4_INT_SPEC, 3> {
        TIMEOUT_W::new(self)
    }
    #[doc = "Bit 4 - IN Token Received When TxFIFO is Empty"]
    #[inline(always)]
    #[must_use]
    pub fn intkntxfemp(&mut self) -> INTKNTXFEMP_W<DIEP4_INT_SPEC, 4> {
        INTKNTXFEMP_W::new(self)
    }
    #[doc = "Bit 5 - IN Token Received with EP Mismatch"]
    #[inline(always)]
    #[must_use]
    pub fn intknepmis(&mut self) -> INTKNEPMIS_W<DIEP4_INT_SPEC, 5> {
        INTKNEPMIS_W::new(self)
    }
    #[doc = "Bit 6 - IN Endpoint NAK Effective"]
    #[inline(always)]
    #[must_use]
    pub fn inepnakeff(&mut self) -> INEPNAKEFF_W<DIEP4_INT_SPEC, 6> {
        INEPNAKEFF_W::new(self)
    }
    #[doc = "Bit 8 - Fifo Underrun"]
    #[inline(always)]
    #[must_use]
    pub fn txfifoundrn(&mut self) -> TXFIFOUNDRN_W<DIEP4_INT_SPEC, 8> {
        TXFIFOUNDRN_W::new(self)
    }
    #[doc = "Bit 11 - Packet Drop Status"]
    #[inline(always)]
    #[must_use]
    pub fn pktdrpsts(&mut self) -> PKTDRPSTS_W<DIEP4_INT_SPEC, 11> {
        PKTDRPSTS_W::new(self)
    }
    #[doc = "Bit 12 - Babble Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn bbleerr(&mut self) -> BBLEERR_W<DIEP4_INT_SPEC, 12> {
        BBLEERR_W::new(self)
    }
    #[doc = "Bit 13 - NAK Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn nakintrpt(&mut self) -> NAKINTRPT_W<DIEP4_INT_SPEC, 13> {
...
#[doc = "Device IN Endpoint x+1 Interrupt Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`diep4_int::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`diep4_int::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DIEP4_INT_SPEC;
impl crate::RegisterSpec for DIEP4_INT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep4_int::R`](R) reader structure"]
impl crate::Readable for DIEP4_INT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`diep4_int::W`](W) writer structure"]
impl crate::Writable for DIEP4_INT_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DIEP4_INT to value 0x80"]
impl crate::Resettable for DIEP4_INT_SPEC {
