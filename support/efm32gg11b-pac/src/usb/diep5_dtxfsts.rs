...
pub type R = crate::R<Diep5DtxfstsSpec>;
...
#[doc = "Device IN Endpoint Transmit FIFO Status Register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`diep5_dtxfsts::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Diep5DtxfstsSpec;
impl crate::RegisterSpec for Diep5DtxfstsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep5_dtxfsts::R`](R) reader structure"]
impl crate::Readable for Diep5DtxfstsSpec {}
#[doc = "`reset()` method sets DIEP5_DTXFSTS to value 0x0200"]
impl crate::Resettable for Diep5DtxfstsSpec {
