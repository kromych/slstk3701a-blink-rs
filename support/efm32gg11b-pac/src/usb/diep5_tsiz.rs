...
pub type R = crate::R<Diep5TsizSpec>;
#[doc = "Register `DIEP5_TSIZ` writer"]
pub type W = crate::W<Diep5TsizSpec>;
...
impl W {
    #[doc = "Bits 0:18 - Transfer Size"]
    #[inline(always)]
    pub fn xfersize(&mut self) -> XfersizeW<'_, Diep5TsizSpec> {
        XfersizeW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet Count"]
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PktcntW<'_, Diep5TsizSpec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - Multi Count"]
    #[inline(always)]
    pub fn mc(&mut self) -> McW<'_, Diep5TsizSpec> {
        McW::new(self, 29)
    }
}
#[doc = "Device IN Endpoint x+1 Transfer Size Register\n\nYou can [`read`](crate::Reg::read) this register and get [`diep5_tsiz::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`diep5_tsiz::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Diep5TsizSpec;
impl crate::RegisterSpec for Diep5TsizSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep5_tsiz::R`](R) reader structure"]
impl crate::Readable for Diep5TsizSpec {}
#[doc = "`write(|w| ..)` method takes [`diep5_tsiz::W`](W) writer structure"]
impl crate::Writable for Diep5TsizSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DIEP5_TSIZ to value 0"]
impl crate::Resettable for Diep5TsizSpec {}
