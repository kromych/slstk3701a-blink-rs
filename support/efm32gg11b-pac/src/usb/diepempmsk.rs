...
pub type INEPTXFEMPMSK_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ineptxfempmsk(&mut self) -> INEPTXFEMPMSK_W<DIEPEMPMSK_SPEC, 0> {
        INEPTXFEMPMSK_W::new(self)
    }
