...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn dmaaddr(&mut self) -> DmaaddrW<'_, Doep1DmaaddrSpec> {
        DmaaddrW::new(self, 0)
    }
}
#[doc = "Device OUT Endpoint x+1 DMA Address Register\n\nYou can [`read`](crate::Reg::read) this register and get [`doep1_dmaaddr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`doep1_dmaaddr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
