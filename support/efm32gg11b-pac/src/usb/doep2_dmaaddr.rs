...
pub type R = crate::R<DOEP2_DMAADDR_SPEC>;
#[doc = "Register `DOEP2_DMAADDR` writer"]
pub type W = crate::W<DOEP2_DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<DOEP2_DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
