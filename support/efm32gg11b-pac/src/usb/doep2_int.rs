...
pub type R = crate::R<Doep2IntSpec>;
#[doc = "Register `DOEP2_INT` writer"]
pub type W = crate::W<Doep2IntSpec>;
...
impl W {
    #[doc = "Bit 0 - Transfer Completed Interrupt"]
    #[inline(always)]
    pub fn xfercompl(&mut self) -> XfercomplW<'_, Doep2IntSpec> {
        XfercomplW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint Disabled Interrupt"]
    #[inline(always)]
    pub fn epdisbld(&mut self) -> EpdisbldW<'_, Doep2IntSpec> {
        EpdisbldW::new(self, 1)
    }
    #[doc = "Bit 2 - AHB Error"]
    #[inline(always)]
    pub fn ahberr(&mut self) -> AhberrW<'_, Doep2IntSpec> {
        AhberrW::new(self, 2)
    }
    #[doc = "Bit 3 - Setup Phase Done"]
    #[inline(always)]
    pub fn setup(&mut self) -> SetupW<'_, Doep2IntSpec> {
        SetupW::new(self, 3)
    }
    #[doc = "Bit 4 - OUT Token Received When Endpoint Disabled"]
    #[inline(always)]
    pub fn outtknepdis(&mut self) -> OuttknepdisW<'_, Doep2IntSpec> {
        OuttknepdisW::new(self, 4)
    }
    #[doc = "Bit 5 - Status Phase Received For Control Write"]
    #[inline(always)]
    pub fn stsphsercvd(&mut self) -> StsphsercvdW<'_, Doep2IntSpec> {
        StsphsercvdW::new(self, 5)
    }
    #[doc = "Bit 6 - Back-to-Back SETUP Packets Received"]
    #[inline(always)]
    pub fn back2backsetup(&mut self) -> Back2backsetupW<'_, Doep2IntSpec> {
        Back2backsetupW::new(self, 6)
    }
    #[doc = "Bit 8 - OUT Packet Error"]
    #[inline(always)]
    pub fn outpkterr(&mut self) -> OutpkterrW<'_, Doep2IntSpec> {
        OutpkterrW::new(self, 8)
    }
    #[doc = "Bit 11 - Packet Drop Status"]
    #[inline(always)]
    pub fn pktdrpsts(&mut self) -> PktdrpstsW<'_, Doep2IntSpec> {
        PktdrpstsW::new(self, 11)
    }
    #[doc = "Bit 12 - Babble Error"]
    #[inline(always)]
    pub fn bbleerr(&mut self) -> BbleerrW<'_, Doep2IntSpec> {
        BbleerrW::new(self, 12)
    }
    #[doc = "Bit 13 - NAK Interrupt"]
    #[inline(always)]
    pub fn nakintrpt(&mut self) -> NakintrptW<'_, Doep2IntSpec> {
        NakintrptW::new(self, 13)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn stuppktrcvd(&mut self) -> StuppktrcvdW<'_, Doep2IntSpec> {
        StuppktrcvdW::new(self, 15)
    }
}
#[doc = "Device OUT Endpoint x+1 Interrupt Register\n\nYou can [`read`](crate::Reg::read) this register and get [`doep2_int::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`doep2_int::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Doep2IntSpec;
impl crate::RegisterSpec for Doep2IntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep2_int::R`](R) reader structure"]
impl crate::Readable for Doep2IntSpec {}
#[doc = "`write(|w| ..)` method takes [`doep2_int::W`](W) writer structure"]
impl crate::Writable for Doep2IntSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DOEP2_INT to value 0"]
impl crate::Resettable for Doep2IntSpec {}
