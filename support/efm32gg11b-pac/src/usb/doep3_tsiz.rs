#[doc = "Register `DOEP3_TSIZ` reader"]
pub type R = crate::R<Doep3TsizSpec>;
#[doc = "Register `DOEP3_TSIZ` writer"]
pub type W = crate::W<Doep3TsizSpec>;
...
impl W {
    #[doc = "Bits 0:18 - Transfer Size"]
    #[inline(always)]
    pub fn xfersize(&mut self) -> XfersizeW<'_, Doep3TsizSpec> {
        XfersizeW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet Count"]
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PktcntW<'_, Doep3TsizSpec> {
        PktcntW::new(self, 19)
    }
}
#[doc = "Device OUT Endpoint x+1 Transfer Size Register\n\nYou can [`read`](crate::Reg::read) this register and get [`doep3_tsiz::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`doep3_tsiz::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Doep3TsizSpec;
impl crate::RegisterSpec for Doep3TsizSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep3_tsiz::R`](R) reader structure"]
impl crate::Readable for Doep3TsizSpec {}
#[doc = "`write(|w| ..)` method takes [`doep3_tsiz::W`](W) writer structure"]
impl crate::Writable for Doep3TsizSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DOEP3_TSIZ to value 0"]
impl crate::Resettable for Doep3TsizSpec {}
