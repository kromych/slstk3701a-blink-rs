#[doc = "Register `DOEP4_TSIZ` reader"]
pub type R = crate::R<Doep4TsizSpec>;
#[doc = "Register `DOEP4_TSIZ` writer"]
pub type W = crate::W<Doep4TsizSpec>;
...
impl W {
    #[doc = "Bits 0:18 - Transfer Size"]
    #[inline(always)]
    pub fn xfersize(&mut self) -> XfersizeW<'_, Doep4TsizSpec> {
        XfersizeW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet Count"]
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PktcntW<'_, Doep4TsizSpec> {
        PktcntW::new(self, 19)
    }
}
#[doc = "Device OUT Endpoint x+1 Transfer Size Register\n\nYou can [`read`](crate::Reg::read) this register and get [`doep4_tsiz::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`doep4_tsiz::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Doep4TsizSpec;
impl crate::RegisterSpec for Doep4TsizSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep4_tsiz::R`](R) reader structure"]
impl crate::Readable for Doep4TsizSpec {}
#[doc = "`write(|w| ..)` method takes [`doep4_tsiz::W`](W) writer structure"]
impl crate::Writable for Doep4TsizSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DOEP4_TSIZ to value 0"]
impl crate::Resettable for Doep4TsizSpec {}
