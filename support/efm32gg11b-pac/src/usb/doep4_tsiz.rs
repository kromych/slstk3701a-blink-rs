...
pub type R = crate::R<DOEP4_TSIZ_SPEC>;
#[doc = "Register `DOEP4_TSIZ` writer"]
pub type W = crate::W<DOEP4_TSIZ_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfersize(&mut self) -> XFERSIZE_W<DOEP4_TSIZ_SPEC, 0> {
        XFERSIZE_W::new(self)
    }
    #[doc = "Bits 19:28 - Packet Count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PKTCNT_W<DOEP4_TSIZ_SPEC, 19> {
        PKTCNT_W::new(self)
    }
...
#[doc = "Device OUT Endpoint x+1 Transfer Size Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`doep4_tsiz::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`doep4_tsiz::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DOEP4_TSIZ_SPEC;
impl crate::RegisterSpec for DOEP4_TSIZ_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep4_tsiz::R`](R) reader structure"]
impl crate::Readable for DOEP4_TSIZ_SPEC {}
#[doc = "`write(|w| ..)` method takes [`doep4_tsiz::W`](W) writer structure"]
impl crate::Writable for DOEP4_TSIZ_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DOEP4_TSIZ to value 0"]
impl crate::Resettable for DOEP4_TSIZ_SPEC {
