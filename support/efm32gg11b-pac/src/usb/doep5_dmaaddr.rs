...
pub type R = crate::R<DOEP5_DMAADDR_SPEC>;
#[doc = "Register `DOEP5_DMAADDR` writer"]
pub type W = crate::W<DOEP5_DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<DOEP5_DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
#[doc = "Device OUT Endpoint x+1 DMA Address Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`doep5_dmaaddr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`doep5_dmaaddr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
