...
pub type R = crate::R<DOEP5_TSIZ_SPEC>;
#[doc = "Register `DOEP5_TSIZ` writer"]
pub type W = crate::W<DOEP5_TSIZ_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfersize(&mut self) -> XFERSIZE_W<DOEP5_TSIZ_SPEC, 0> {
        XFERSIZE_W::new(self)
    }
    #[doc = "Bits 19:28 - Packet Count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PKTCNT_W<DOEP5_TSIZ_SPEC, 19> {
        PKTCNT_W::new(self)
    }
...
#[doc = "Device OUT Endpoint x+1 Transfer Size Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`doep5_tsiz::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`doep5_tsiz::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DOEP5_TSIZ_SPEC;
impl crate::RegisterSpec for DOEP5_TSIZ_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep5_tsiz::R`](R) reader structure"]
impl crate::Readable for DOEP5_TSIZ_SPEC {}
