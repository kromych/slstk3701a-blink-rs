...
pub type R = crate::R<Hc10IntSpec>;
#[doc = "Register `HC10_INT` writer"]
pub type W = crate::W<Hc10IntSpec>;
...
impl W {
    #[doc = "Bit 0 - Transfer Completed"]
    #[inline(always)]
    pub fn xfercompl(&mut self) -> XfercomplW<'_, Hc10IntSpec> {
        XfercomplW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Halted"]
    #[inline(always)]
    pub fn chhltd(&mut self) -> ChhltdW<'_, Hc10IntSpec> {
        ChhltdW::new(self, 1)
    }
    #[doc = "Bit 2 - AHB Error"]
    #[inline(always)]
    pub fn ahberr(&mut self) -> AhberrW<'_, Hc10IntSpec> {
        AhberrW::new(self, 2)
    }
    #[doc = "Bit 3 - STALL Response Received Interrupt"]
    #[inline(always)]
    pub fn stall(&mut self) -> StallW<'_, Hc10IntSpec> {
        StallW::new(self, 3)
    }
    #[doc = "Bit 4 - NAK Response Received Interrupt"]
    #[inline(always)]
    pub fn nak(&mut self) -> NakW<'_, Hc10IntSpec> {
        NakW::new(self, 4)
    }
    #[doc = "Bit 5 - ACK Response Received/Transmitted Interrupt"]
    #[inline(always)]
    pub fn ack(&mut self) -> AckW<'_, Hc10IntSpec> {
        AckW::new(self, 5)
    }
    #[doc = "Bit 7 - Transaction Error"]
    #[inline(always)]
    pub fn xacterr(&mut self) -> XacterrW<'_, Hc10IntSpec> {
        XacterrW::new(self, 7)
    }
    #[doc = "Bit 8 - Babble Error"]
    #[inline(always)]
    pub fn bblerr(&mut self) -> BblerrW<'_, Hc10IntSpec> {
        BblerrW::new(self, 8)
    }
    #[doc = "Bit 9 - Frame Overrun"]
    #[inline(always)]
    pub fn frmovrun(&mut self) -> FrmovrunW<'_, Hc10IntSpec> {
        FrmovrunW::new(self, 9)
    }
    #[doc = "Bit 10 - Data Toggle Error"]
    #[inline(always)]
    pub fn datatglerr(&mut self) -> DatatglerrW<'_, Hc10IntSpec> {
        DatatglerrW::new(self, 10)
    }
}
#[doc = "Host Channel x Interrupt Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hc10_int::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hc10_int::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hc10IntSpec;
impl crate::RegisterSpec for Hc10IntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hc10_int::R`](R) reader structure"]
impl crate::Readable for Hc10IntSpec {}
#[doc = "`write(|w| ..)` method takes [`hc10_int::W`](W) writer structure"]
impl crate::Writable for Hc10IntSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HC10_INT to value 0"]
impl crate::Resettable for Hc10IntSpec {}
