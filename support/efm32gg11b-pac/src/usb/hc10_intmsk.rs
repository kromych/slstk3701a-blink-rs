...
pub type R = crate::R<HC10_INTMSK_SPEC>;
#[doc = "Register `HC10_INTMSK` writer"]
pub type W = crate::W<HC10_INTMSK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfercomplmsk(&mut self) -> XFERCOMPLMSK_W<HC10_INTMSK_SPEC, 0> {
        XFERCOMPLMSK_W::new(self)
    }
    #[doc = "Bit 1 - Channel Halted Mask"]
    #[inline(always)]
    #[must_use]
    pub fn chhltdmsk(&mut self) -> CHHLTDMSK_W<HC10_INTMSK_SPEC, 1> {
        CHHLTDMSK_W::new(self)
    }
    #[doc = "Bit 2 - AHB Error Mask"]
    #[inline(always)]
    #[must_use]
    pub fn ahberrmsk(&mut self) -> AHBERRMSK_W<HC10_INTMSK_SPEC, 2> {
        AHBERRMSK_W::new(self)
    }
    #[doc = "Bit 3 - STALL Response Received Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn stallmsk(&mut self) -> STALLMSK_W<HC10_INTMSK_SPEC, 3> {
        STALLMSK_W::new(self)
    }
    #[doc = "Bit 4 - NAK Response Received Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn nakmsk(&mut self) -> NAKMSK_W<HC10_INTMSK_SPEC, 4> {
        NAKMSK_W::new(self)
    }
    #[doc = "Bit 5 - ACK Response Received/Transmitted Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn ackmsk(&mut self) -> ACKMSK_W<HC10_INTMSK_SPEC, 5> {
        ACKMSK_W::new(self)
    }
    #[doc = "Bit 7 - Transaction Error Mask"]
    #[inline(always)]
    #[must_use]
    pub fn xacterrmsk(&mut self) -> XACTERRMSK_W<HC10_INTMSK_SPEC, 7> {
        XACTERRMSK_W::new(self)
    }
    #[doc = "Bit 8 - Babble Error Mask"]
    #[inline(always)]
    #[must_use]
    pub fn bblerrmsk(&mut self) -> BBLERRMSK_W<HC10_INTMSK_SPEC, 8> {
        BBLERRMSK_W::new(self)
    }
    #[doc = "Bit 9 - Frame Overrun Mask"]
    #[inline(always)]
    #[must_use]
    pub fn frmovrunmsk(&mut self) -> FRMOVRUNMSK_W<HC10_INTMSK_SPEC, 9> {
        FRMOVRUNMSK_W::new(self)
    }
    #[doc = "Bit 10 - Data Toggle Error Mask"]
    #[inline(always)]
    #[must_use]
    pub fn datatglerrmsk(&mut self) -> DATATGLERRMSK_W<HC10_INTMSK_SPEC, 10> {
...
#[doc = "Host Channel x Interrupt Mask Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hc10_intmsk::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hc10_intmsk::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HC10_INTMSK_SPEC;
impl crate::RegisterSpec for HC10_INTMSK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hc10_intmsk::R`](R) reader structure"]
impl crate::Readable for HC10_INTMSK_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hc10_intmsk::W`](W) writer structure"]
impl crate::Writable for HC10_INTMSK_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HC10_INTMSK to value 0"]
impl crate::Resettable for HC10_INTMSK_SPEC {
