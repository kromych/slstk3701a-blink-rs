...
pub type R = crate::R<HC11_INT_SPEC>;
#[doc = "Register `HC11_INT` writer"]
pub type W = crate::W<HC11_INT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfercompl(&mut self) -> XFERCOMPL_W<HC11_INT_SPEC, 0> {
        XFERCOMPL_W::new(self)
    }
    #[doc = "Bit 1 - Channel Halted"]
    #[inline(always)]
    #[must_use]
    pub fn chhltd(&mut self) -> CHHLTD_W<HC11_INT_SPEC, 1> {
        CHHLTD_W::new(self)
    }
    #[doc = "Bit 2 - AHB Error"]
    #[inline(always)]
    #[must_use]
    pub fn ahberr(&mut self) -> AHBERR_W<HC11_INT_SPEC, 2> {
        AHBERR_W::new(self)
    }
    #[doc = "Bit 3 - STALL Response Received Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> STALL_W<HC11_INT_SPEC, 3> {
        STALL_W::new(self)
    }
    #[doc = "Bit 4 - NAK Response Received Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn nak(&mut self) -> NAK_W<HC11_INT_SPEC, 4> {
        NAK_W::new(self)
    }
    #[doc = "Bit 5 - ACK Response Received/Transmitted Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn ack(&mut self) -> ACK_W<HC11_INT_SPEC, 5> {
        ACK_W::new(self)
    }
    #[doc = "Bit 7 - Transaction Error"]
    #[inline(always)]
    #[must_use]
    pub fn xacterr(&mut self) -> XACTERR_W<HC11_INT_SPEC, 7> {
        XACTERR_W::new(self)
    }
    #[doc = "Bit 8 - Babble Error"]
    #[inline(always)]
    #[must_use]
    pub fn bblerr(&mut self) -> BBLERR_W<HC11_INT_SPEC, 8> {
        BBLERR_W::new(self)
    }
    #[doc = "Bit 9 - Frame Overrun"]
    #[inline(always)]
    #[must_use]
    pub fn frmovrun(&mut self) -> FRMOVRUN_W<HC11_INT_SPEC, 9> {
        FRMOVRUN_W::new(self)
    }
    #[doc = "Bit 10 - Data Toggle Error"]
    #[inline(always)]
    #[must_use]
    pub fn datatglerr(&mut self) -> DATATGLERR_W<HC11_INT_SPEC, 10> {
...
#[doc = "Host Channel x Interrupt Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hc11_int::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hc11_int::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HC11_INT_SPEC;
impl crate::RegisterSpec for HC11_INT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hc11_int::R`](R) reader structure"]
impl crate::Readable for HC11_INT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hc11_int::W`](W) writer structure"]
impl crate::Writable for HC11_INT_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HC11_INT to value 0"]
impl crate::Resettable for HC11_INT_SPEC {
