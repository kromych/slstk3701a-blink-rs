...
pub type R = crate::R<HC11_TSIZ_SPEC>;
#[doc = "Register `HC11_TSIZ` writer"]
pub type W = crate::W<HC11_TSIZ_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfersize(&mut self) -> XFERSIZE_W<HC11_TSIZ_SPEC, 0> {
        XFERSIZE_W::new(self)
    }
    #[doc = "Bits 19:28 - Packet Count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PKTCNT_W<HC11_TSIZ_SPEC, 19> {
        PKTCNT_W::new(self)
    }
    #[doc = "Bits 29:30 - The Application Programs This Field With the Type of"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PID_W<HC11_TSIZ_SPEC, 29> {
        PID_W::new(self)
    }
...
#[doc = "Host Channel x Transfer Size Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hc11_tsiz::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hc11_tsiz::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HC11_TSIZ_SPEC;
impl crate::RegisterSpec for HC11_TSIZ_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hc11_tsiz::R`](R) reader structure"]
impl crate::Readable for HC11_TSIZ_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hc11_tsiz::W`](W) writer structure"]
impl crate::Writable for HC11_TSIZ_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HC11_TSIZ to value 0"]
impl crate::Resettable for HC11_TSIZ_SPEC {
