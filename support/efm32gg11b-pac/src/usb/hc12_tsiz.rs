#[doc = "Register `HC12_TSIZ` reader"]
pub type R = crate::R<Hc12TsizSpec>;
#[doc = "Register `HC12_TSIZ` writer"]
pub type W = crate::W<Hc12TsizSpec>;
...
impl W {
    #[doc = "Bits 0:18 - Transfer Size"]
    #[inline(always)]
    pub fn xfersize(&mut self) -> XfersizeW<'_, Hc12TsizSpec> {
        XfersizeW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet Count"]
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PktcntW<'_, Hc12TsizSpec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - The Application Programs This Field With the Type of"]
    #[inline(always)]
    pub fn pid(&mut self) -> PidW<'_, Hc12TsizSpec> {
        PidW::new(self, 29)
    }
}
#[doc = "Host Channel x Transfer Size Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hc12_tsiz::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hc12_tsiz::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hc12TsizSpec;
impl crate::RegisterSpec for Hc12TsizSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hc12_tsiz::R`](R) reader structure"]
impl crate::Readable for Hc12TsizSpec {}
#[doc = "`write(|w| ..)` method takes [`hc12_tsiz::W`](W) writer structure"]
impl crate::Writable for Hc12TsizSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HC12_TSIZ to value 0"]
impl crate::Resettable for Hc12TsizSpec {}
