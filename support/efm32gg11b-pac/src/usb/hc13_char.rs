#[doc = "Register `HC13_CHAR` reader"]
pub type R = crate::R<Hc13CharSpec>;
#[doc = "Register `HC13_CHAR` writer"]
pub type W = crate::W<Hc13CharSpec>;
...
impl W {
    #[doc = "Bits 0:10 - Maximum Packet Size"]
    #[inline(always)]
    pub fn mps(&mut self) -> MpsW<'_, Hc13CharSpec> {
        MpsW::new(self, 0)
    }
    #[doc = "Bits 11:14 - Endpoint Number"]
    #[inline(always)]
    pub fn epnum(&mut self) -> EpnumW<'_, Hc13CharSpec> {
        EpnumW::new(self, 11)
    }
    #[doc = "Bit 15 - Endpoint Direction"]
    #[inline(always)]
    pub fn epdir(&mut self) -> EpdirW<'_, Hc13CharSpec> {
        EpdirW::new(self, 15)
    }
    #[doc = "Bit 17 - Low-Speed Device"]
    #[inline(always)]
    pub fn lspddev(&mut self) -> LspddevW<'_, Hc13CharSpec> {
        LspddevW::new(self, 17)
    }
    #[doc = "Bits 18:19 - Endpoint Type"]
    #[inline(always)]
    pub fn eptype(&mut self) -> EptypeW<'_, Hc13CharSpec> {
        EptypeW::new(self, 18)
    }
    #[doc = "Bits 20:21 - Multi Count (MC) / Error Count"]
    #[inline(always)]
    pub fn mc(&mut self) -> McW<'_, Hc13CharSpec> {
        McW::new(self, 20)
    }
    #[doc = "Bits 22:28 - Device Address"]
    #[inline(always)]
    pub fn devaddr(&mut self) -> DevaddrW<'_, Hc13CharSpec> {
        DevaddrW::new(self, 22)
    }
    #[doc = "Bit 29 - Odd Frame"]
    #[inline(always)]
    pub fn oddfrm(&mut self) -> OddfrmW<'_, Hc13CharSpec> {
        OddfrmW::new(self, 29)
    }
    #[doc = "Bit 30 - Channel Disable"]
    #[inline(always)]
    pub fn chdis(&mut self) -> ChdisW<'_, Hc13CharSpec> {
        ChdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Channel Enable"]
    #[inline(always)]
    pub fn chena(&mut self) -> ChenaW<'_, Hc13CharSpec> {
        ChenaW::new(self, 31)
    }
}
#[doc = "Host Channel x Characteristics Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hc13_char::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hc13_char::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hc13CharSpec;
impl crate::RegisterSpec for Hc13CharSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hc13_char::R`](R) reader structure"]
impl crate::Readable for Hc13CharSpec {}
#[doc = "`write(|w| ..)` method takes [`hc13_char::W`](W) writer structure"]
impl crate::Writable for Hc13CharSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HC13_CHAR to value 0"]
impl crate::Resettable for Hc13CharSpec {}
