...
pub type R = crate::R<HC13_TSIZ_SPEC>;
#[doc = "Register `HC13_TSIZ` writer"]
pub type W = crate::W<HC13_TSIZ_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfersize(&mut self) -> XFERSIZE_W<HC13_TSIZ_SPEC, 0> {
        XFERSIZE_W::new(self)
    }
    #[doc = "Bits 19:28 - Packet Count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PKTCNT_W<HC13_TSIZ_SPEC, 19> {
        PKTCNT_W::new(self)
    }
    #[doc = "Bits 29:30 - The Application Programs This Field With the Type of"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PID_W<HC13_TSIZ_SPEC, 29> {
        PID_W::new(self)
    }
