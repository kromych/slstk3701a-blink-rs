...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mps(&mut self) -> MPS_W<HC2_CHAR_SPEC, 0> {
        MPS_W::new(self)
    }
    #[doc = "Bits 11:14 - Endpoint Number"]
    #[inline(always)]
    #[must_use]
    pub fn epnum(&mut self) -> EPNUM_W<HC2_CHAR_SPEC, 11> {
        EPNUM_W::new(self)
    }
    #[doc = "Bit 15 - Endpoint Direction"]
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EPDIR_W<HC2_CHAR_SPEC, 15> {
        EPDIR_W::new(self)
    }
    #[doc = "Bit 17 - Low-Speed Device"]
    #[inline(always)]
    #[must_use]
    pub fn lspddev(&mut self) -> LSPDDEV_W<HC2_CHAR_SPEC, 17> {
        LSPDDEV_W::new(self)
    }
    #[doc = "Bits 18:19 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EPTYPE_W<HC2_CHAR_SPEC, 18> {
        EPTYPE_W::new(self)
    }
    #[doc = "Bits 20:21 - Multi Count (MC) / Error Count"]
    #[inline(always)]
    #[must_use]
    pub fn mc(&mut self) -> MC_W<HC2_CHAR_SPEC, 20> {
        MC_W::new(self)
    }
    #[doc = "Bits 22:28 - Device Address"]
    #[inline(always)]
    #[must_use]
    pub fn devaddr(&mut self) -> DEVADDR_W<HC2_CHAR_SPEC, 22> {
        DEVADDR_W::new(self)
    }
    #[doc = "Bit 29 - Odd Frame"]
    #[inline(always)]
    #[must_use]
    pub fn oddfrm(&mut self) -> ODDFRM_W<HC2_CHAR_SPEC, 29> {
        ODDFRM_W::new(self)
    }
    #[doc = "Bit 30 - Channel Disable"]
    #[inline(always)]
    #[must_use]
    pub fn chdis(&mut self) -> CHDIS_W<HC2_CHAR_SPEC, 30> {
        CHDIS_W::new(self)
    }
    #[doc = "Bit 31 - Channel Enable"]
    #[inline(always)]
    #[must_use]
    pub fn chena(&mut self) -> CHENA_W<HC2_CHAR_SPEC, 31> {
        CHENA_W::new(self)
    }
