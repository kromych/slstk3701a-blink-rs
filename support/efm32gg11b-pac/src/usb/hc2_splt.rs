...
pub type R = crate::R<Hc2SpltSpec>;
#[doc = "Register `HC2_SPLT` writer"]
pub type W = crate::W<Hc2SpltSpec>;
...
impl W {
    #[doc = "Bits 0:6 - Port Address"]
    #[inline(always)]
    pub fn prtaddr(&mut self) -> PrtaddrW<'_, Hc2SpltSpec> {
        PrtaddrW::new(self, 0)
    }
    #[doc = "Bits 7:13 - Hub Address"]
    #[inline(always)]
    pub fn hubaddr(&mut self) -> HubaddrW<'_, Hc2SpltSpec> {
        HubaddrW::new(self, 7)
    }
    #[doc = "Bits 14:15 - Transaction Position"]
    #[inline(always)]
    pub fn xactpos(&mut self) -> XactposW<'_, Hc2SpltSpec> {
        XactposW::new(self, 14)
    }
    #[doc = "Bit 16 - Do Complete Split"]
    #[inline(always)]
    pub fn compsplt(&mut self) -> CompspltW<'_, Hc2SpltSpec> {
        CompspltW::new(self, 16)
    }
    #[doc = "Bit 31 - Split Enable"]
    #[inline(always)]
    pub fn spltena(&mut self) -> SpltenaW<'_, Hc2SpltSpec> {
        SpltenaW::new(self, 31)
    }
}
#[doc = "Host Channel x Split Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hc2_splt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hc2_splt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hc2SpltSpec;
impl crate::RegisterSpec for Hc2SpltSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hc2_splt::R`](R) reader structure"]
impl crate::Readable for Hc2SpltSpec {}
#[doc = "`write(|w| ..)` method takes [`hc2_splt::W`](W) writer structure"]
impl crate::Writable for Hc2SpltSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HC2_SPLT to value 0"]
impl crate::Resettable for Hc2SpltSpec {}
