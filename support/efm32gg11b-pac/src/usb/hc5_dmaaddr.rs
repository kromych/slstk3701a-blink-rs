...
pub type R = crate::R<HC5_DMAADDR_SPEC>;
#[doc = "Register `HC5_DMAADDR` writer"]
pub type W = crate::W<HC5_DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<HC5_DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
#[doc = "Host Channel x DMA Address Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hc5_dmaaddr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hc5_dmaaddr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
