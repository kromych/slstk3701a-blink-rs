...
pub type R = crate::R<HC5_SPLT_SPEC>;
#[doc = "Register `HC5_SPLT` writer"]
pub type W = crate::W<HC5_SPLT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn prtaddr(&mut self) -> PRTADDR_W<HC5_SPLT_SPEC, 0> {
        PRTADDR_W::new(self)
    }
    #[doc = "Bits 7:13 - Hub Address"]
    #[inline(always)]
    #[must_use]
    pub fn hubaddr(&mut self) -> HUBADDR_W<HC5_SPLT_SPEC, 7> {
        HUBADDR_W::new(self)
    }
    #[doc = "Bits 14:15 - Transaction Position"]
    #[inline(always)]
    #[must_use]
    pub fn xactpos(&mut self) -> XACTPOS_W<HC5_SPLT_SPEC, 14> {
        XACTPOS_W::new(self)
    }
    #[doc = "Bit 16 - Do Complete Split"]
    #[inline(always)]
    #[must_use]
    pub fn compsplt(&mut self) -> COMPSPLT_W<HC5_SPLT_SPEC, 16> {
        COMPSPLT_W::new(self)
    }
    #[doc = "Bit 31 - Split Enable"]
    #[inline(always)]
    #[must_use]
    pub fn spltena(&mut self) -> SPLTENA_W<HC5_SPLT_SPEC, 31> {
        SPLTENA_W::new(self)
    }
