...
pub type R = crate::R<Hc5TsizSpec>;
#[doc = "Register `HC5_TSIZ` writer"]
pub type W = crate::W<Hc5TsizSpec>;
...
impl W {
    #[doc = "Bits 0:18 - Transfer Size"]
    #[inline(always)]
    pub fn xfersize(&mut self) -> XfersizeW<'_, Hc5TsizSpec> {
        XfersizeW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet Count"]
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PktcntW<'_, Hc5TsizSpec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - The Application Programs This Field With the Type of"]
    #[inline(always)]
    pub fn pid(&mut self) -> PidW<'_, Hc5TsizSpec> {
        PidW::new(self, 29)
    }
}
#[doc = "Host Channel x Transfer Size Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hc5_tsiz::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hc5_tsiz::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hc5TsizSpec;
impl crate::RegisterSpec for Hc5TsizSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hc5_tsiz::R`](R) reader structure"]
impl crate::Readable for Hc5TsizSpec {}
#[doc = "`write(|w| ..)` method takes [`hc5_tsiz::W`](W) writer structure"]
impl crate::Writable for Hc5TsizSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HC5_TSIZ to value 0"]
impl crate::Resettable for Hc5TsizSpec {}
