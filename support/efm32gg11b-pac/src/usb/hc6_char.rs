#[doc = "Register `HC6_CHAR` reader"]
pub type R = crate::R<Hc6CharSpec>;
#[doc = "Register `HC6_CHAR` writer"]
pub type W = crate::W<Hc6CharSpec>;
...
impl W {
    #[doc = "Bits 0:10 - Maximum Packet Size"]
    #[inline(always)]
    pub fn mps(&mut self) -> MpsW<'_, Hc6CharSpec> {
        MpsW::new(self, 0)
    }
    #[doc = "Bits 11:14 - Endpoint Number"]
    #[inline(always)]
    pub fn epnum(&mut self) -> EpnumW<'_, Hc6CharSpec> {
        EpnumW::new(self, 11)
    }
    #[doc = "Bit 15 - Endpoint Direction"]
    #[inline(always)]
    pub fn epdir(&mut self) -> EpdirW<'_, Hc6CharSpec> {
        EpdirW::new(self, 15)
    }
    #[doc = "Bit 17 - Low-Speed Device"]
    #[inline(always)]
    pub fn lspddev(&mut self) -> LspddevW<'_, Hc6CharSpec> {
        LspddevW::new(self, 17)
    }
    #[doc = "Bits 18:19 - Endpoint Type"]
    #[inline(always)]
    pub fn eptype(&mut self) -> EptypeW<'_, Hc6CharSpec> {
        EptypeW::new(self, 18)
    }
    #[doc = "Bits 20:21 - Multi Count (MC) / Error Count"]
    #[inline(always)]
    pub fn mc(&mut self) -> McW<'_, Hc6CharSpec> {
        McW::new(self, 20)
    }
    #[doc = "Bits 22:28 - Device Address"]
    #[inline(always)]
    pub fn devaddr(&mut self) -> DevaddrW<'_, Hc6CharSpec> {
        DevaddrW::new(self, 22)
    }
    #[doc = "Bit 29 - Odd Frame"]
    #[inline(always)]
    pub fn oddfrm(&mut self) -> OddfrmW<'_, Hc6CharSpec> {
        OddfrmW::new(self, 29)
    }
    #[doc = "Bit 30 - Channel Disable"]
    #[inline(always)]
    pub fn chdis(&mut self) -> ChdisW<'_, Hc6CharSpec> {
        ChdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Channel Enable"]
    #[inline(always)]
    pub fn chena(&mut self) -> ChenaW<'_, Hc6CharSpec> {
        ChenaW::new(self, 31)
    }
}
#[doc = "Host Channel x Characteristics Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hc6_char::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hc6_char::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hc6CharSpec;
impl crate::RegisterSpec for Hc6CharSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hc6_char::R`](R) reader structure"]
impl crate::Readable for Hc6CharSpec {}
#[doc = "`write(|w| ..)` method takes [`hc6_char::W`](W) writer structure"]
impl crate::Writable for Hc6CharSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HC6_CHAR to value 0"]
impl crate::Resettable for Hc6CharSpec {}
