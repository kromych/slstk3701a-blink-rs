...
pub type R = crate::R<HC6_CHAR_SPEC>;
#[doc = "Register `HC6_CHAR` writer"]
pub type W = crate::W<HC6_CHAR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mps(&mut self) -> MPS_W<HC6_CHAR_SPEC, 0> {
        MPS_W::new(self)
    }
    #[doc = "Bits 11:14 - Endpoint Number"]
    #[inline(always)]
    #[must_use]
    pub fn epnum(&mut self) -> EPNUM_W<HC6_CHAR_SPEC, 11> {
        EPNUM_W::new(self)
    }
    #[doc = "Bit 15 - Endpoint Direction"]
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EPDIR_W<HC6_CHAR_SPEC, 15> {
        EPDIR_W::new(self)
    }
    #[doc = "Bit 17 - Low-Speed Device"]
    #[inline(always)]
    #[must_use]
    pub fn lspddev(&mut self) -> LSPDDEV_W<HC6_CHAR_SPEC, 17> {
        LSPDDEV_W::new(self)
    }
    #[doc = "Bits 18:19 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EPTYPE_W<HC6_CHAR_SPEC, 18> {
        EPTYPE_W::new(self)
    }
    #[doc = "Bits 20:21 - Multi Count (MC) / Error Count"]
    #[inline(always)]
    #[must_use]
    pub fn mc(&mut self) -> MC_W<HC6_CHAR_SPEC, 20> {
        MC_W::new(self)
    }
    #[doc = "Bits 22:28 - Device Address"]
    #[inline(always)]
    #[must_use]
    pub fn devaddr(&mut self) -> DEVADDR_W<HC6_CHAR_SPEC, 22> {
        DEVADDR_W::new(self)
    }
    #[doc = "Bit 29 - Odd Frame"]
    #[inline(always)]
    #[must_use]
    pub fn oddfrm(&mut self) -> ODDFRM_W<HC6_CHAR_SPEC, 29> {
        ODDFRM_W::new(self)
    }
    #[doc = "Bit 30 - Channel Disable"]
    #[inline(always)]
    #[must_use]
    pub fn chdis(&mut self) -> CHDIS_W<HC6_CHAR_SPEC, 30> {
        CHDIS_W::new(self)
    }
    #[doc = "Bit 31 - Channel Enable"]
    #[inline(always)]
    #[must_use]
    pub fn chena(&mut self) -> CHENA_W<HC6_CHAR_SPEC, 31> {
        CHENA_W::new(self)
    }
...
#[doc = "Host Channel x Characteristics Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hc6_char::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hc6_char::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HC6_CHAR_SPEC;
impl crate::RegisterSpec for HC6_CHAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hc6_char::R`](R) reader structure"]
impl crate::Readable for HC6_CHAR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hc6_char::W`](W) writer structure"]
impl crate::Writable for HC6_CHAR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HC6_CHAR to value 0"]
impl crate::Resettable for HC6_CHAR_SPEC {
