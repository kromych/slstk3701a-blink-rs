#[doc = "Register `HC8_SPLT` reader"]
pub type R = crate::R<Hc8SpltSpec>;
#[doc = "Register `HC8_SPLT` writer"]
pub type W = crate::W<Hc8SpltSpec>;
...
impl W {
    #[doc = "Bits 0:6 - Port Address"]
    #[inline(always)]
    pub fn prtaddr(&mut self) -> PrtaddrW<'_, Hc8SpltSpec> {
        PrtaddrW::new(self, 0)
    }
    #[doc = "Bits 7:13 - Hub Address"]
    #[inline(always)]
    pub fn hubaddr(&mut self) -> HubaddrW<'_, Hc8SpltSpec> {
        HubaddrW::new(self, 7)
    }
    #[doc = "Bits 14:15 - Transaction Position"]
    #[inline(always)]
    pub fn xactpos(&mut self) -> XactposW<'_, Hc8SpltSpec> {
        XactposW::new(self, 14)
    }
    #[doc = "Bit 16 - Do Complete Split"]
    #[inline(always)]
    pub fn compsplt(&mut self) -> CompspltW<'_, Hc8SpltSpec> {
        CompspltW::new(self, 16)
    }
    #[doc = "Bit 31 - Split Enable"]
    #[inline(always)]
    pub fn spltena(&mut self) -> SpltenaW<'_, Hc8SpltSpec> {
        SpltenaW::new(self, 31)
    }
}
#[doc = "Host Channel x Split Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`hc8_splt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hc8_splt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hc8SpltSpec;
impl crate::RegisterSpec for Hc8SpltSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hc8_splt::R`](R) reader structure"]
impl crate::Readable for Hc8SpltSpec {}
#[doc = "`write(|w| ..)` method takes [`hc8_splt::W`](W) writer structure"]
impl crate::Writable for Hc8SpltSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HC8_SPLT to value 0"]
impl crate::Resettable for Hc8SpltSpec {}
