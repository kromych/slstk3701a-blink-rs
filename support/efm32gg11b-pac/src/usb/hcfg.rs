...
pub type FSLSPCLKSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O, FSLSPCLKSEL_A>;
impl<'a, REG, const O: u8> FSLSPCLKSEL_W<'a, REG, O>
where
...
pub type FSLSSUPP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ENA32KHZS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RESVALID_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type MODECHTIMEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ena32khzs(&mut self) -> ENA32KHZS_W<HCFG_SPEC, 7> {
        ENA32KHZS_W::new(self)
    }
    #[doc = "Bits 8:15 - Resume Validation Period"]
    #[inline(always)]
    #[must_use]
    pub fn resvalid(&mut self) -> RESVALID_W<HCFG_SPEC, 8> {
        RESVALID_W::new(self)
    }
    #[doc = "Bit 31 - Mode Change Time"]
    #[inline(always)]
    #[must_use]
    pub fn modechtimen(&mut self) -> MODECHTIMEN_W<HCFG_SPEC, 31> {
