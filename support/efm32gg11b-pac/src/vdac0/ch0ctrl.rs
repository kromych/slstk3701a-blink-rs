...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn convmode(&mut self) -> CONVMODE_W<CH0CTRL_SPEC> {
        CONVMODE_W::new(self, 0)
    }
    #[doc = "Bits 4:6 - Channel 0 Trigger Mode"]
    #[inline(always)]
    #[must_use]
    pub fn trigmode(&mut self) -> TRIGMODE_W<CH0CTRL_SPEC> {
        TRIGMODE_W::new(self, 4)
    }
    #[doc = "Bit 8 - Channel 0 PRS Asynchronous Enable"]
    #[inline(always)]
    #[must_use]
    pub fn prsasync(&mut self) -> PRSASYNC_W<CH0CTRL_SPEC> {
        PRSASYNC_W::new(self, 8)
    }
    #[doc = "Bits 12:16 - Channel 0 PRS Trigger Select"]
    #[inline(always)]
    #[must_use]
    pub fn prssel(&mut self) -> PRSSEL_W<CH0CTRL_SPEC> {
