...
pub type R = crate::R<CH0CTRL_SPEC>;
#[doc = "Register `CH0CTRL` writer"]
pub type W = crate::W<CH0CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn convmode(&mut self) -> CONVMODE_W<CH0CTRL_SPEC, 0> {
        CONVMODE_W::new(self)
    }
    #[doc = "Bits 4:6 - Channel 0 Trigger Mode"]
    #[inline(always)]
    #[must_use]
    pub fn trigmode(&mut self) -> TRIGMODE_W<CH0CTRL_SPEC, 4> {
        TRIGMODE_W::new(self)
    }
    #[doc = "Bit 8 - Channel 0 PRS Asynchronous Enable"]
    #[inline(always)]
    #[must_use]
    pub fn prsasync(&mut self) -> PRSASYNC_W<CH0CTRL_SPEC, 8> {
        PRSASYNC_W::new(self)
    }
    #[doc = "Bits 12:16 - Channel 0 PRS Trigger Select"]
    #[inline(always)]
    #[must_use]
    pub fn prssel(&mut self) -> PRSSEL_W<CH0CTRL_SPEC, 12> {
        PRSSEL_W::new(self)
    }
