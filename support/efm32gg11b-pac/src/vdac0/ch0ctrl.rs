...
impl W {
    #[doc = "Bit 0 - Conversion Mode"]
    #[inline(always)]
    pub fn convmode(&mut self) -> ConvmodeW<'_, Ch0ctrlSpec> {
        ConvmodeW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Channel 0 Trigger Mode"]
    #[inline(always)]
    pub fn trigmode(&mut self) -> TrigmodeW<'_, Ch0ctrlSpec> {
        TrigmodeW::new(self, 4)
    }
    #[doc = "Bit 8 - Channel 0 PRS Asynchronous Enable"]
    #[inline(always)]
    pub fn prsasync(&mut self) -> PrsasyncW<'_, Ch0ctrlSpec> {
        PrsasyncW::new(self, 8)
    }
    #[doc = "Bits 12:16 - Channel 0 PRS Trigger Select"]
    #[inline(always)]
    pub fn prssel(&mut self) -> PrsselW<'_, Ch0ctrlSpec> {
        PrsselW::new(self, 12)
    }
}
