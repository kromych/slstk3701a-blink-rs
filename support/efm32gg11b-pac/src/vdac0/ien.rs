...
pub type CH0BL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CH1BL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0cd(&mut self) -> CH0CD_W<IEN_SPEC, 0> {
        CH0CD_W::new(self)
    }
    #[doc = "Bit 1 - CH1CD Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1cd(&mut self) -> CH1CD_W<IEN_SPEC, 1> {
        CH1CD_W::new(self)
    }
    #[doc = "Bit 2 - CH0OF Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0of(&mut self) -> CH0OF_W<IEN_SPEC, 2> {
        CH0OF_W::new(self)
    }
    #[doc = "Bit 3 - CH1OF Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1of(&mut self) -> CH1OF_W<IEN_SPEC, 3> {
        CH1OF_W::new(self)
    }
    #[doc = "Bit 4 - CH0UF Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0uf(&mut self) -> CH0UF_W<IEN_SPEC, 4> {
        CH0UF_W::new(self)
    }
    #[doc = "Bit 5 - CH1UF Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1uf(&mut self) -> CH1UF_W<IEN_SPEC, 5> {
        CH1UF_W::new(self)
    }
    #[doc = "Bit 6 - CH0BL Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0bl(&mut self) -> CH0BL_W<IEN_SPEC, 6> {
        CH0BL_W::new(self)
    }
    #[doc = "Bit 7 - CH1BL Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1bl(&mut self) -> CH1BL_W<IEN_SPEC, 7> {
        CH1BL_W::new(self)
    }
    #[doc = "Bit 15 - EM23ERR Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn em23err(&mut self) -> EM23ERR_W<IEN_SPEC, 15> {
        EM23ERR_W::new(self)
    }
    #[doc = "Bit 16 - OPA0APORTCONFLICT Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn opa0aportconflict(&mut self) -> OPA0APORTCONFLICT_W<IEN_SPEC, 16> {
        OPA0APORTCONFLICT_W::new(self)
    }
    #[doc = "Bit 17 - OPA1APORTCONFLICT Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn opa1aportconflict(&mut self) -> OPA1APORTCONFLICT_W<IEN_SPEC, 17> {
        OPA1APORTCONFLICT_W::new(self)
    }
    #[doc = "Bit 18 - OPA2APORTCONFLICT Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn opa2aportconflict(&mut self) -> OPA2APORTCONFLICT_W<IEN_SPEC, 18> {
        OPA2APORTCONFLICT_W::new(self)
    }
    #[doc = "Bit 19 - OPA3APORTCONFLICT Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn opa3aportconflict(&mut self) -> OPA3APORTCONFLICT_W<IEN_SPEC, 19> {
        OPA3APORTCONFLICT_W::new(self)
    }
    #[doc = "Bit 20 - OPA0PRSTIMEDERR Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn opa0prstimederr(&mut self) -> OPA0PRSTIMEDERR_W<IEN_SPEC, 20> {
        OPA0PRSTIMEDERR_W::new(self)
    }
    #[doc = "Bit 21 - OPA1PRSTIMEDERR Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn opa1prstimederr(&mut self) -> OPA1PRSTIMEDERR_W<IEN_SPEC, 21> {
        OPA1PRSTIMEDERR_W::new(self)
    }
    #[doc = "Bit 22 - OPA2PRSTIMEDERR Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn opa2prstimederr(&mut self) -> OPA2PRSTIMEDERR_W<IEN_SPEC, 22> {
        OPA2PRSTIMEDERR_W::new(self)
    }
    #[doc = "Bit 23 - OPA3PRSTIMEDERR Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn opa3prstimederr(&mut self) -> OPA3PRSTIMEDERR_W<IEN_SPEC, 23> {
        OPA3PRSTIMEDERR_W::new(self)
    }
    #[doc = "Bit 28 - OPA0OUTVALID Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn opa0outvalid(&mut self) -> OPA0OUTVALID_W<IEN_SPEC, 28> {
        OPA0OUTVALID_W::new(self)
    }
    #[doc = "Bit 29 - OPA1OUTVALID Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn opa1outvalid(&mut self) -> OPA1OUTVALID_W<IEN_SPEC, 29> {
        OPA1OUTVALID_W::new(self)
    }
    #[doc = "Bit 30 - OPA2OUTVALID Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn opa2outvalid(&mut self) -> OPA2OUTVALID_W<IEN_SPEC, 30> {
        OPA2OUTVALID_W::new(self)
    }
    #[doc = "Bit 31 - OPA3OUTVALID Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn opa3outvalid(&mut self) -> OPA3OUTVALID_W<IEN_SPEC, 31> {
