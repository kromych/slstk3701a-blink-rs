...
pub type R = crate::R<Opa0AportconflictSpec>;
...
#[doc = "Operational Amplifier APORT Conflict Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa0_aportconflict::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa0AportconflictSpec;
impl crate::RegisterSpec for Opa0AportconflictSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa0_aportconflict::R`](R) reader structure"]
impl crate::Readable for Opa0AportconflictSpec {}
#[doc = "`reset()` method sets OPA0_APORTCONFLICT to value 0"]
impl crate::Resettable for Opa0AportconflictSpec {}
