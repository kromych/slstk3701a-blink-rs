...
pub type R = crate::R<Opa0AportreqSpec>;
...
#[doc = "Operational Amplifier APORT Request Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa0_aportreq::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa0AportreqSpec;
impl crate::RegisterSpec for Opa0AportreqSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa0_aportreq::R`](R) reader structure"]
impl crate::Readable for Opa0AportreqSpec {}
#[doc = "`reset()` method sets OPA0_APORTREQ to value 0"]
impl crate::Resettable for Opa0AportreqSpec {}
