...
pub type R = crate::R<OPA0_APORTREQ_SPEC>;
...
#[doc = "Operational Amplifier APORT Request Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`opa0_aportreq::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
