...
pub type R = crate::R<Opa0CalSpec>;
#[doc = "Register `OPA0_CAL` writer"]
pub type W = crate::W<Opa0CalSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Compensation Cap Cm1 Trim Value"]
    #[inline(always)]
    pub fn cm1(&mut self) -> Cm1W<'_, Opa0CalSpec> {
        Cm1W::new(self, 0)
    }
    #[doc = "Bits 5:8 - Compensation Cap Cm2 Trim Value"]
    #[inline(always)]
    pub fn cm2(&mut self) -> Cm2W<'_, Opa0CalSpec> {
        Cm2W::new(self, 5)
    }
    #[doc = "Bits 10:11 - Compensation Cap Cm3 Trim Value"]
    #[inline(always)]
    pub fn cm3(&mut self) -> Cm3W<'_, Opa0CalSpec> {
        Cm3W::new(self, 10)
    }
    #[doc = "Bits 13:15 - Gm Trim Value"]
    #[inline(always)]
    pub fn gm(&mut self) -> GmW<'_, Opa0CalSpec> {
        GmW::new(self, 13)
    }
    #[doc = "Bits 17:18 - Gm3 Trim Value"]
    #[inline(always)]
    pub fn gm3(&mut self) -> Gm3W<'_, Opa0CalSpec> {
        Gm3W::new(self, 17)
    }
    #[doc = "Bits 20:24 - OPAx Non-Inverting Input Offset Configuration Value"]
    #[inline(always)]
    pub fn offsetp(&mut self) -> OffsetpW<'_, Opa0CalSpec> {
        OffsetpW::new(self, 20)
    }
    #[doc = "Bits 26:30 - OPAx Inverting Input Offset Configuration Value"]
    #[inline(always)]
    pub fn offsetn(&mut self) -> OffsetnW<'_, Opa0CalSpec> {
        OffsetnW::new(self, 26)
    }
}
#[doc = "Operational Amplifier Calibration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa0_cal::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`opa0_cal::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa0CalSpec;
impl crate::RegisterSpec for Opa0CalSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa0_cal::R`](R) reader structure"]
impl crate::Readable for Opa0CalSpec {}
#[doc = "`write(|w| ..)` method takes [`opa0_cal::W`](W) writer structure"]
impl crate::Writable for Opa0CalSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OPA0_CAL to value 0x80e7"]
impl crate::Resettable for Opa0CalSpec {
