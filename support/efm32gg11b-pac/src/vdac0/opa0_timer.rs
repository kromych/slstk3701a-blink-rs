...
pub type R = crate::R<OPA0_TIMER_SPEC>;
#[doc = "Register `OPA0_TIMER` writer"]
pub type W = crate::W<OPA0_TIMER_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn startupdly(&mut self) -> STARTUPDLY_W<OPA0_TIMER_SPEC, 0> {
        STARTUPDLY_W::new(self)
    }
    #[doc = "Bits 8:14 - OPAx Warmup Time Count Value"]
    #[inline(always)]
    #[must_use]
    pub fn warmuptime(&mut self) -> WARMUPTIME_W<OPA0_TIMER_SPEC, 8> {
        WARMUPTIME_W::new(self)
    }
    #[doc = "Bits 16:25 - OPAx Output Settling Timeout Value"]
    #[inline(always)]
    #[must_use]
    pub fn settletime(&mut self) -> SETTLETIME_W<OPA0_TIMER_SPEC, 16> {
...
#[doc = "Operational Amplifier Timer Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`opa0_timer::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`opa0_timer::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
