...
pub type R = crate::R<Opa0TimerSpec>;
#[doc = "Register `OPA0_TIMER` writer"]
pub type W = crate::W<Opa0TimerSpec>;
...
impl W {
    #[doc = "Bits 0:5 - OPAx Startup Delay Count Value"]
    #[inline(always)]
    pub fn startupdly(&mut self) -> StartupdlyW<'_, Opa0TimerSpec> {
        StartupdlyW::new(self, 0)
    }
    #[doc = "Bits 8:14 - OPAx Warmup Time Count Value"]
    #[inline(always)]
    pub fn warmuptime(&mut self) -> WarmuptimeW<'_, Opa0TimerSpec> {
        WarmuptimeW::new(self, 8)
    }
    #[doc = "Bits 16:25 - OPAx Output Settling Timeout Value"]
    #[inline(always)]
    pub fn settletime(&mut self) -> SettletimeW<'_, Opa0TimerSpec> {
        SettletimeW::new(self, 16)
    }
}
#[doc = "Operational Amplifier Timer Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa0_timer::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`opa0_timer::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa0TimerSpec;
impl crate::RegisterSpec for Opa0TimerSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa0_timer::R`](R) reader structure"]
impl crate::Readable for Opa0TimerSpec {}
#[doc = "`write(|w| ..)` method takes [`opa0_timer::W`](W) writer structure"]
impl crate::Writable for Opa0TimerSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OPA0_TIMER to value 0x0001_0700"]
impl crate::Resettable for Opa0TimerSpec {
