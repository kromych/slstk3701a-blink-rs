...
pub type R = crate::R<OPA1_APORTCONFLICT_SPEC>;
...
#[doc = "Operational Amplifier APORT Conflict Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`opa1_aportconflict::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
