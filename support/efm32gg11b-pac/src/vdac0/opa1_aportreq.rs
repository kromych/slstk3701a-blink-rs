...
pub type R = crate::R<Opa1AportreqSpec>;
...
#[doc = "Operational Amplifier APORT Request Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa1_aportreq::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa1AportreqSpec;
impl crate::RegisterSpec for Opa1AportreqSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa1_aportreq::R`](R) reader structure"]
impl crate::Readable for Opa1AportreqSpec {}
#[doc = "`reset()` method sets OPA1_APORTREQ to value 0"]
impl crate::Resettable for Opa1AportreqSpec {}
