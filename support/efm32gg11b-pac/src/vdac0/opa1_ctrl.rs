...
pub type R = crate::R<Opa1CtrlSpec>;
#[doc = "Register `OPA1_CTRL` writer"]
pub type W = crate::W<Opa1CtrlSpec>;
...
impl W {
    #[doc = "Bits 0:1 - OPAx Operation Mode"]
    #[inline(always)]
    pub fn drivestrength(&mut self) -> DrivestrengthW<'_, Opa1CtrlSpec> {
        DrivestrengthW::new(self, 0)
    }
    #[doc = "Bit 2 - OPAx Unity Gain Bandwidth Scale"]
    #[inline(always)]
    pub fn incbw(&mut self) -> IncbwW<'_, Opa1CtrlSpec> {
        IncbwW::new(self, 2)
    }
    #[doc = "Bit 3 - High Common Mode Disable"]
    #[inline(always)]
    pub fn hcmdis(&mut self) -> HcmdisW<'_, Opa1CtrlSpec> {
        HcmdisW::new(self, 3)
    }
    #[doc = "Bit 4 - Scale OPAx Output Driving Strength"]
    #[inline(always)]
    pub fn outscale(&mut self) -> OutscaleW<'_, Opa1CtrlSpec> {
        OutscaleW::new(self, 4)
    }
    #[doc = "Bit 8 - OPAx PRS Trigger Enable"]
    #[inline(always)]
    pub fn prsen(&mut self) -> PrsenW<'_, Opa1CtrlSpec> {
        PrsenW::new(self, 8)
    }
    #[doc = "Bit 9 - OPAx PRS Trigger Mode"]
    #[inline(always)]
    pub fn prsmode(&mut self) -> PrsmodeW<'_, Opa1CtrlSpec> {
        PrsmodeW::new(self, 9)
    }
    #[doc = "Bits 10:14 - OPAx PRS Trigger Select"]
    #[inline(always)]
    pub fn prssel(&mut self) -> PrsselW<'_, Opa1CtrlSpec> {
        PrsselW::new(self, 10)
    }
    #[doc = "Bit 16 - OPAx PRS Output Select"]
    #[inline(always)]
    pub fn prsoutmode(&mut self) -> PrsoutmodeW<'_, Opa1CtrlSpec> {
        PrsoutmodeW::new(self, 16)
    }
    #[doc = "Bit 20 - APORT Bus Master Disable"]
    #[inline(always)]
    pub fn aportxmasterdis(&mut self) -> AportxmasterdisW<'_, Opa1CtrlSpec> {
        AportxmasterdisW::new(self, 20)
    }
    #[doc = "Bit 21 - APORT Bus Master Disable"]
    #[inline(always)]
    pub fn aportymasterdis(&mut self) -> AportymasterdisW<'_, Opa1CtrlSpec> {
        AportymasterdisW::new(self, 21)
    }
}
#[doc = "Operational Amplifier Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa1_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`opa1_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa1CtrlSpec;
impl crate::RegisterSpec for Opa1CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa1_ctrl::R`](R) reader structure"]
impl crate::Readable for Opa1CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`opa1_ctrl::W`](W) writer structure"]
impl crate::Writable for Opa1CtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OPA1_CTRL to value 0x0e"]
impl crate::Resettable for Opa1CtrlSpec {
