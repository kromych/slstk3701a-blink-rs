...
pub type R = crate::R<Opa1MuxSpec>;
#[doc = "Register `OPA1_MUX` writer"]
pub type W = crate::W<Opa1MuxSpec>;
...
impl W {
    #[doc = "Bits 0:7 - OPAx Non-inverting Input Mux"]
    #[inline(always)]
    pub fn possel(&mut self) -> PosselW<'_, Opa1MuxSpec> {
        PosselW::new(self, 0)
    }
    #[doc = "Bits 8:15 - OPAx Inverting Input Mux"]
    #[inline(always)]
    pub fn negsel(&mut self) -> NegselW<'_, Opa1MuxSpec> {
        NegselW::new(self, 8)
    }
    #[doc = "Bits 16:18 - OPAx Resistor Ladder Input Mux"]
    #[inline(always)]
    pub fn resinmux(&mut self) -> ResinmuxW<'_, Opa1MuxSpec> {
        ResinmuxW::new(self, 16)
    }
    #[doc = "Bit 20 - OPAx Dedicated 3x Gain Resistor Ladder"]
    #[inline(always)]
    pub fn gain3x(&mut self) -> Gain3xW<'_, Opa1MuxSpec> {
        Gain3xW::new(self, 20)
    }
    #[doc = "Bits 24:26 - OPAx Resistor Ladder Select"]
    #[inline(always)]
    pub fn ressel(&mut self) -> ResselW<'_, Opa1MuxSpec> {
        ResselW::new(self, 24)
    }
}
#[doc = "Operational Amplifier Mux Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa1_mux::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`opa1_mux::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa1MuxSpec;
impl crate::RegisterSpec for Opa1MuxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa1_mux::R`](R) reader structure"]
impl crate::Readable for Opa1MuxSpec {}
#[doc = "`write(|w| ..)` method takes [`opa1_mux::W`](W) writer structure"]
impl crate::Writable for Opa1MuxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OPA1_MUX to value 0x0016_f2f1"]
impl crate::Resettable for Opa1MuxSpec {
