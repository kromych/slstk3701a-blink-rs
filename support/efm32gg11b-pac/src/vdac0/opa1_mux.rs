...
pub type R = crate::R<OPA1_MUX_SPEC>;
#[doc = "Register `OPA1_MUX` writer"]
pub type W = crate::W<OPA1_MUX_SPEC>;
...
impl RESINMUX_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<RESINMUX_A> {
        match self.bits {
...
pub type RESINMUX_W<'a, REG> = crate::FieldWriter<'a, REG, 3, RESINMUX_A>;
impl<'a, REG> RESINMUX_W<'a, REG>
where
...
pub type GAIN3X_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RESSEL_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, RESSEL_A>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn possel(&mut self) -> POSSEL_W<OPA1_MUX_SPEC> {
        POSSEL_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - OPAx Inverting Input Mux"]
    #[inline(always)]
    #[must_use]
    pub fn negsel(&mut self) -> NEGSEL_W<OPA1_MUX_SPEC> {
        NEGSEL_W::new(self, 8)
    }
    #[doc = "Bits 16:18 - OPAx Resistor Ladder Input Mux"]
    #[inline(always)]
    #[must_use]
    pub fn resinmux(&mut self) -> RESINMUX_W<OPA1_MUX_SPEC> {
        RESINMUX_W::new(self, 16)
    }
    #[doc = "Bit 20 - OPAx Dedicated 3x Gain Resistor Ladder"]
    #[inline(always)]
    #[must_use]
    pub fn gain3x(&mut self) -> GAIN3X_W<OPA1_MUX_SPEC> {
        GAIN3X_W::new(self, 20)
    }
    #[doc = "Bits 24:26 - OPAx Resistor Ladder Select"]
    #[inline(always)]
    #[must_use]
    pub fn ressel(&mut self) -> RESSEL_W<OPA1_MUX_SPEC> {
        RESSEL_W::new(self, 24)
    }
...
#[doc = "Operational Amplifier Mux Configuration Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`opa1_mux::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`opa1_mux::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
