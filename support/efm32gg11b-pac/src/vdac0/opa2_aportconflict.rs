...
pub type R = crate::R<Opa2AportconflictSpec>;
...
#[doc = "Operational Amplifier APORT Conflict Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa2_aportconflict::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa2AportconflictSpec;
impl crate::RegisterSpec for Opa2AportconflictSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa2_aportconflict::R`](R) reader structure"]
impl crate::Readable for Opa2AportconflictSpec {}
#[doc = "`reset()` method sets OPA2_APORTCONFLICT to value 0"]
impl crate::Resettable for Opa2AportconflictSpec {}
