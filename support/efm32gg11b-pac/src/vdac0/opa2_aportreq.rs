...
pub type R = crate::R<Opa2AportreqSpec>;
...
#[doc = "Operational Amplifier APORT Request Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa2_aportreq::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa2AportreqSpec;
impl crate::RegisterSpec for Opa2AportreqSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa2_aportreq::R`](R) reader structure"]
impl crate::Readable for Opa2AportreqSpec {}
#[doc = "`reset()` method sets OPA2_APORTREQ to value 0"]
impl crate::Resettable for Opa2AportreqSpec {}
