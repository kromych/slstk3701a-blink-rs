...
pub type R = crate::R<OPA2_CAL_SPEC>;
#[doc = "Register `OPA2_CAL` writer"]
pub type W = crate::W<OPA2_CAL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cm1(&mut self) -> CM1_W<OPA2_CAL_SPEC, 0> {
        CM1_W::new(self)
    }
    #[doc = "Bits 5:8 - Compensation Cap Cm2 Trim Value"]
    #[inline(always)]
    #[must_use]
    pub fn cm2(&mut self) -> CM2_W<OPA2_CAL_SPEC, 5> {
        CM2_W::new(self)
    }
    #[doc = "Bits 10:11 - Compensation Cap Cm3 Trim Value"]
    #[inline(always)]
    #[must_use]
    pub fn cm3(&mut self) -> CM3_W<OPA2_CAL_SPEC, 10> {
        CM3_W::new(self)
    }
    #[doc = "Bits 13:15 - Gm Trim Value"]
    #[inline(always)]
    #[must_use]
    pub fn gm(&mut self) -> GM_W<OPA2_CAL_SPEC, 13> {
        GM_W::new(self)
    }
    #[doc = "Bits 17:18 - Gm3 Trim Value"]
    #[inline(always)]
    #[must_use]
    pub fn gm3(&mut self) -> GM3_W<OPA2_CAL_SPEC, 17> {
        GM3_W::new(self)
    }
    #[doc = "Bits 20:24 - OPAx Non-Inverting Input Offset Configuration Value"]
    #[inline(always)]
    #[must_use]
    pub fn offsetp(&mut self) -> OFFSETP_W<OPA2_CAL_SPEC, 20> {
        OFFSETP_W::new(self)
    }
    #[doc = "Bits 26:30 - OPAx Inverting Input Offset Configuration Value"]
    #[inline(always)]
    #[must_use]
    pub fn offsetn(&mut self) -> OFFSETN_W<OPA2_CAL_SPEC, 26> {
        OFFSETN_W::new(self)
    }
...
#[doc = "Operational Amplifier Calibration Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`opa2_cal::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`opa2_cal::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
