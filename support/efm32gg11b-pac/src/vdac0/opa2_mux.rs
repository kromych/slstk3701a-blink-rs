...
pub type R = crate::R<OPA2_MUX_SPEC>;
#[doc = "Register `OPA2_MUX` writer"]
pub type W = crate::W<OPA2_MUX_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn possel(&mut self) -> POSSEL_W<OPA2_MUX_SPEC> {
        POSSEL_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - OPAx Inverting Input Mux"]
    #[inline(always)]
    #[must_use]
    pub fn negsel(&mut self) -> NEGSEL_W<OPA2_MUX_SPEC> {
        NEGSEL_W::new(self, 8)
    }
    #[doc = "Bits 16:18 - OPAx Resistor Ladder Input Mux"]
    #[inline(always)]
    #[must_use]
    pub fn resinmux(&mut self) -> RESINMUX_W<OPA2_MUX_SPEC> {
        RESINMUX_W::new(self, 16)
    }
    #[doc = "Bit 20 - OPAx Dedicated 3x Gain Resistor Ladder"]
    #[inline(always)]
    #[must_use]
    pub fn gain3x(&mut self) -> GAIN3X_W<OPA2_MUX_SPEC> {
        GAIN3X_W::new(self, 20)
    }
    #[doc = "Bits 24:26 - OPAx Resistor Ladder Select"]
    #[inline(always)]
    #[must_use]
    pub fn ressel(&mut self) -> RESSEL_W<OPA2_MUX_SPEC> {
...
#[doc = "Operational Amplifier Mux Configuration Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`opa2_mux::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`opa2_mux::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
