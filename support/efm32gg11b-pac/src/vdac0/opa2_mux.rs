...
pub type R = crate::R<Opa2MuxSpec>;
#[doc = "Register `OPA2_MUX` writer"]
pub type W = crate::W<Opa2MuxSpec>;
...
impl W {
    #[doc = "Bits 0:7 - OPAx Non-inverting Input Mux"]
    #[inline(always)]
    pub fn possel(&mut self) -> PosselW<'_, Opa2MuxSpec> {
        PosselW::new(self, 0)
    }
    #[doc = "Bits 8:15 - OPAx Inverting Input Mux"]
    #[inline(always)]
    pub fn negsel(&mut self) -> NegselW<'_, Opa2MuxSpec> {
        NegselW::new(self, 8)
    }
    #[doc = "Bits 16:18 - OPAx Resistor Ladder Input Mux"]
    #[inline(always)]
    pub fn resinmux(&mut self) -> ResinmuxW<'_, Opa2MuxSpec> {
        ResinmuxW::new(self, 16)
    }
    #[doc = "Bit 20 - OPAx Dedicated 3x Gain Resistor Ladder"]
    #[inline(always)]
    pub fn gain3x(&mut self) -> Gain3xW<'_, Opa2MuxSpec> {
        Gain3xW::new(self, 20)
    }
    #[doc = "Bits 24:26 - OPAx Resistor Ladder Select"]
    #[inline(always)]
    pub fn ressel(&mut self) -> ResselW<'_, Opa2MuxSpec> {
        ResselW::new(self, 24)
    }
}
#[doc = "Operational Amplifier Mux Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa2_mux::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`opa2_mux::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa2MuxSpec;
impl crate::RegisterSpec for Opa2MuxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa2_mux::R`](R) reader structure"]
impl crate::Readable for Opa2MuxSpec {}
#[doc = "`write(|w| ..)` method takes [`opa2_mux::W`](W) writer structure"]
impl crate::Writable for Opa2MuxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OPA2_MUX to value 0x0016_f2f1"]
impl crate::Resettable for Opa2MuxSpec {
