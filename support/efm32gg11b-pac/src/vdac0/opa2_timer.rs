...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn startupdly(&mut self) -> STARTUPDLY_W<OPA2_TIMER_SPEC, 0> {
        STARTUPDLY_W::new(self)
    }
    #[doc = "Bits 8:14 - OPAx Warmup Time Count Value"]
    #[inline(always)]
    #[must_use]
    pub fn warmuptime(&mut self) -> WARMUPTIME_W<OPA2_TIMER_SPEC, 8> {
        WARMUPTIME_W::new(self)
    }
    #[doc = "Bits 16:25 - OPAx Output Settling Timeout Value"]
    #[inline(always)]
    #[must_use]
    pub fn settletime(&mut self) -> SETTLETIME_W<OPA2_TIMER_SPEC, 16> {
