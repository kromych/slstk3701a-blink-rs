...
pub type R = crate::R<Opa2TimerSpec>;
#[doc = "Register `OPA2_TIMER` writer"]
pub type W = crate::W<Opa2TimerSpec>;
...
impl W {
    #[doc = "Bits 0:5 - OPAx Startup Delay Count Value"]
    #[inline(always)]
    pub fn startupdly(&mut self) -> StartupdlyW<'_, Opa2TimerSpec> {
        StartupdlyW::new(self, 0)
    }
    #[doc = "Bits 8:14 - OPAx Warmup Time Count Value"]
    #[inline(always)]
    pub fn warmuptime(&mut self) -> WarmuptimeW<'_, Opa2TimerSpec> {
        WarmuptimeW::new(self, 8)
    }
    #[doc = "Bits 16:25 - OPAx Output Settling Timeout Value"]
    #[inline(always)]
    pub fn settletime(&mut self) -> SettletimeW<'_, Opa2TimerSpec> {
        SettletimeW::new(self, 16)
    }
}
#[doc = "Operational Amplifier Timer Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa2_timer::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`opa2_timer::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa2TimerSpec;
impl crate::RegisterSpec for Opa2TimerSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa2_timer::R`](R) reader structure"]
impl crate::Readable for Opa2TimerSpec {}
#[doc = "`write(|w| ..)` method takes [`opa2_timer::W`](W) writer structure"]
impl crate::Writable for Opa2TimerSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OPA2_TIMER to value 0x0001_0700"]
impl crate::Resettable for Opa2TimerSpec {
