...
pub type R = crate::R<Opa3AportconflictSpec>;
...
#[doc = "Operational Amplifier APORT Conflict Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa3_aportconflict::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa3AportconflictSpec;
impl crate::RegisterSpec for Opa3AportconflictSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa3_aportconflict::R`](R) reader structure"]
impl crate::Readable for Opa3AportconflictSpec {}
#[doc = "`reset()` method sets OPA3_APORTCONFLICT to value 0"]
impl crate::Resettable for Opa3AportconflictSpec {}
