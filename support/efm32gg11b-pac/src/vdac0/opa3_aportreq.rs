...
pub type R = crate::R<Opa3AportreqSpec>;
...
#[doc = "Operational Amplifier APORT Request Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa3_aportreq::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Opa3AportreqSpec;
impl crate::RegisterSpec for Opa3AportreqSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opa3_aportreq::R`](R) reader structure"]
impl crate::Readable for Opa3AportreqSpec {}
#[doc = "`reset()` method sets OPA3_APORTREQ to value 0"]
impl crate::Resettable for Opa3AportreqSpec {}
