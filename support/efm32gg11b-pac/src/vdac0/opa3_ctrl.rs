...
pub type R = crate::R<OPA3_CTRL_SPEC>;
#[doc = "Register `OPA3_CTRL` writer"]
pub type W = crate::W<OPA3_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn drivestrength(&mut self) -> DRIVESTRENGTH_W<OPA3_CTRL_SPEC, 0> {
        DRIVESTRENGTH_W::new(self)
    }
    #[doc = "Bit 2 - OPAx Unity Gain Bandwidth Scale"]
    #[inline(always)]
    #[must_use]
    pub fn incbw(&mut self) -> INCBW_W<OPA3_CTRL_SPEC, 2> {
        INCBW_W::new(self)
    }
    #[doc = "Bit 3 - High Common Mode Disable"]
    #[inline(always)]
    #[must_use]
    pub fn hcmdis(&mut self) -> HCMDIS_W<OPA3_CTRL_SPEC, 3> {
        HCMDIS_W::new(self)
    }
    #[doc = "Bit 4 - Scale OPAx Output Driving Strength"]
    #[inline(always)]
    #[must_use]
    pub fn outscale(&mut self) -> OUTSCALE_W<OPA3_CTRL_SPEC, 4> {
        OUTSCALE_W::new(self)
    }
    #[doc = "Bit 8 - OPAx PRS Trigger Enable"]
    #[inline(always)]
    #[must_use]
    pub fn prsen(&mut self) -> PRSEN_W<OPA3_CTRL_SPEC, 8> {
        PRSEN_W::new(self)
    }
    #[doc = "Bit 9 - OPAx PRS Trigger Mode"]
    #[inline(always)]
    #[must_use]
    pub fn prsmode(&mut self) -> PRSMODE_W<OPA3_CTRL_SPEC, 9> {
        PRSMODE_W::new(self)
    }
    #[doc = "Bits 10:14 - OPAx PRS Trigger Select"]
    #[inline(always)]
    #[must_use]
    pub fn prssel(&mut self) -> PRSSEL_W<OPA3_CTRL_SPEC, 10> {
        PRSSEL_W::new(self)
    }
    #[doc = "Bit 16 - OPAx PRS Output Select"]
    #[inline(always)]
    #[must_use]
    pub fn prsoutmode(&mut self) -> PRSOUTMODE_W<OPA3_CTRL_SPEC, 16> {
        PRSOUTMODE_W::new(self)
    }
    #[doc = "Bit 20 - APORT Bus Master Disable"]
    #[inline(always)]
    #[must_use]
    pub fn aportxmasterdis(&mut self) -> APORTXMASTERDIS_W<OPA3_CTRL_SPEC, 20> {
        APORTXMASTERDIS_W::new(self)
    }
    #[doc = "Bit 21 - APORT Bus Master Disable"]
    #[inline(always)]
    #[must_use]
    pub fn aportymasterdis(&mut self) -> APORTYMASTERDIS_W<OPA3_CTRL_SPEC, 21> {
...
#[doc = "Operational Amplifier Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`opa3_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`opa3_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
