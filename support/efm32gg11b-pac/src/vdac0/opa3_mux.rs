...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn possel(&mut self) -> POSSEL_W<OPA3_MUX_SPEC, 0> {
        POSSEL_W::new(self)
    }
    #[doc = "Bits 8:15 - OPAx Inverting Input Mux"]
    #[inline(always)]
    #[must_use]
    pub fn negsel(&mut self) -> NEGSEL_W<OPA3_MUX_SPEC, 8> {
        NEGSEL_W::new(self)
    }
    #[doc = "Bits 16:18 - OPAx Resistor Ladder Input Mux"]
    #[inline(always)]
    #[must_use]
    pub fn resinmux(&mut self) -> RESINMUX_W<OPA3_MUX_SPEC, 16> {
        RESINMUX_W::new(self)
    }
    #[doc = "Bit 20 - OPAx Dedicated 3x Gain Resistor Ladder"]
    #[inline(always)]
    #[must_use]
    pub fn gain3x(&mut self) -> GAIN3X_W<OPA3_MUX_SPEC, 20> {
        GAIN3X_W::new(self)
    }
    #[doc = "Bits 24:26 - OPAx Resistor Ladder Select"]
    #[inline(always)]
    #[must_use]
    pub fn ressel(&mut self) -> RESSEL_W<OPA3_MUX_SPEC, 24> {
        RESSEL_W::new(self)
    }
