...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn startupdly(&mut self) -> STARTUPDLY_W<OPA3_TIMER_SPEC> {
        STARTUPDLY_W::new(self, 0)
    }
    #[doc = "Bits 8:14 - OPAx Warmup Time Count Value"]
    #[inline(always)]
    #[must_use]
    pub fn warmuptime(&mut self) -> WARMUPTIME_W<OPA3_TIMER_SPEC> {
        WARMUPTIME_W::new(self, 8)
    }
    #[doc = "Bits 16:25 - OPAx Output Settling Timeout Value"]
    #[inline(always)]
    #[must_use]
    pub fn settletime(&mut self) -> SETTLETIME_W<OPA3_TIMER_SPEC> {
