...
pub type R = crate::R<Pch0PrsctrlSpec>;
#[doc = "Register `PCH0_PRSCTRL` writer"]
pub type W = crate::W<Pch0PrsctrlSpec>;
...
impl W {
    #[doc = "Bits 0:4 - PRS Channel PRS Select"]
    #[inline(always)]
    pub fn prssel(&mut self) -> PrsselW<'_, Pch0PrsctrlSpec> {
        PrsselW::new(self, 0)
    }
    #[doc = "Bit 8 - PRS Missing Event Will Trigger a Watchdog Reset"]
    #[inline(always)]
    pub fn prsmissrsten(&mut self) -> PrsmissrstenW<'_, Pch0PrsctrlSpec> {
...
pub struct Pch0PrsctrlSpec;
impl crate::RegisterSpec for Pch0PrsctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pch0_prsctrl::R`](R) reader structure"]
impl crate::Readable for Pch0PrsctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`pch0_prsctrl::W`](W) writer structure"]
impl crate::Writable for Pch0PrsctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PCH0_PRSCTRL to value 0"]
impl crate::Resettable for Pch0PrsctrlSpec {}
