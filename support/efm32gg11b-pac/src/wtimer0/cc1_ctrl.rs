...
impl W {
    ...
    #[doc = "Bit 2 - Output Invert"]
    #[inline(always)]
    pub fn outinv(&mut self) -> OutinvW<'_, Cc1CtrlSpec> {
        OutinvW::new(self, 2)
    }
    #[doc = "Bit 4 - Compare Output Initial State"]
    #[inline(always)]
    pub fn coist(&mut self) -> CoistW<'_, Cc1CtrlSpec> {
        CoistW::new(self, 4)
    }
    #[doc = "Bits 8:9 - Compare Match Output Action"]
    #[inline(always)]
    ...
    #[doc = "Bits 10:11 - Counter Overflow Output Action"]
    #[inline(always)]
    pub fn cofoa(&mut self) -> CofoaW<'_, Cc1CtrlSpec> {
        CofoaW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Counter Underflow Output Action"]
    #[inline(always)]
    pub fn cufoa(&mut self) -> CufoaW<'_, Cc1CtrlSpec> {
        CufoaW::new(self, 12)
    }
    #[doc = "Bits 16:20 - Compare/Capture Channel PRS Input Channel Selection"]
    #[inline(always)]
    ...
    #[doc = "Bits 26:27 - Input Capture Event Control"]
    #[inline(always)]
    pub fn icevctrl(&mut self) -> IcevctrlW<'_, Cc1CtrlSpec> {
        IcevctrlW::new(self, 26)
    }
    #[doc = "Bit 28 - PRS Configuration"]
    #[inline(always)]
    pub fn prsconf(&mut self) -> PrsconfW<'_, Cc1CtrlSpec> {
        PrsconfW::new(self, 28)
    }
    #[doc = "Bit 29 - Input Selection"]
    #[inline(always)]
    pub fn insel(&mut self) -> InselW<'_, Cc1CtrlSpec> {
        InselW::new(self, 29)
    }
    #[doc = "Bit 30 - Digital Filter"]
    #[inline(always)]
    pub fn filt(&mut self) -> FiltW<'_, Cc1CtrlSpec> {
        FiltW::new(self, 30)
    }
}
