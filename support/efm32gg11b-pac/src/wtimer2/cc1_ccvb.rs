...
pub type R = crate::R<CC1_CCVB_SPEC>;
#[doc = "Register `CC1_CCVB` writer"]
pub type W = crate::W<CC1_CCVB_SPEC>;
...
pub type CCVB_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccvb(&mut self) -> CCVB_W<CC1_CCVB_SPEC> {
        CCVB_W::new(self, 0)
    }
